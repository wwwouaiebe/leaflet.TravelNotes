 ...
 * Build 00244 - 2020-09-01T21:59:42+0200 
...
/**
	...
	@------------------------------------------------------------------------------------------------------------------------------
	*/function bt(){let e=p(),t=null,o=null,n=null,r=null,i=null,l=null,s=null,d=null;function u(e){let a=t.getBoundingClientRect(),o=(e.clientX-a.x-c.margin/(2*c.margin+c.width)*a.width)/(c.width/(2*c.margin+c.width)*a.width)*d.distance;return Pe.getLatLngElevAtDist(d,o)}function g(e){e.preventDefault(),e.stopPropagation();let t=u(e);t&&(e.routeObjId=d.objId,e.latlng={lat:t.latLng[0],lng:t.latLng[1]},e.originalEvent={clientX:e.clientX,clientY:e.clientY},function(e){let t=Ee(),a=Ge(e,[{context:mt,name:b.getText("ProfileContextMenu - Add a note to the route at this point"),action:mt.newRouteNote,param:e.routeObjId},{context:t,name:b.getText("ProfileContextMenu - Zoom to this point"),action:t.zoomToLatLng,param:[e.latlng.lat,e.latlng.lng]}]);return Object.seal(a)}(e).show())}function v(){ve.dispatch("removeobject",{objId:e})}function h(a){let l=t.getBoundingClientRect(),s=u(a);if(s){const u=3;ve.dispatch("removeobject",{objId:e}),ve.dispatch("additinerarypointmarker",{objId:e,latLng:s.latLng}),o&&(t.removeChild(o),t.removeChild(i),t.removeChild(n),t.removeChild(r));let g=(2*c.margin+c.width)*(a.clientX-l.x)/l.width,v=c.margin+c.height;o=document.createElementNS("http://www.w3.org/2000/svg","polyline"),o.setAttributeNS(null,"points",String(g)+","+c.margin+" "+g+","+v),o.setAttributeNS(null,"class","TravelNotes-SvgProfile-markerPolyline"),t.appendChild(o);let p=s.routeDistance>d.distance/2?"end":"start",h=s.routeDistance>d.distance/2?-c.xDeltaText:c.xDeltaText;i=document.createElementNS("http://www.w3.org/2000/svg","text"),i.appendChild(document.createTextNode(y.formatDistance(s.routeDistance))),i.setAttributeNS(null,"class","TravelNotes-SvgProfile-elevText"),i.setAttributeNS(null,"x",g+h),i.setAttributeNS(null,"y",c.margin+c.yDeltaText),i.setAttributeNS(null,"text-anchor",p),t.appendChild(i),n=document.createElementNS("http://www.w3.org/2000/svg","text"),n.appendChild(document.createTextNode("Alt. "+s.elev.toFixed(0)+" m.")),n.setAttributeNS(null,"class","TravelNotes-SvgProfile-elevText"),n.setAttributeNS(null,"x",g+h),n.setAttributeNS(null,"y",c.margin+2*c.yDeltaText),n.setAttributeNS(null,"text-anchor",p),t.appendChild(n),r=document.createElementNS("http://www.w3.org/2000/svg","text"),r.appendChild(document.createTextNode("Pente "+s.ascent.toFixed(0)+" % ")),r.setAttributeNS(null,"class","TravelNotes-SvgProfile-elevText"),r.setAttributeNS(null,"x",g+h),r.setAttributeNS(null,"y",c.margin+c.yDeltaText*u),r.setAttributeNS(null,"text-anchor",p),t.appendChild(r)}}function m(){t&&(t.removeEventListener("contextmenu",g,!1),t.removeEventListener("mousemove",h,!1),t.removeEventListener("mouseleave",v,!1),ve.dispatch("removeobject",{objId:e}),l.content.removeChild(s),l.content.removeChild(t)),t=null,o=null,r=null,i=null,n=null,s=null}return l=Me(),l.createWindow(),l.onClose=function(){m(),ve.dispatch("profileclosed",{objId:d.objId})},l.update=function(e){m(),d=e,t=ft().createSvg(e),l.header.innerHTML=b.getText("ProfileWindow - Profile {name}",d),l.content.appendChild(t),t.addEventListener("contextmenu",g,!1),t.addEventListener("mousemove",h,!1),t.addEventListener("mouseleave",v,!1),s=a.create("div",{className:"TravelNotes-ProfileWindow-Ascent",innerHTML:b.getText("ProfileWindow - Ascent: {ascent} m. - Descent: {descent} m. - Distance: {distance}",{ascent:d.itinerary.ascent.toFixed(0),descent:d.itinerary.descent.toFixed(0),distance:y.formatDistance(d.distance)})}),l.content.appendChild(s)},Object.seal(l)}let yt=new Map,Tt=ft();const Nt=Object.seal(new class{createProfile(e){let a=yt.get(e.objId);if(e.itinerary.hasProfile){t.route.elev.smooth&&Tt.smooth(e),e.itinerary.ascent=0,e.itinerary.descent=0;let o=e.itinerary.itineraryPoints.first.elev;e.itinerary.itineraryPoints.forEach(t=>{let a=t.elev-o;0>a?e.itinerary.descent-=a:e.itinerary.ascent+=a,o=t.elev}),a&&a.update(e)}else a&&a.close()}updateProfile(e,t){let a=yt.get(e);a&&(yt.delete(e),t&&t.itinerary.hasProfile?(a.update(t),yt.set(t.objId,a)):a.close())}deleteProfile(e){let t=yt.get(e);t&&t.close()}deleteAllProfiles(){yt.forEach(e=>e.close())}showProfile(e){let t=yt.get(e);t||(t=bt());let a=Le.getRoute(e);t.update(a),yt.set(e,t)}onProfileClosed(e){yt.delete(e)}});const Lt=Object.seal(new class{createUI(){a.create("div",{id:"TravelNotes-AttributionsUI"},document.querySelector("body")),this.attributions=""}set attributions(e){document.getElementById("TravelNotes-AttributionsUI").innerHTML='&copy; <a href="http://leafletjs.com/" target="_blank" title="Leaflet">Leaflet</a> | &copy; <a href="http://www.openstreetmap.org/copyright" target="_blank" title="OpenStreetMap contributors">OpenStreetMap contributors</a> '+e+'| &copy; <a href="https://github.com/wwwouaiebe" target="_blank" title="https://github.com/wwwouaiebe">Travel & Notes</a> '}});let wt=[{service:"wmts",url:"https://{s}.tile.osm.org/{z}/{x}/{y}.png",name:"OSM - Color",toolbar:{text:"OSM",color:"red",backgroundColor:"white"},providerName:"OSM",providerKeyNeeded:!1,attribution:""}],It=null,xt=null,At=null,jt=0,Pt=0,Et=0,Mt=0;function Dt(e){e.target.setAttribute("style","color:"+e.target.layer.toolbar.backgroundColor+";background-color:"+e.target.layer.toolbar.color)}function Rt(e){e.target.setAttribute("style","color:"+e.target.layer.toolbar.color+";background-color:"+e.target.layer.toolbar.backgroundColor)}function Ot(e){e.target.classList.add("TravelNotes-LayersToolbarUI-LinkButton-Enter"),e.target.classList.remove("TravelNotes-LayersToolbarUI-LinkButton-Leave")}function Ct(e){ve.dispatch("layerchange",{layer:e.target.layer}),Lt.attributions=e.target.layer.attribution,$.travel.layerName=e.target.layer.name}function St(e){e.target.classList.add("TravelNotes-LayersToolbarUI-LinkButton-Leave"),e.target.classList.remove("TravelNotes-LayersToolbarUI-LinkButton-Enter")}function Ut(e){e.deltaY&&(jt-=e.deltaY*g[e.deltaMode],jt=jt>Mt?Mt:jt,jt=jt<Mt-Et+3*Pt?Mt-Et+3*Pt:jt,At.style.marginTop=String(jt)+"px"),e.stopPropagation()}function kt(){let e=At.childNodes;for(let t=0;t<e.length;t++)"layer"===e[t].type?(e[t].removeEventListener("mouseenter",Dt,!1),e[t].removeEventListener("mouseleave",Rt,!1),e[t].removeEventListener("click",Ct,!1)):(e[t].removeEventListener("mouseenter",Ot,!1),e[t].removeEventListener("mouseleave",Ot,!1));At.removeEventListener("wheel",Ut,!1),xt.removeChild(At),It=null}function Ht(){It=setTimeout(kt,t.layersToolbarUI.toolbarTimeOut)}function Bt(){if(It)return clearTimeout(It),void(It=null);At=a.create("div",{id:"TravelNotes-LayersToolbarUI-Buttons"},xt),Mt=xt.clientHeight,Et=0,wt.forEach(e=>function(e){if(e.providerKeyNeeded&&!Ne.getKey(e.providerName.toLowerCase()))return;let t=a.create("div",{type:"layer",className:"TravelNotes-LayersToolbarUI-Button",title:e.name,layer:e,innerHTML:e.toolbar.text,style:"color:"+e.toolbar.color+";background-color:"+e.toolbar.backgroundColor},At);t.addEventListener("mouseenter",Dt,!1),t.addEventListener("mouseleave",Rt,!1),t.addEventListener("click",Ct,!1),Pt=t.clientHeight,Et+=Pt}(e)),t.layersToolbarUI.theDevil&&t.layersToolbarUI.theDevil.addButton&&function(e,t,o){let n=a.create("div",{type:"link",className:"TravelNotes-LayersToolbarUI-Button TravelNotes-LayersToolbarUI-LinkButton-Leave",innerHTML:'<a href="'+e+'" title="'+t+'" target="_blank">'+o+"</a>"},At);n.addEventListener("mouseenter",Ot,!1),n.addEventListener("mouseleave",St,!1),Et+=n.clientHeight}("https://www.google.com/maps/@"+$.map.getCenter().lat+","+$.map.getCenter().lng+","+$.map.getZoom()+"z",t.layersToolbarUI.theDevil.title,t.layersToolbarUI.theDevil.text),Mt+=Pt,jt=Mt,At.style.marginTop=String(jt)+"px",At.addEventListener("wheel",Ut,!1)}const Ft=Object.freeze(new class{createUI(){xt=a.create("div",{id:"TravelNotes-LayersToolbarUI"},document.querySelector("body")),a.create("div",{id:"TravelNotes-LayersToolbarUI-Header",innerHTML:b.getText("LayersToolbarUI - Layers")},xt),xt.addEventListener("mouseenter",Bt,!1),xt.addEventListener("mouseleave",Ht,!1),ve.dispatch("layerchange",{layer:wt[0]}),Lt.attributions=wt[0].attribution}getLayer(e){let t=wt.find(t=>t.name===e)||wt[0];if(t.providerKeyNeeded){Ne.getKey(t.providerName.toLowerCase())||(t=wt[0])}return t}setLayer(e){let t=wt.find(t=>t.name===e)||wt[0];if(t.providerKeyNeeded){Ne.getKey(t.providerName.toLowerCase())||(t=wt[0])}ve.dispatch("layerchange",{layer:t}),Lt.attributions=t.attribution,$.travel.layerName=t.name}addLayers(e){wt=wt.concat(e)}});function Vt(){let e=null,o=null,n=null,r=[],i=0,l=null,s=document.querySelector("body"),d=0;function c(){for(;0<document.getElementsByClassName("TravelNotes-routeViewDiv").length;)s.removeChild(document.getElementsByClassName("TravelNotes-routeViewDiv")[0]);document.getElementById("TravelNotes-PrintToolbar-PrintButton").removeEventListener("click",()=>window.print(),!1),document.getElementById("TravelNotes-PrintToolbar-CancelButton").removeEventListener("click",c,!1),s.removeChild(document.getElementById("TravelNotes-PrintToolbar"));let e=s.children;for(let t=0;t<e.length;t++)e.item(t).classList.remove("TravelNotes-PrintViews-Hidden");$.map.invalidateSize(!1),window.removeEventListener("afterprint",c,!0)}function u(e,t,a){let o=function(e,t,a){if(e.bottomLeft.lat===e.upperRight.lat&&e.bottomLeft.lng===e.upperRight.lng){let e=Math.min(Math.abs(n[0]/(a.lat-t.lat)),Math.abs(n[1]/(a.lng-t.lng)));return{lat:t.lat+e*(a.lat-t.lat),lng:t.lng+e*(a.lng-t.lng)}}return null}(e,t,a);if(o)return o;if(o=function(e,t){return t.lat-e.bottomLeft.lat<1e-6||e.upperRight.lat-t.lat<1e-6||t.lng-e.bottomLeft.lng<1e-6||e.upperRight.lng-t.lng<1e-6?{lat:t.lat,lng:t.lng}:null}(e,t),o)return o;if(o=function(e,t,a){return t.lng===a.lng?{lat:t.lat>a.lat?e.bottomLeft.lat:e.upperRight.lat,lng:t.lng}:t.lat===a.lat?{lat:t.lat,lng:t.lng<a.lng?e.upperRight.lng:e.bottomLeft.lng}:null}(e,t,a),o)return o;let r=(t.lat-a.lat)/(t.lng-a.lng),i=t.lat-r*t.lng;if(o={lat:r*e.upperRight.lng+i,lng:e.upperRight.lng},o.lat<=e.upperRight.lat&&o.lat>=e.bottomLeft.lat&&o.lng<a.lng)return o;if(o={lat:e.upperRight.lat,lng:(e.upperRight.lat-i)/r},o.lng>=e.bottomLeft.lng&&o.lng<=e.upperRight.lng&&o.lat<a.lat)return o;if(o={lat:r*e.bottomLeft.lng+i,lng:e.bottomLeft.lng},o.lat<=e.upperRight.lat&&o.lat>=e.bottomLeft.lat&&o.lng>a.lng)return o;if(o={lat:e.bottomLeft.lat,lng:(e.bottomLeft.lat-i)/r},o.lng>=e.bottomLeft.lng&&o.lng<=e.upperRight.lng&&o.lat>a.lat)return o;throw new Error("intermediate point not found")}function g(n){i++;let r="TravelNotes-RouteViewDiv"+i,d=a.create("div",{className:"TravelNotes-routeViewDiv",id:r},s);e.pageBreak&&d.classList.add("TravelNotes-PrintPageBreak"),d.setAttribute("style","width:"+e.paperWidth+"mm;height:"+e.paperHeight+"mm;");let c=e.printNotes?function(){let e=[];return o.notes.forEach(a=>{let o=L.divIcon({iconSize:[a.iconWidth,a.iconHeight],iconAnchor:[a.iconWidth/2,a.iconHeight/2],popupAnchor:[0,-a.iconHeight/2],html:a.iconContent,className:"TravelNotes-AllNotes "+t.note.style});let n=L.marker(a.iconLatLng,{zIndexOffset:100,icon:o,draggable:!0});e.push(n)}),e}():[];c.push(function(){let e=Ft.getLayer($.travel.layerName),t=e.url;if(e.providerKeyNeeded){let a=Ne.getKey(e.providerName.toLowerCase());t=t.replace("{providerKey}",a)}let a=null;return a="wmts"===e.service.toLowerCase()?L.tileLayer(t):L.tileLayer.wms(t,e.wmsOptions),a.options.attribution=' &copy; <a href="http://www.openstreetmap.org/copyright" target="_blank" title="OpenStreetMap contributors">OpenStreetMap contributors</a> '+e.attribution+'| &copy; <a href="https://github.com/wwwouaiebe" target="_blank" title="https://github.com/wwwouaiebe">Travel & Notes</a> ',a}()),c.push(L.circleMarker([n.entryPoint.lat,n.entryPoint.lng],t.printRouteMap.entryPointMarker)),c.push(L.circleMarker([n.exitPoint.lat,n.exitPoint.lng],t.printRouteMap.exitPointMarker)),c.push(l),L.map(r,{attributionControl:!0,zoomControl:!1,center:[(n.bottomLeft.lat+n.upperRight.lat)/2,(n.bottomLeft.lng+n.upperRight.lng)/2],zoom:e.zoomFactor,minZoom:e.zoomFactor,maxZoom:e.zoomFactor,layers:c})}function v(){let e=s.children;for(let t=0;t<e.length;t++)e.item(t).classList.add("TravelNotes-PrintViews-Hidden");!function(){let e=a.create("div",{id:"TravelNotes-PrintToolbar"},s);a.create("div",{id:"TravelNotes-PrintToolbar-PrintButton",className:"TravelNotes-UI-Button",title:b.getText("PrintFactory - Print"),innerHTML:"&#x1F5A8;&#xFE0F;"},e).addEventListener("click",()=>window.print(),!1),a.create("div",{id:"TravelNotes-PrintToolbar-CancelButton",className:"TravelNotes-UI-Button",title:b.getText("PrintFactory - Cancel print"),innerHTML:"&#x274c;"},e).addEventListener("click",c,!1)}(),window.addEventListener("afterprint",c,!0);let t=[],n=o.itinerary.itineraryPoints.iterator;for(;!n.done;)t.push(n.value.latLng);l=L.polyline(t,{color:o.color,weight:o.width}),i=0,r.forEach(g)}return Object.freeze(new class{print(i,l){o=Le.getRoute(l),o&&(e=i,function(){let t=document.querySelector("body"),o=a.create("div",{},t);o.setAttribute("style","position:absolute;top:0,left:0;width:"+(e.paperWidth-2*e.borderWidth)+"mm;height:"+(e.paperHeight-2*e.borderWidth)+"mm;"),d=Math.ceil(o.clientWidth/256)*Math.ceil(o.clientHeight/256);let r=Pe.screenCoordToLatLng(0,0),i=Pe.screenCoordToLatLng(o.clientWidth,o.clientHeight);t.removeChild(o);let l=$.map.getZoomScale($.map.getZoom(),e.zoomFactor);n=[Math.abs(r[0]-i[0])*l,Math.abs(r[1]-i[1])*l]}(),function(){r=[];let e=o.itinerary.itineraryPoints.iterator,a=e.done,i={bottomLeft:{lat:e.value.lat,lng:e.value.lng},upperRight:{lat:e.value.lat,lng:e.value.lng}},l={lat:e.value.lat,lng:e.value.lng},s=e.value;a=e.done;let c=e.value;for(;!a;){let o={bottomLeft:{lat:Math.min(i.bottomLeft.lat,c.lat),lng:Math.min(i.bottomLeft.lng,c.lng)},upperRight:{lat:Math.max(i.upperRight.lat,c.lat),lng:Math.max(i.upperRight.lng,c.lng)}},g=[o.upperRight.lat-o.bottomLeft.lat,o.upperRight.lng-o.bottomLeft.lng];n[0]>g[0]&&n[1]>g[1]?(i=o,s=e.value,a=e.done,c=e.value,a&&(i.entryPoint=l,i.exitPoint=s,r.push(i))):(s=u(i,s,c),i.bottomLeft={lat:Math.min(i.bottomLeft.lat,s.lat),lng:Math.min(i.bottomLeft.lng,s.lng)},i.upperRight={lat:Math.max(i.upperRight.lat,s.lat),lng:Math.max(i.upperRight.lng,s.lng)},i.entryPoint=l,i.exitPoint=s,r.push(i),i={bottomLeft:{lat:s.lat,lng:s.lng},upperRight:{lat:s.lat,lng:s.lng}},l={lat:s.lat,lng:s.lng}),t.printRouteMap.maxTiles<r.length*d&&(a=!0)}}(),t.printRouteMap.maxTiles<r.length*d?ue.showError(b.getText("PrintFactory - The maximum of allowed pages is reached.")):v())}})}let Wt=!1,zt=!1;function Kt(){let e=$.travel.routes.iterator,t=n.defaultValue;for(;!e.done;){e.value.chain?(e.value.chainedDistance=t,t+=e.value.distance):e.value.chainedDistance=n.defaultValue;let a=e.value.notes.iterator;for(;!a.done;)a.value.chainedDistance=e.value.chainedDistance}}function Xt(e){let t=!0;return e.wayPoints.forEach(e=>{t=t&&s.defaultValue!==e.lat&&s.defaultValue!==e.lng}),t}function Zt(e){zt=!1,ue.showError(e),console.log(e||"An error occurs when asking the route to the provider")}function Gt(){if(zt=!1,function(e){let t=e.itinerary.itineraryPoints.iterator,a=e.itinerary.maneuvers.iterator;for(t.done,a.done,a.value.distance=n.defaultValue,a.done,e.distance=n.defaultValue,e.duration=n.defaultValue;!t.done;)t.previous.distance=Pe.pointsDistance(t.previous.latLng,t.value.latLng),e.distance+=t.previous.distance,a.previous.distance+=t.previous.distance,a.value.itineraryPointObjId===t.value.objId&&(e.duration+=a.previous.duration,a.value.distance=n.defaultValue,a.next&&a.value.itineraryPointObjId===a.next.itineraryPointObjId&&(a.done,a.value.distance=n.defaultValue),a.done)}($.travel.editedRoute),"circle"!==$.travel.editedRoute.itinerary.transitMode){let e=$.travel.editedRoute.wayPoints.iterator;for(;!e.done;)e.first?e.value.latLng=$.travel.editedRoute.itinerary.itineraryPoints.first.latLng:e.last?e.value.latLng=$.travel.editedRoute.itinerary.itineraryPoints.last.latLng:e.value.latLng=Pe.getClosestLatLngDistance($.travel.editedRoute,e.value.latLng).latLng}let e=$.travel.editedRoute.notes.iterator;for(;!e.done;){let t=Pe.getClosestLatLngDistance($.travel.editedRoute,e.value.latLng);e.value.latLng=t.latLng,e.value.distance=t.distance}Kt(),$.travel.editedRoute.notes.sort((e,t)=>e.distance-t.distance),Wt&&Ee().zoomToRoute($.travel.editedRoute.objId),Nt.createProfile($.travel.editedRoute),ve.dispatch("routeupdated",{removedRouteObjId:$.travel.editedRoute.objId,addedRouteObjId:$.travel.editedRoute.objId}),ve.dispatch("roadbookupdate"),ve.dispatch("showitinerary")}const Jt=Object.seal(new class{addRoute(){let e=K();$.travel.routes.add(e),d.editedChanged===$.travel.editedRoute.editionStatus?(Kt(),ve.dispatch("setrouteslist"),ve.dispatch("roadbookupdate")):this.editRoute(e.objId)}editRoute(e){if(d.editedChanged===$.travel.editedRoute.editionStatus)return void ue.showError(b.getText("RouteEditor - Not possible to edit a route without a save or cancel"));let t=Le.getRoute(e),a=t.itinerary.provider,o=$.providers.get(a.toLowerCase());if(a&&""!==a&&(!o||o.providerKeyNeeded&&!Ne.getKey(a)))return void ue.showError(b.getText("RouteEditor - Not possible to edit a route created with this provider",{provider:a}));-1!==$.editedRouteObjId&&this.cancelEdition(),a&&""!==a&&ve.dispatch("setprovider",{provider:a});let n=t.itinerary.transitMode;n&&""!==n&&ve.dispatch("settransitmode",{transitMode:n}),$.travel.editedRoute=K(),t.editionStatus=d.editedNoChange,$.travel.editedRoute.jsonObject=t.jsonObject,$.editedRouteObjId=t.objId,$.travel.editedRoute.hidden=!1,t.hidden=!1,Nt.updateProfile($.editedRouteObjId,$.travel.editedRoute),Kt(),ve.dispatch("routeupdated",{removedRouteObjId:t.objId,addedRouteObjId:$.travel.editedRoute.objId}),ve.dispatch("roadbookupdate"),ve.dispatch("showitinerary"),ve.dispatch("setrouteslist")}removeRoute(e){let t=e;if(t===$.editedRouteObjId||t===$.travel.editedRoute.objId){if(d.editedChanged===$.travel.editedRoute.editionStatus)return void ue.showError(b.getText("TravelEditor - Cannot remove an edited route"));t=$.editedRouteObjId,this.cancelEdition()}ve.dispatch("routeupdated",{removedRouteObjId:t,addedRouteObjId:-1}),$.travel.routes.remove(t),Nt.deleteProfile(t),Kt(),ve.dispatch("roadbookupdate"),ve.dispatch("setrouteslist")}removeManeuver(e){($.travel.editedRoute.itinerary.maneuvers.previous(e,e=>n.defaultValue<e.distance)||$.travel.editedRoute.itinerary.maneuvers.first).distance+=$.travel.editedRoute.itinerary.maneuvers.getAt(e).distance,$.travel.editedRoute.itinerary.maneuvers.remove(e),ve.dispatch("showitinerary"),ve.dispatch("roadbookupdate")}saveGpx(e){we().routeToGpx(e)}chainRoutes(){Kt()}startRouting(){if(t.routing.auto&&!zt&&Xt($.travel.editedRoute)){Wt=0===$.travel.editedRoute.itinerary.itineraryPoints.length,zt=!0;let e=$.providers.get($.routing.provider.toLowerCase());$.travel.editedRoute.itinerary.provider=e.name,$.travel.editedRoute.itinerary.transitMode=$.routing.transitMode,e.getPromiseRoute($.travel.editedRoute,null).then(Gt).catch(Zt)}}saveEdition(){let e=K();e.jsonObject=$.travel.editedRoute.jsonObject,$.travel.routes.replace($.editedRouteObjId,e),$.editedRouteObjId=e.objId,this.cancelEdition()}cancelEdition(){let e=Le.getRoute($.editedRouteObjId);e.editionStatus=d.notEdited,Nt.updateProfile($.travel.editedRoute.objId,e),ve.dispatch("routeupdated",{removedRouteObjId:$.travel.editedRoute.objId,addedRouteObjId:$.editedRouteObjId}),$.editedRouteObjId=-1,$.travel.editedRoute=K(),Kt(),ve.dispatch("roadbookupdate"),ve.dispatch("setrouteslist"),ve.dispatch("showitinerary")}routeProperties(e){let t=Le.getRoute(e);xe(t).show().then(()=>{Kt(),Xt(t)&&ve.dispatch("routepropertiesupdated",{routeObjId:t.objId}),ve.dispatch("roadbookupdate"),ve.dispatch("setrouteslist"),ve.dispatch("updateitinerary")}).catch(e=>console.log(e||"An error occurs in the route properties dialog"))}printRouteMap(e){(function(){let e=null,o=null,n=null,r=null,i=null,l=null,s=null,d=null;function c(){return Object.seal({paperWidth:parseInt(n.value),paperHeight:parseInt(r.value),borderWidth:parseInt(i.value),zoomFactor:parseInt(d.value),pageBreak:l.checked,printNotes:s.checked})}return e=ee(),e.title=b.getText("PrintRouteMapDialog - Print"),e.okButtonListener=c,o=a.create("div",{id:"TravelNotes-PrintRouteMapDialog-MainDataDiv"},e.content),function(){let e=a.create("div",{className:"TravelNotes-PrintRouteMapDialog-DataDiv"},o);a.create("text",{value:b.getText("PrintRouteMapDialog - Paper width")},e),n=a.create("input",{type:"number",className:"TravelNotes-PrintRouteMapDialog-NumberInput"},e),n.value=t.printRouteMap.paperWidth,a.create("text",{value:b.getText("PrintRouteMapDialog - Paper width units")},e)}(),function(){let e=a.create("div",{className:"TravelNotes-PrintRouteMapDialog-DataDiv"},o);a.create("text",{value:b.getText("PrintRouteMapDialog - Paper height")},e),r=a.create("input",{type:"number",className:"TravelNotes-PrintRouteMapDialog-NumberInput",value:t.printRouteMap.paperHeight},e),a.create("text",{value:b.getText("PrintRouteMapDialog - Paper height units")},e)}(),function(){let e=a.create("div",{className:"TravelNotes-PrintRouteMapDialog-DataDiv"},o);a.create("text",{value:b.getText("PrintRouteMapDialog - Border width")},e),i=a.create("input",{type:"number",className:"TravelNotes-PrintRouteMapDialog-NumberInput",id:"TravelNotes-PrintRouteMapDialog-BorderWidthNumberInput",value:t.printRouteMap.borderWidth},e),a.create("text",{value:b.getText("PrintRouteMapDialog - Border width units")},e)}(),function(){let e=a.create("div",{className:"TravelNotes-PrintRouteMapDialog-DataDiv",id:"TravelNotes-PrintRouteMapDialog-ZoomFactorDataDiv"},o);a.create("text",{value:b.getText("PrintRouteMapDialog - Zoom factor")},e),d=a.create("input",{type:"number",className:"TravelNotes-PrintRouteMapDialog-NumberInput",value:Math.min(t.printRouteMap.zoomFactor,15),min:$.map.getMinZoom(),max:Math.min($.map.getMaxZoom(),15)},e)}(),function(){let e=a.create("div",{className:"TravelNotes-PrintRouteMapDialog-DataDiv",id:"TravelNotes-PrintRouteMapDialog-PageBreakDataDiv"},o);l=a.create("input",{type:"checkbox",id:"TravelNotes-PrintRouteMapDialog-PageBreakInput",checked:t.printRouteMap.pageBreak},e),a.create("text",{value:b.getText("PrintRouteMapDialog - Page break")},e)}(),function(){let e=a.create("div",{className:"TravelNotes-PrintRouteMapDialog-DataDiv",id:"TravelNotes-PrintRouteMapDialog-PrintNotesDataDiv"},o);s=a.create("input",{type:"checkbox",id:"TravelNotes-PrintRouteMapDialog-PrintNotesInput",checked:t.printRouteMap.printNotes},e),a.create("text",{value:b.getText("PrintRouteMapDialog - Print notes")},e)}(),e})().show().then(t=>Vt().print(t,e)).catch(e=>console.log(e||"An error occurs in the route properties dialog"))}showRoute(e){Le.getRoute(e).hidden=!1,ve.dispatch("routeupdated",{removedRouteObjId:-1,addedRouteObjId:e}),ve.dispatch("setrouteslist")}hideRoute(e){Le.getRoute(e).hidden=!0,ve.dispatch("routeupdated",{removedRouteObjId:e,addedRouteObjId:-1}),ve.dispatch("setrouteslist")}showRoutes(){let e=$.travel.routes.iterator;for(;!e.done;)e.value.hidden&&(e.value.hidden=!1,ve.dispatch("routeupdated",{removedRouteObjId:-1,addedRouteObjId:e.value.objId}));ve.dispatch("setrouteslist")}hideRoutes(){let e=$.travel.routes.iterator;for(;!e.done;)e.value.hidden||e.value.objId===$.editedRouteObjId||(e.value.hidden=!0,ve.dispatch("routeupdated",{removedRouteObjId:e.value.objId,addedRouteObjId:-1}));ve.dispatch("setrouteslist")}});function Yt(e,a){if(!t.wayPoint.reverseGeocoding)return;let o=qe();o.getPromiseAddress(e).then(e=>{let t=o.parseResponse(e),n=t.street;""!==t.city&&(n+=" "+t.city),function(e,t){$.travel.editedRoute.editionStatus=d.editedChanged;let a=$.travel.editedRoute.wayPoints.getAt(t);a.name=e.name,a.address=e.address,ve.dispatch("setrouteslist"),ve.dispatch("showitinerary"),ve.dispatch("roadbookupdate")}(Object.seal({name:t.name,address:n}),a)}).catch(e=>console.log(e||"An error occurs in the geoCoder"))}const qt=Object.seal(new class{addWayPoint(e){$.travel.editedRoute.editionStatus=d.editedChanged;let t=I();t.latLng=e,Yt(e,t.objId),$.travel.editedRoute.wayPoints.add(t),ve.dispatch("addwaypoint",{wayPoint:$.travel.editedRoute.wayPoints.last,letter:$.travel.editedRoute.wayPoints.length-2}),$.travel.editedRoute.wayPoints.swap(t.objId,!0),Jt.startRouting()}addWayPointOnRoute(e,t){let a=Pe.getClosestLatLngDistance($.travel.editedRoute,e).distance;$.travel.editedRoute.editionStatus=d.editedChanged;let o=I();o.latLng=t,Yt(t,o.objId),$.travel.editedRoute.wayPoints.add(o),ve.dispatch("addwaypoint",{wayPoint:$.travel.editedRoute.wayPoints.last,letter:$.travel.editedRoute.wayPoints.length-2});let n=$.travel.editedRoute.wayPoints.iterator;for(;!n.done;){if(a<Pe.getClosestLatLngDistance($.travel.editedRoute,n.value.latLng).distance){$.travel.editedRoute.wayPoints.moveTo(o.objId,n.value.objId,!0);break}}Jt.startRouting()}reverseWayPoints(){$.travel.editedRoute.editionStatus=d.editedChanged;let e=$.travel.editedRoute.wayPoints.iterator;for(;!e.done;)ve.dispatch("removeobject",{objId:e.value.objId});for($.travel.editedRoute.wayPoints.reverse(),e=$.travel.editedRoute.wayPoints.iterator;!e.done;)ve.dispatch("addwaypoint",{wayPoint:e.value,letter:e.first?"A":e.last?"B":e.index});ve.dispatch("setrouteslist"),ve.dispatch("showitinerary"),ve.dispatch("roadbookupdate"),Jt.startRouting()}removeWayPoint(e){$.travel.editedRoute.editionStatus=d.editedChanged,ve.dispatch("removeobject",{objId:e}),$.travel.editedRoute.wayPoints.remove(e),Jt.startRouting()}setStartPoint(e){$.travel.editedRoute.editionStatus=d.editedChanged,s.defaultValue!==$.travel.editedRoute.wayPoints.first.lat&&ve.dispatch("removeobject",{objId:$.travel.editedRoute.wayPoints.first.objId}),$.travel.editedRoute.wayPoints.first.latLng=e,t.wayPoint.reverseGeocoding&&Yt(e,$.travel.editedRoute.wayPoints.first.objId),ve.dispatch("addwaypoint",{wayPoint:$.travel.editedRoute.wayPoints.first,letter:"A"}),Jt.startRouting()}setEndPoint(e){$.travel.editedRoute.editionStatus=d.editedChanged,s.defaultValue!==$.travel.editedRoute.wayPoints.last.lat&&ve.dispatch("removeobject",{objId:$.travel.editedRoute.wayPoints.last.objId}),$.travel.editedRoute.wayPoints.last.latLng=e,t.wayPoint.reverseGeocoding&&Yt(e,$.travel.editedRoute.wayPoints.last.objId),ve.dispatch("addwaypoint",{wayPoint:$.travel.editedRoute.wayPoints.last,letter:"B"}),Jt.startRouting()}wayPointDragEnd(e){$.travel.editedRoute.editionStatus=d.editedChanged,t.wayPoint.reverseGeocoding&&Yt($.travel.editedRoute.wayPoints.getAt(e).latLng,e),Jt.startRouting()}wayPointProperties(e){(function(e){let o=null,n=null,r=null,i=null;function l(){return e.name=r.value,e.address=i.value,e}function s(a){if(a.stopPropagation(),!t.wayPoint.reverseGeocoding)return;let o=qe();o.getPromiseAddress(e.latLng).then(e=>{let t=o.parseResponse(e),a=t.street;""!==t.city&&(a+=" "+t.city),i.value=a}).catch(e=>console.log(e||"An error occurs in the geoCoder"))}return o=ee(),o.title=b.getText("WayPointPropertiesDialog - Waypoint properties"),o.okButtonListener=l,n=a.create("div",{id:"TravelNotes-WayPointPropertiesDialog-DataDiv"},o.content),a.create("div",{innerHTML:b.getText("WayPointPropertiesDialog - Name")},n),r=a.create("input",{type:"text",value:e.name,className:"TravelNotes-WayPointPropertiesDialog-Input"},a.create("div",null,n)),function(){let t=a.create("div",null,n);a.create("div",{className:"TravelNotes-BaseDialog-Button",title:b.getText("WayPointPropertiesDialog - Reset address"),innerHTML:"&#x1f504;"},t).addEventListener("click",s,!1),a.create("text",{value:b.getText("WayPointPropertiesDialog - Address")},t),i=a.create("input",{type:"text",value:e.address,className:"TravelNotes-WayPointPropertiesDialog-Input"},a.create("div",null,n))}(),o})($.travel.editedRoute.wayPoints.getAt(e)).show().then(()=>{ve.dispatch("setrouteslist"),ve.dispatch("showitinerary"),ve.dispatch("roadbookupdate")}).catch(e=>console.log(e||"An error occurs in the waypoint properties dialog"))}});function Qt(e,a){let o=e.target.objId,n=Le.getRoute(o),r=Ee();let i=Ge(e,function(){let a=[{context:Jt,name:b.getText("RouteContextMenu - Edit this route"),action:o===$.travel.editedRoute.objId||d.editedChanged===$.travel.editedRoute.editionStatus?null:Jt.editRoute,param:o},{context:Jt,name:b.getText("RouteContextMenu - Delete this route"),action:o===$.travel.editedRoute.objId&&d.editedChanged===$.travel.editedRoute.editionStatus?null:Jt.removeRoute,param:o},n.hidden?{context:Jt,name:b.getText("RouteContextMenu - Show this route"),action:Jt.showRoute,param:o}:{context:Jt,name:b.getText("RouteContextMenu - Hide this route"),action:$.travel.editedRoute.objId===o?null:Jt.hideRoute,param:o},{context:Jt,name:b.getText("RouteContextMenu - Properties"),action:n.hidden?null:Jt.routeProperties,param:o},{context:r,name:b.getText("RouteContextMenu - Zoom to route"),action:r.zoomToRoute,param:o},{context:Nt,name:b.getText("RouteContextMenu - View the elevation"),action:n.itinerary.hasProfile?Nt.showProfile:null,param:o}];return t.printRouteMap.isEnabled&&a.push({context:Jt,name:b.getText("RouteContextMenu - Print route map"),action:Jt.printRouteMap,param:o}),a=a.concat([{context:Jt,name:b.getText("RouteContextMenu - Save this route in a GPX file"),action:0<n.itinerary.itineraryPoints.length?Jt.saveGpx:null,param:o},{context:qt,name:b.getText("RouteContextMenu - Invert waypoints"),action:$.travel.editedRoute.objId===o?qt.reverseWayPoints:null},{context:mt,name:b.getText("RouteContextMenu - Add a note on the route"),action:e.fromUI?null:mt.newRouteNote,param:o},{context:mt,name:b.getText("RouteContextMenu - Create a note for each route maneuver"),action:n.hidden?null:mt.addAllManeuverNotes,param:o},{context:Jt,name:b.getText("RouteContextMenu - Save modifications on this route"),action:$.travel.editedRoute.objId===o?Jt.saveEdition:null},{context:Jt,name:b.getText("RouteContextMenu - Cancel modifications on this route"),action:$.travel.editedRoute.objId===o?Jt.cancelEdition:null}]),a}(),a);return Object.seal(i)}function _t(e,t){let a=e.noteObjId||e.target.objId,o=Ee();let n=Ge(e,function(){let e=Le.getNoteAndRoute(a).route;return[{context:mt,name:b.getText("NoteContextMenu - Edit this note"),action:mt.editNote,param:a},{context:mt,name:b.getText("NoteContextMenu - Delete this note"),action:mt.removeNote,param:a},{context:o,name:b.getText("NoteContextMenu - Zoom to note"),action:o.zoomToNote,param:a},{context:mt,name:e?b.getText("NoteContextMenu - Detach note from route"):b.getText("NoteContextMenu - Attach note to route"),action:0!==$.travel.routes.length&&-1===$.editedRouteObjId?e?mt.detachNoteFromRoute:mt.attachNoteToRoute:null,param:a}]}(),t);return Object.seal(n)}function $t(e,t){let o=t.note,n=a.create("div");if(0!==o.tooltipContent.length&&a.create("div",{className:e+"NoteHtml-TooltipContent",innerHTML:o.tooltipContent},n),0!==o.popupContent.length&&a.create("div",{className:e+"NoteHtml-PopupContent",innerHTML:o.popupContent},n),0!==o.address.length&&a.create("div",{className:e+"NoteHtml-Address",innerHTML:b.getText("HTMLViewsFactory - Address")+o.address},n),0!==o.phone.length&&a.create("div",{className:e+"NoteHtml-Phone",innerHTML:b.getText("HTMLViewsFactory - Phone")+o.phone},n),0!==o.url.length&&a.create("a",{href:o.url,target:"_blank",innerHTML:o.url.substr(0,40)+"..."},a.create("div",{className:e+"NoteHtml-Url",innerHTML:b.getText("HTMLViewsFactory - Link")},n)),a.create("div",{className:e+"NoteHtml-LatLng",innerHTML:b.getText("HTMLViewsFactory - Latitude Longitude",{lat:y.formatLat(o.lat),lng:y.formatLng(o.lng)})},n),t.route){t.route.chain&&a.create("div",{className:e+"NoteHtml-Distance",innerHTML:b.getText("HTMLViewsFactory - Distance from start of travel",{distance:y.formatDistance(o.chainedDistance+o.distance)})},n),a.create("div",{className:e+"NoteHtml-Distance",innerHTML:b.getText("HTMLViewsFactory - Distance from start of route",{distance:y.formatDistance(o.distance)})},n);let r=t.route.notes.next(o.objId);if(r){let t=r.distance-o.distance;9<t&&a.create("div",{className:e+"NoteHtml-NextDistance",innerHTML:b.getText("HTMLViewsFactory - Next note after&nbsp;:&nbsp;{distance}",{distance:y.formatDistance(t)})},n)}}return n}function ea(e,o){let n=a.create("div"),r=a.create("div",{className:e+"Travel-Notes-IconCell",innerHTML:o.note.iconContent},n);"svg"===r.firstChild.tagName&&"TravelNotes-Roadbook-"===e&&r.firstChild.setAttributeNS(null,"viewBox","0 0 "+t.note.svgIconWidth+" "+t.note.svgIconWidth);let i=$t(e,o);return i.className=e+"Travel-Notes-Cell",n.appendChild(i),n.noteObjId=o.note.objId,n}function ta(e){let t=a.create("div",{className:e+"Travel-Notes"}),o=$.travel.notes.iterator;for(;!o.done;){let a=ea(e,{note:o.value,route:null});a.className=e+"Travel-Notes-Row",t.appendChild(a)}return t}function aa(e,t){let o=a.create("div",{className:e+"Route-Header",id:"route"+t.objId});return a.create("div",{className:e+"Route-Header-Name",innerHTML:t.computedName},o),0!==t.distance&&a.create("div",{className:e+"Route-Header-Distance",innerHTML:b.getText("HTMLViewsFactory - Distance",{distance:y.formatDistance(t.distance)})},o),$.travel.readOnly||"bike"===t.itinerary.transitMode||a.create("div",{className:e+"Route-Header-Duration",innerHTML:b.getText("HTMLViewsFactory - Duration",{duration:y.formatTime(t.duration)})},o),t.itinerary.hasProfile&&(a.create("div",{className:e+"Route-Header-Ascent",innerHTML:b.getText("HTMLViewsFactory - Ascent",{ascent:t.itinerary.ascent.toFixed(0)})},o),a.create("div",{className:e+"Route-Header-Descent",innerHTML:b.getText("HTMLViewsFactory - Descent",{descent:t.itinerary.descent.toFixed(0)})},o)),o}function oa(e,t){let o=a.create("div");a.create("div",{className:e+"Route-ManeuversAndNotes-IconCell TravelNotes-ManeuverNote-"+t.maneuver.iconName},o);let r=a.create("div",{className:e+"Route-ManeuversAndNotes-Cell"},o);return a.create("div",{innerHTML:t.maneuver.instruction},r),t.route.chain&&a.create("div",{innerHTML:b.getText("HTMLViewsFactory - Distance from start of travel",{distance:y.formatDistance(t.route.chainedDistance+t.maneuverDistance)})},r),a.create("div",{innerHTML:b.getText("HTMLViewsFactory - Distance from start of route",{distance:y.formatDistance(t.maneuverDistance)})},r),n.defaultValue<t.maneuver.distance&&a.create("div",{innerHTML:b.getText("HTMLViewsFactory - Next maneuver after&nbsp;:&nbsp;{distance}",{distance:y.formatDistance(t.maneuver.distance)})},r),o}function na(e,t){let o=[],n=t.notes.iterator;for(;!n.done;){let a=ea(e,{note:n.value,route:t});a.className=e+"Route-Notes-Row",a.objId=p(),a.latLng=n.value.latLng,a.noteObjId=n.value.objId,a.distance=n.value.distance,o.push(a)}let r=t.itinerary.maneuvers.iterator,i=0;for(;!r.done;){let a=oa(e,{route:t,maneuver:r.value,maneuverDistance:i});a.className=e+"Route-Maneuvers-Row",a.objId=p(),a.latLng=t.itinerary.itineraryPoints.getAt(r.value.itineraryPointObjId).latLng,a.maneuverObjId=r.value.objId,a.distance=i,o.push(a),i+=r.value.distance}o.sort((e,t)=>e.distance-t.distance);let l=a.create("div",{className:e+"Route-ManeuversAndNotes"});return o.forEach(e=>l.appendChild(e)),l}function ra(e,t){let o="";return""!==t.itinerary.provider&&""!==t.itinerary.transitMode&&(o=b.getText("HTMLViewsFactory - Itinerary computed by {provider} and optimized for {transitMode}",{provider:t.itinerary.provider,transitMode:b.getText("HTMLViewsFactory - TransitMode "+t.itinerary.transitMode)})),a.create("div",{className:e+"RouteFooter",innerHTML:o})}function ia(e,t){let o=a.create("div",{className:e+"RouteProfile",innerHTML:b.getText("HTMLViewsFactory - Profile")});return o.appendChild(ft().createSvg(t)),o}function la(e){let o=a.create("div",{className:e+"Travel"});o.appendChild(function(e){let o=a.create("div",{className:e+"Travel-Header"});a.create("div",{className:e+"Travel-Header-Name",innerHTML:$.travel.name},o);let r=n.defaultValue,i=0,l=0,s=$.travel.routes.iterator;for(;!s.done;){let n=s.value.objId===$.editedRouteObjId&&t.routeEditor.displayEditionInHTMLPage?$.travel.editedRoute:s.value,d=a.create("div",{className:e+"Travel-Header-RouteName"},o);a.create("a",{href:"#route"+n.objId,innerHTML:n.computedName},d),a.create("text",{value:" : "+y.formatDistance(n.distance)+"."},d),n.chain&&(r+=n.distance,i+=n.itinerary.ascent,l+=n.itinerary.descent)}return a.create("div",{className:e+"Travel-Header-TravelDistance",innerHTML:b.getText("HTMLViewsFactory - Travel distance&nbsp;:&nbsp;{distance}",{distance:y.formatDistance(r)})},o),0!==i&&a.create("div",{className:e+"Travel-Header-TravelAscent",innerHTML:b.getText("HTMLViewsFactory - Travel ascent&nbsp;:&nbsp;{ascent}",{ascent:i.toFixed(0)})},o),0!==l&&a.create("div",{className:e+"Travel-Header-TravelDescent",innerHTML:b.getText("HTMLViewsFactory - Travel descent&nbsp;:&nbsp;{descent}",{descent:l.toFixed(0)})},o),o}(e)),o.appendChild(ta(e));let r=$.travel.routes.iterator;for(;!r.done;){let a=t.routeEditor.displayEditionInHTMLPage&&r.value.objId===$.editedRouteObjId?$.travel.editedRoute:r.value;o.appendChild(aa(e,a)),a.itinerary.hasProfile&&o.appendChild(ia(e,a)),o.appendChild(na(e,a)),o.appendChild(ra(e,a))}return o.appendChild(function(e){return a.create("div",{className:e+"TravelFooter",innerHTML:b.getText("HTMLViewsFactory - Travel footer")})}(e)),o}const sa=Object.freeze(new class{getTravelHTML(e){return la(e)}getNoteTextHTML(e,t){return $t(e,t)}getEditedRouteManeuversAndNotesHTML(e){return na(e,$.travel.editedRoute)}getTravelNotesHTML(e){return ta(e)}getRouteHeaderHTML(e,t){return aa(e,t)}});let da=null,ca=null;function ua(e){let t=Le.getRoute(e.target.objId),a=Pe.getClosestLatLngDistance(t,[e.latlng.lat,e.latlng.lng]).distance;a+=t.chainedDistance,a=y.formatDistance(a);let o=$.mapObjects.get(e.target.objId);o.closeTooltip();let n=t.computedName;$.travel.readOnly||(n+=0===n.length?"":" - ",n+=a),o.setTooltipContent(n),o.openTooltip(e.latlng)}function ga(e,t){t.objId=e,t.addTo($.map),$.mapObjects.set(e,t)}function va(e){let a=Le.getNoteAndRoute(e).note,o=L.marker(a.latLng,{icon:L.divIcon({iconSize:[t.note.grip.size,t.note.grip.size],iconAnchor:[t.note.grip.size/2,t.note.grip.size/2],html:"<div></div>",className:"TravelNotes-Note-Bullet"}),opacity:t.note.grip.opacity,draggable:!$.travel.readOnly});o.objId=a.objId;let n=L.divIcon({iconSize:[a.iconWidth,a.iconHeight],iconAnchor:[a.iconWidth/2,a.iconHeight/2],popupAnchor:[0,-a.iconHeight/2],html:a.iconContent,className:"TravelNotes-AllNotes "+t.note.style});let r=L.marker(a.iconLatLng,{zIndexOffset:100,icon:n,draggable:!$.travel.readOnly});r.objId=a.objId,r.bindPopup(e=>sa.getNoteTextHTML("TravelNotes-",Le.getNoteAndRoute(e.objId))),0!==a.tooltipContent.length&&(r.bindTooltip(e=>Le.getNoteAndRoute(e.objId).note.tooltipContent),r.getTooltip().options.offset[0]=a.iconWidth/2);let i=L.polyline([a.latLng,a.iconLatLng],t.note.polyline);i.objId=a.objId;let l=L.layerGroup([r,i,o]);return l.markerId=L.Util.stamp(r),l.polylineId=L.Util.stamp(i),l.bulletId=L.Util.stamp(o),ga(a.objId,l),Object.freeze({marker:r,polyline:i,bullet:o})}function pa(e){e.dashArray>=t.route.dashChoices.length&&(e.dashArray=0);let a=t.route.dashChoices[e.dashArray].iDashArray;if(a){let t="",o=0;for(o=0;o<a.length-1;o++)t+=a[o]*e.width+",";return t+=a[o]*e.width,t}return null}const ha=Object.seal(new class{addRoute(e){let t=Le.getRoute(e),a=[],o=t.itinerary.itineraryPoints.iterator;for(;!o.done;)a.push(o.value.latLng);let n=L.polyline(a,{color:t.color,weight:t.width,dashArray:pa(t)});ga(t.objId,n),d.notEdited===t.editionStatus&&(n.bindTooltip(t.computedName,{sticky:!0,direction:"right"}),n.on("mouseover",ua),n.on("mousemove",ua)),n.bindPopup(e=>{let t=Le.getRoute(e.objId);return sa.getRouteHeaderHTML("TravelNotes-UI-",t)}),L.DomEvent.on(n,"click",e=>e.target.openPopup(e.latlng));let r=t.notes.iterator;for(;!r.done;)va(r.value.objId);return t}addNote(e){return va(e)}getDashArray(e){return pa(e)}zoomTo(e,a){if(a){let e=[];a.forEach(t=>e=e.concat(t)),$.map.fitBounds(Pe.getLatLngBounds(e))}else $.map.setView(e,t.itineraryPointZoom)}setLayer(e){let t=null;t="wmts"===e.service.toLowerCase()?L.tileLayer(e.url):L.tileLayer.wms(e.url,e.wmsOptions),da&&$.map.removeLayer(da),$.map.addLayer(t),da=t,$.travel.readOnly||($.map.getZoom()<(e.minZoom||0)&&$.map.setZoom(e.minZoom||0),$.map.setMinZoom(e.minZoom||0),$.map.getZoom()>(e.maxZoom||18)&&$.map.setZoom(e.maxZoom||18),$.map.setMaxZoom(e.maxZoom||18),e.bounds?($.map.getBounds().intersects(e.bounds)&&!$.map.getBounds().contains(e.bounds)||($.map.setMaxBounds(null),$.map.fitBounds(e.bounds),$.map.setZoom(e.minZoom||0)),$.map.setMaxBounds(e.bounds)):$.map.setMaxBounds(null)),$.map.fire("baselayerchange",t)}onGeolocationStatusChanged(e){r.active!==e&&ca&&($.map.removeLayer(ca),ca=null)}onGeolocationPositionChanged(e){let a=t.geoLocation.zoomToPosition;ca&&($.map.removeLayer(ca),a=!1),ca=L.circleMarker(L.latLng(e.coords.latitude,e.coords.longitude),{radius:t.geoLocation.radius,color:t.geoLocation.color}).bindTooltip(y.formatLatLng([e.coords.latitude,e.coords.longitude])).addTo($.map),a&&$.map.setView(L.latLng(e.coords.latitude,e.coords.longitude),t.geoLocation.zoomFactor)}});let ma=null,fa=null,ba=1;function ya(){ma&&(L.DomEvent.off(ma),$.map.removeLayer(ma),ma=null)}function Ta(){L.DomEvent.off(ma,"mouseout",ya)}function Na(e){e.latlng.lat=fa[0],e.latlng.lng=fa[1],e.target.objId=$.travel.editedRoute.objId,Qt(e).show()}function La(e){qt.addWayPointOnRoute(fa,[e.target.getLatLng().lat,e.target.getLatLng().lng]),ma&&(L.DomEvent.off(ma,"dragstart",Ta),L.DomEvent.off(ma,"dragend",La),L.DomEvent.off(ma,"contextmenu",Na),$.map.removeLayer(ma),ma=null)}function wa(e){let t=Le.getNoteAndRoute(e.target.objId),a=t.note,o=t.route,n=$.mapObjects.get(e.target.objId);if(null===o)a.latLng=[e.target.getLatLng().lat,e.target.getLatLng().lng],ve.dispatch("updatetravelnotes");else{let t=Pe.getClosestLatLngDistance(o,[e.target.getLatLng().lat,e.target.getLatLng().lng]);a.latLng=t.latLng,a.distance=t.distance,o.notes.sort((e,t)=>e.distance-t.distance),n.getLayer(n.bulletId).setLatLng(t.latLng),ve.dispatch("updateitinerary")}n.getLayer(n.polylineId).setLatLngs([a.latLng,a.iconLatLng]),ve.dispatch("roadbookupdate")}function Ia(e){let t=Le.getNoteAndRoute(e.target.objId).note,a=$.mapObjects.get(e.target.objId);a.getLayer(a.polylineId).setLatLngs([[e.latlng.lat,e.latlng.lng],t.iconLatLng])}function xa(e){e.originalEvent.target.style.opacity=t.note.grip.moveOpacity}function Aa(e){e.originalEvent.target.style.opacity=t.note.grip.opacity}function ja(e){_t(e).show()}function Pa(e){let t=Le.getNoteAndRoute(e.target.objId).note;t.iconLatLng=[e.target.getLatLng().lat,e.target.getLatLng().lng];let a=$.mapObjects.get(e.target.objId);a.getLayer(a.polylineId).setLatLngs([t.latLng,t.iconLatLng])}function Ea(e){let t=Le.getNoteAndRoute(e.target.objId).note,a=$.mapObjects.get(e.target.objId);a.getLayer(a.polylineId).setLatLngs([t.latLng,[e.latlng.lat,e.latlng.lng]])}function Ma(e){let a=Le.getRoute(e.target.objId);if(d.notEdited!==a.editionStatus)if(fa=[e.latlng.lat,e.latlng.lng],ma)ma.setLatLng(e.latlng);else{let a='<div class="TravelNotes-WayPoint TravelNotes-WayPointTmp"></div><div class="TravelNotes-WayPointText">?</div>';ma=L.marker(e.latlng,{icon:L.divIcon({iconSize:[40,40],iconAnchor:[20,40],html:a,className:"TravelNotes-WayPointStyle"}),draggable:!0}),(-1===t.route.showDragTooltip||ba<=t.route.showDragTooltip)&&(ba++,ma.bindTooltip(b.getText("MapEditor - Drag and drop to add a waypoint")),ma.getTooltip().options.offset=[0,0]),ma.addTo($.map),L.DomEvent.on(ma,"mouseout",ya),L.DomEvent.on(ma,"dragstart",Ta),L.DomEvent.on(ma,"dragend",La),L.DomEvent.on(ma,"contextmenu",Na)}}function Da(e){Qt(e).show()}function Ra(e){(function(e){let t=e.target.objId,a=Ge(e,function(){let e=$.travel.editedRoute.wayPoints.first.objId!==t&&$.travel.editedRoute.wayPoints.last.objId!==t;return[{context:qt,name:b.getText("WayPointContextMenu - Delete this waypoint"),action:e?qt.removeWayPoint:null,param:t},{context:qt,name:b.getText("WayPointContextMenu - Modify properties"),action:qt.wayPointProperties,param:t}]}());return Object.seal(a)})(e).show()}function Oa(e){$.travel.editedRoute.wayPoints.getAt(e.target.objId).latLng=[e.target.getLatLng().lat,e.target.getLatLng().lng],qt.wayPointDragEnd(e.target.objId)}function Ca(e,t){t.objId=e,t.addTo($.map),$.mapObjects.set(e,t)}function Sa(e){let t=$.mapObjects.get(e);t&&(L.DomEvent.off(t),$.map.removeLayer(t),$.mapObjects.delete(e))}function Ua(e,t){if(s.defaultValue===e.lat&&s.defaultValue===e.lng)return;let a='<div class="TravelNotes-WayPoint TravelNotes-WayPoint'+("A"===t?"Start":"B"===t?"End":"Via")+'"></div><div class="TravelNotes-WayPointText">'+t+"</div>",o=L.marker(e.latLng,{icon:L.divIcon({iconSize:[40,40],iconAnchor:[20,40],html:a,className:"TravelNotes-WayPointStyle"}),draggable:!0});o.bindTooltip(e=>Le.getWayPoint(e.objId).fullName),o.getTooltip().options.offset=[20,-20],L.DomEvent.on(o,"contextmenu",Ra),o.objId=e.objId,Ca(e.objId,o),L.DomEvent.on(o,"dragend",Oa)}const ka=Object.seal(new class{updateRoute(e,t){-1!==e&&function(e){let t=Le.getRoute(e);Sa(t.objId);let a=t.notes.iterator;for(;!a.done;)Sa(a.value.objId);let o=t.wayPoints.iterator;for(;!o.done;)Sa(o.value.objId)}(e),-1!==t&&function(e){let t=ha.addRoute(e),a=$.mapObjects.get(e);if(!$.travel.readOnly){L.DomEvent.on(a,"contextmenu",Da),L.DomEvent.on(a,"mouseover",Ma);let e=t.notes.iterator;for(;!e.done;){let t=$.mapObjects.get(e.value.objId),a=t.getLayer(t.markerId),o=t.getLayer(t.bulletId);L.DomEvent.on(o,"dragend",wa),L.DomEvent.on(o,"drag",Ia),L.DomEvent.on(o,"mouseenter",xa),L.DomEvent.on(o,"mouseleave",Aa),L.DomEvent.on(a,"contextmenu",ja),L.DomEvent.on(a,"dragend",Pa),L.DomEvent.on(a,"drag",Ea)}}if(!$.travel.readOnly&&d.notEdited!==t.editionStatus){let e=$.travel.editedRoute.wayPoints.iterator;for(;!e.done;)Ua(e.value,e.first?"A":e.last?"B":e.index)}}(t)}updateRouteProperties(e){let t=$.mapObjects.get(e),a=Le.getRoute(e);t.setStyle({color:a.color,weight:a.width,dashArray:ha.getDashArray(a)})}updateNote(e,t){let a=!1;if(-1!==e){let t=$.mapObjects.get(e);t&&(a=t.getLayer(t.markerId).isPopupOpen()),Sa(e)}-1!==t&&function(e,t){let a=ha.addNote(e);t&&a.marker.openPopup(),$.travel.readOnly||(L.DomEvent.on(a.bullet,"dragend",wa),L.DomEvent.on(a.bullet,"drag",Ia),L.DomEvent.on(a.bullet,"mouseenter",xa),L.DomEvent.on(a.bullet,"mouseleave",Aa),L.DomEvent.on(a.marker,"contextmenu",ja),L.DomEvent.on(a.marker,"dragend",Pa),L.DomEvent.on(a.marker,"drag",Ea))}(t,a)}removeObject(e){Sa(e)}removeAllObjects(){$.mapObjects.forEach(e=>{L.DomEvent.off(e),$.map.removeLayer(e)}),$.mapObjects.clear()}addWayPoint(e,t){Ua(e,t)}addItineraryPointMarker(e,a){Ca(e,L.circleMarker(a,t.itineraryPointMarker))}addSearchPointMarker(e,a,o){let n=!1;if(o){let e=[];o.forEach(t=>{e=e.concat(t)});let t=Pe.getLatLngBounds(e),a=$.map.getBounds();n=(t.getEast()-t.getWest())/(a.getEast()-a.getWest())>.01&&(t.getNorth()-t.getSouth())/(a.getNorth()-a.getSouth())>.01}Ca(e,n?L.polyline(o,t.searchPointPolyline):L.circleMarker(a,t.searchPointMarker))}addRectangle(e,t,a){Ca(e,L.rectangle(t,a))}setLayer(e){let t=e.url;if(e.providerKeyNeeded){let a=Ne.getKey(e.providerName.toLowerCase());if(!a)return;t=t.replace("{providerKey}",a)}e.url=t,ha.setLayer(e)}});var Ha={};function Ba(e){return Math.floor(Math.abs(e)+.5)*(e>=0?1:-1)}function Fa(e,t,a){var o=(e=Ba(e*a))-(t=Ba(t*a));o<<=1,e-t<0&&(o=~o);for(var n="";o>=32;)n+=String.fromCharCode(63+(32|31&o)),o>>=5;return n+=String.fromCharCode(o+63)}function Va(e){for(var t=[],a=0;a<e.length;a++){var o=e[a].slice();t.push([o[1],o[0]])}return t}function Wa(){function e(e){let t={};0!==e.itinerary.itineraryPoints.length&&(t=e.itinerary.itineraryPoints[0].objType);let a={latLngs:[],distances:[],elevs:[],objIds:[],objType:t};e.itinerary.itineraryPoints.forEach(e=>{a.latLngs.push([e.lat,e.lng]),a.distances.push(e.distance),a.elevs.push(e.elev),a.objIds.push(e.objId)}),a.latLngs=Ha.encode(a.latLngs,6),e.itinerary.itineraryPoints=a}function t(e){e.itinerary.itineraryPoints.latLngs=Ha.decode(e.itinerary.itineraryPoints.latLngs,6);let t=[],a=0;e.itinerary.itineraryPoints.latLngs.forEach(o=>{let n={};n.lat=o[0],n.lng=o[1],n.distance=e.itinerary.itineraryPoints.distances[a],e.itinerary.itineraryPoints.elevs?n.elev=e.itinerary.itineraryPoints.elevs[a]:n.elev=l.defaultValue,n.objId=e.itinerary.itineraryPoints.objIds[a],n.objType=e.itinerary.itineraryPoints.objType,t.push(n),a++}),e.itinerary.itineraryPoints=t}function a(e){e.routes.forEach(t),e.editedRoute&&t(e.editedRoute)}return Object.seal(new class{decompress(e){a(e),$.travel.jsonObject=e,$.editedRouteObjId=-1,$.travel.routes.forEach(e=>{d.notEdited!==e.editionStatus&&($.editedRouteObjId=e.objId)})}decompressMerge(e){a(e);let t=J();t.jsonObject=e;let o=t.routes.iterator;for(;!o.done;)$.travel.routes.add(o.value);let n=t.notes.iterator;for(;!n.done;)$.travel.notes.add(n.value)}compress(){let t=$.travel.jsonObject;return t.routes.forEach(e),e(t.editedRoute),t}})}Ha.decode=function(e,t){for(var a,o=0,n=0,r=0,i=[],l=0,s=0,d=null,c=Math.pow(10,Number.isInteger(t)?t:5);o<e.length;){d=null,l=0,s=0;do{s|=(31&(d=e.charCodeAt(o++)-63))<<l,l+=5}while(d>=32);a=1&s?~(s>>1):s>>1,l=s=0;do{s|=(31&(d=e.charCodeAt(o++)-63))<<l,l+=5}while(d>=32);n+=a,r+=1&s?~(s>>1):s>>1,i.push([n/c,r/c])}return i},Ha.encode=function(e,t){if(!e.length)return"";for(var a=Math.pow(10,Number.isInteger(t)?t:5),o=Fa(e[0][0],0,a)+Fa(e[0][1],0,a),n=1;n<e.length;n++){var r=e[n],i=e[n-1];o+=Fa(r[0],i[0],a),o+=Fa(r[1],i[1],a)}return o},Ha.fromGeoJSON=function(e,t){if(e&&"Feature"===e.type&&(e=e.geometry),!e||"LineString"!==e.type)throw new Error("Input must be a GeoJSON LineString");return Ha.encode(Va(e.coordinates),t)},Ha.toGeoJSON=function(e,t){return{type:"LineString",coordinates:Va(Ha.decode(e,t))}},"object"==typeof module&&module.exports&&(module.exports=Ha);const za=Object.seal(new class{routeDropped(e,t,a){$.travel.routes.moveTo(e,t,a),Jt.chainRoutes(),ve.dispatch("setrouteslist"),ve.dispatch("roadbookupdate")}saveTravel(){let e=$.travel.routes.iterator;for(;!e.done;)e.value.hidden=!1;let t=Wa().compress($.travel);y.saveFile(t.name+".trv",JSON.stringify(t))}clear(){window.confirm(b.getText("TravelEditor - This page ask to close; data are perhaps not saved."))&&(Nt.deleteAllProfiles(),ve.dispatch("removeallobjects"),$.travel.editedRoute=K(),$.editedRouteObjId=-1,$.travel=J(),$.travel.routes.add(K()),ve.dispatch("setrouteslist"),ve.dispatch("showitinerary"),ve.dispatch("roadbookupdate"),ve.dispatch("travelnameupdated"),t.travelEditor.startupRouteEdition&&Jt.editRoute($.travel.routes.first.objId))}});function Ka(){return Object.seal(new class{openDistantFile(e){Wa().decompress(e),$.travel.readOnly=!0,this.display()}display(){let e=$.travel.routes.iterator;for(;!e.done;)d.notEdited===e.value.editionStatus&&ve.dispatch("routeupdated",{removedRouteObjId:-1,addedRouteObjId:e.value.objId});-1!==$.editedRouteObjId&&ve.dispatch("routeupdated",{removedRouteObjId:-1,addedRouteObjId:$.travel.editedRoute.objId});let t=$.travel.notes.iterator;for(;!t.done;)ve.dispatch("noteupdated",{removedNoteObjId:-1,addedNoteObjId:t.value.objId});Ee().zoomToTravel()}})}function Xa(){function e(e,t){let a=new FileReader;a.onload=function(){let e={};try{e=JSON.parse(a.result)}catch(e){console.log(e||"An error occurs when reading the file")}t?Wa().decompressMerge(e):(Nt.deleteAllProfiles(),Wa().decompress(e)),function(){if(ve.dispatch("removeallobjects"),Ka().display(),Ft.setLayer($.travel.layerName),ve.dispatch("setrouteslist"),-1!==$.editedRouteObjId){let e=$.travel.editedRoute.itinerary.provider;if(e&&""!==e&&!$.providers.get(e.toLowerCase()))ue.showError(b.getText("FileLoader - Not possible to select as provider",{provider:e}));else{let t=$.travel.editedRoute.itinerary.transitMode;ve.dispatch("setprovider",{provider:e}),t&&""!==t&&ve.dispatch("settransitmode",{transitMode:t})}}Jt.chainRoutes(),ve.dispatch("travelnameupdated"),ve.dispatch("showitinerary"),ve.dispatch("roadbookupdate")}()},a.readAsText(e.target.files[0])}return Object.seal(new class{openLocalFile(t){e(t,!1)}mergeLocalFile(t){e(t,!0)}})}let Za=null,Ga=null,Ja=null,Ya=0,qa=null,Qa=null,_a=null,$a=null;function eo(e){e.deltaY&&(e.target.scrollTop+=e.deltaY*g[e.deltaMode]),e.stopPropagation()}function to(e){$.travel.name=e.target.value,ve.dispatch("roadbookupdate")}function ao(e){e.stopPropagation(),za.clear()}function oo(e){e.stopPropagation(),za.saveTravel()}function no(e){e.stopPropagation(),Xa().openLocalFile(e)}function ro(){window.confirm(b.getText("TravelEditor - This page ask to close; data are perhaps not saved."))&&Qa.click()}function io(e){e.stopPropagation(),Xa().mergeLocalFile(e)}function lo(){-1===$.editedRouteObjId?_a.click():ue.showError(b.getText("TravelUI - Not possible to merge a travel when a route is edited"))}function so(){qa=a.create("div",{className:"TravelNotes-UI-FlexRowDiv"},Ja),a.create("div",{className:"TravelNotes-UI-Button",title:b.getText("TravelUI - Cancel travel"),innerHTML:"&#x274c;"},qa).addEventListener("click",ao,!1),a.create("div",{className:"TravelNotes-UI-Button",title:b.getText("TravelUI - Save travel"),innerHTML:"&#x1f4be;"},qa).addEventListener("click",oo,!1),Qa=a.create("input",{className:"TravelNotes-TravelUI-OpenFileInput",type:"file",accept:".trv"},qa),Qa.addEventListener("change",no,!1),a.create("div",{className:"TravelNotes-UI-Button",title:b.getText("TravelUI - Open travel"),innerHTML:"&#x1F4C2;"},qa).addEventListener("click",ro,!1),_a=a.create("input",{className:"TravelNotes-TravelUI-OpenFileInput",type:"file",accept:".trv,.map"},qa),_a.addEventListener("change",io,!1),a.create("div",{className:"TravelNotes-UI-Button",title:b.getText("TravelUI - Import travel"),innerHTML:"&#x1F30F;"},qa).addEventListener("click",lo,!1),a.create("div",{className:"TravelNotes-UI-Button",title:b.getText("TravelUI - Open travel roadbook"),innerHTML:'<a class="TravelNotes-UI-LinkButton" href="TravelNotesRoadbook.html?lng='+t.language+"&page="+$.UUID+'" target="_blank">&#x1F4CB;</a>'},qa)}function co(e){e.stopPropagation(),Za.classList.toggle("TravelNotes-TravelUI-HiddenRouteList");let t=Za.classList.contains("TravelNotes-TravelUI-HiddenRouteList");e.target.innerHTML=t?"&#x25b6;":"&#x25bc;",e.target.title=t?b.getText("TravelUI - Show"):b.getText("TravelUI - Hide")}function uo(e){e.stopPropagation(),Jt.addRoute()}function go(){$a=a.create("div",{className:"TravelNotes-UI-FlexRowDiv"},Ja),a.create("div",{innerHTML:"&#x25bc;",className:"TravelNotes-TravelUI-RouteList-ExpandButton"},$a).addEventListener("click",co,!1),a.create("span",{innerHTML:b.getText("TravelUI - Travel routes")},$a),a.create("div",{className:"TravelNotes-UI-Button TravelNotes-UI-FlexRow-RightButton",title:b.getText("TravelUI - Add a route"),innerHTML:"+"},$a).addEventListener("click",uo,!1)}function vo(e){e.stopPropagation();try{e.dataTransfer.setData("Text",e.target.objId),e.dataTransfer.dropEffect="move",e.dataTransfer.routeObjId=e.target.objId}catch(e){console.log(e)}Ya=e.target.objId}function po(e){e.preventDefault()}function ho(e){e.preventDefault();let t=e.target;for(;!t.objId;)t=t.parentElement;let a=t.getBoundingClientRect();za.routeDropped(Ya,t.objId,e.clientY-a.top<a.bottom-e.clientY)}function mo(e){e.stopPropagation(),e.preventDefault(),e.latlng={lat:s.defaultValue,lng:s.defaultValue},e.fromUI=!0,e.originalEvent={clientX:e.clientX,clientY:e.clientY},Qt(e,Ja).show()}const fo=Object.freeze(new class{createUI(e){Ja||(Ja=e,function(){let e=a.create("div",{className:"TravelNotes-UI-FlexRowDiv"},Ja);a.create("span",{innerHTML:b.getText("TravelUI - Travel")},e),Ga=a.create("input",{id:"TravelNotes-TravelUI-InputTravelName",type:"text",placeholder:"TravelNotes",value:$.travel.name},e),Ga.addEventListener("change",to,!1)}(),so(),go(),Za=a.create("div",{className:"TravelNotes-TravelUI-RoutesListDiv"},Ja),Za.addEventListener("drop",ho,!1),Za.addEventListener("dragover",po,!1),Za.addEventListener("wheel",eo,!1))}setRoutesList(){for(;Za.firstChild;)Za.firstChild.removeEventListener("dragstart",vo,!1),Za.firstChild.removeEventListener("contextmenu",mo,!1),Za.removeChild(Za.firstChild);let e=$.travel.routes.iterator;for(;!e.done;){let t=e.value.objId===$.editedRouteObjId?$.travel.editedRoute:e.value,o=(e.value.objId===$.editedRouteObjId?"&#x1f534;&nbsp;":"")+(t.chain?"&#x26d3;&nbsp;":"")+t.computedName,n=a.create("div",{draggable:!0,className:"TravelNotes-TravelUI-RoutesList-Item TravelNotes-UI-MoveCursor"+(e.value.hidden?" TravelNotes-TravelUI-RoutesList-HiddenItem":""),objId:e.value.objId===$.editedRouteObjId?$.travel.editedRoute.objId:e.value.objId,canDrag:!0,innerHTML:o},Za);n.addEventListener("dragstart",vo,!1),n.addEventListener("contextmenu",mo,!1)}}setTravelName(){Ga.value=$.travel.name}});let bo=i.invalidPane,yo=new Map,To=null,No=null;function Lo(e){i.invalidPane!==bo&&(yo.get(bo).remove(),To.innerHTML=""),bo=e,yo.get(bo).add(),document.querySelectorAll(".TravelNotes-DataPaneUI-PaneButton").forEach(e=>{e.paneId===bo?e.classList.add("TravelNotes-DataPaneUI-ActivePaneButton"):e.classList.remove("TravelNotes-DataPaneUI-ActivePaneButton")})}function wo(e){Lo(e.target.paneId)}function Io(e){e.deltaY&&(e.target.scrollTop+=e.deltaY*g[e.deltaMode]),e.stopPropagation()}const xo=Object.freeze(new class{createUI(e){if(To)return;let t=a.create("div",{className:"TravelNotes-UI-FlexRowDiv"},e);No=a.create("div",{id:"TravelNotes-PanesManagerUI-PaneControlsDiv"},e),To=a.create("div",{id:"TravelNotes-PanesManagerUI-PaneDataDiv"},e),To.addEventListener("wheel",Io,!1),yo.forEach(e=>{a.create("div",{innerHTML:e.getButtonText(),className:"TravelNotes-DataPaneUI-PaneButton",paneId:e.getId()},t).addEventListener("click",wo,!1),e.setPaneDivs(To,No)})}addPane(e){yo.set(e.getId(),e)}showPane(e){Lo(e)}updatePane(e){e===bo&&Lo(e)}});let Ao=null,jo=!1;const Po=["bike","pedestrian","car","train","line","circle"];let Eo={bike:null,pedestrian:null,car:null,train:null,line:null,circle:null},Mo=null;const Do={bike:"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAB4AAAAeCAIAAAC0Ujn1AAAABmJLR0QAAAAzAJlWvctWAAAACXBIWX\t\tMAAA7EAAAOxAGVKw4bAAAAB3RJTUUH5AEIChYTLGSDtAAAA65JREFUSMftVl1sk1UYfs53vnZft4/R/W+hHaUrbshcQch06VCGWd\t\tBohmNRCRiXKXphZCOacCEYBeOFXHhDlHDjQDEBdKIx9sL4Q8bqtEPqLAOE/YDrGPspa2m7bt/Xr8eLr3WddFuJ88b4Xp285z1P3v\t\tOe533eQ9xud3FxMcdxmMMURWGMUUoJIUjNFEUZHBwkPp8vovBnHVfB7gghACNIsgEQQgjAwBjiAfFIQqqrLBpNhKeU/to9Vr/fic\t\tWzbw6iqrKEQ/Ks/pkxAODwr9n/0HcHLWq5uoqlXMqMTjR+nj2bKWPlcrH9t4komyHRmgLt3pcq0gQNGOr2dSJZMyycteNaSJKjlk\t\tIh0dk9KjnO3QhORtrsV+YmXjzreW576qfxlrrlJUXCrUkWlBgDlmgJI+Tn7pvHfvTOeYzEodncTfP8xoIu93h7XzDR+Vx1vj8kVx\t\toEp2fqrlvGWihsseoFnggCv2JZRql+1pNMK+xL10T5yiyeI6/UFuzbalydq12YIbWW9CMt1u2bDeVm8VCzdZUl+1j7yEPr8wmBlh\t\tJTJg+AEgBI1+L4Gw9OSez8ldsv1JvfbbonKUNi1U6jZNuW0p3vuVRG1K8P6wUc2G4++OlAU03Rh98PV63OKvNNXR8K2oxCqTn747\t\taLgVCkfSBkv+Bvqs5985kV+08OzGTNEoi192lTm71XdTSs1RMl2trhzczUBWXm6vG2PGHcue2+xzeZHNfDWx81vX308tcX/BbTEp\t\tX0rR3jOdnpswqSKPAZomC/FABQadA1PlX+uWsCAM8xAK4Rqb7WvMlmebZhzQ5bXl6u+MC9WS9uzM/R6z7ac796fHJa+XtB/sKOSJ\t\tEqg9DpmXJ6wnWvd8RGRjS273TdqFxnvnh5+BPH2Nqy7N/7/F/5ZABArAiiQNUFpRwATlEUhmnVdeiz/saGWa/xWJkoyxF1vefo1Y\t\twNrR8c7wbQ+kX/q42rEiN3bS76Y+i2uo5GGQCeUhplkuryhJROp+fIbmuXa9h9LfTkw0WimNZ8uGeGrwxDo2EAPV75bOfg4eaK8b\t\tFAKCQtM+i9t8JvneiPQ0cBkEAgcO6XkZrXvksYe3j5kYK8HN2ZrtEz/ZPza1CNRczP0p4+PyEpM3Swv7Nug62UBwBCZ7USw/vfjq\t\tQobz/0BpNoHs8voHzzik9SsUtZVFNH+Y8NMMqRxQWllAdA/H6/RqPr7bvJGBYcgSz28wIhJK49SR7WUlIoy2HidruNRiOldBGzVr\t\t+TfwLXzWMKJ+iQhAAAAABJRU5ErkJggg==",pedestrian:"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAB4AAAAeCAIAAAC0Ujn1AAAABmJLR0QAAAAzAJlWvctWAAAACXBIWX\t\tMAAA7EAAAOxAGVKw4bAAAAB3RJTUUH5AEICholT2tZIQAAAyxJREFUSMetll1IFFEUx/93PtZ13cykJNvWNDXEMkgoyYKICCJISK\t\tkIIYjqpU98kB77loogjCzKCvoQkqigh8ioKKS01NS2grDwY7ddLa3dNVt37r1ze5haLXVzV8/TmTN3fufMYeacP3E4HCkpKZIkYX\t\twmhCCEhD/DOXc6ncTr9TKu1D5vgxj7LCEQYvglAYQQnOuSTAiMTAQGgpDlSzNUlSmyLLe0fl1/6BUmzx6exNIl6RLwV7kygUomzB\t\tYA8G+LuQD9kyoxRrqxf9HFvQtIVMmUMPeqDuevWZUNgDJ917n3kaLDfRhZmUmGE2dRo6g6HLr6bmtQY+5u78kr7ycZ3fCmlzGdUj\t\t01yTyZ6MOb0q6dLYyzmObYE29VFp3Ykjk56HXZU0p2rrDE/m6xJda0c1v+yjTLeIgyCYveujHb0+MfCLBQxOsPHi1dNh40F2HRVm\t\tvMz4AW1IbQZyrrF8637S+wT7QhVovKGedMD0U8Xwau3mzYsyM/XpUmhDaZVKHrus5DEVUmu8+/8/T4LpbmGpFjxelvb6zLSjRFhl\t\tZUhTGu86GqzSYJwL6Dz3Lm21ZnWgEkxMfYbdP8QT0ydMWluoorjRrlnAtKdQCKTAC8cAXKymsvn1p752Desry0/h+D+ZnWyNCVtX\t\t3XG7yDQdbU3F52+nEIDaDq1bfj5c/efei1z060JSdUnS86snluxH+jRjkIqMYAmIZNkXNPejpc/dOmxgLo6PpeVLDQqkiRoRnjBM\t\tTbTwEoyl+Dtbgw25i0U+PNJQce5SSbx0SPOpB1ziVJcvdp/xyYZVEW56YaftJ0K+Woc/4cEz3qXqSUg8DVpwEAGXq/HJv53v0Wd7\t\tfvZVNXp/PbjAQ14l4HBhkAt4/+2bS/rabtR/GJlt6+gYZmV3tnb3XT92jQhBBPvyYEMGKJCcBsVijTo1lg92rarHGqLkRQ46NpD/\t\tHZ4/d0+6NBX3jaYzhOt3f4FDSs8XXXg+fuetdgNOiQzdtwe2Rwe7nj/+NJlqJXHqM+KcsKAOLz+VQ19uOnbiEwht4gMGSZGJJp4S\t\t0jfSalAeJwOOx2uyzLYfTjCAU4Ljn5C1w5SWBHSm1MAAAAAElFTkSuQmCC",car:"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAB4AAAAeCAIAAAC0Ujn1AAAABmJLR0QAAAAzAJlWvctWAAAACXBIWX\t\tMAAA7EAAAOxAGVKw4bAAAAB3RJTUUH5AEICh4hLGpYPAAAAlZJREFUSMfdlk1oE0EUx/+zszEx3UhD0zZYkn5ksfWjlVgrVk1RQV\t\tR6EMFaK9qjggdBRO1NvSiIB8/iyQ/akxepSKteRPxoETXamkQtJAbbBN0ky0boZne8FIu23exqKuhjDgMz78ef/3u8GRIOh/1+P8\t\tdxKF1ompZIJEgmkylo/KPHMTBL6QQzCXM2hGxpF222Ak8pffkqvff88xKqHrqE9g0BDrAo10wwAOCwaPFvovmFDo6Gak4f3+x0gj\t\tHoOjQNTIfOoOvQ9dn93aF3p268tobu3R9sqC+XJACgdGbxPCgFIbPXHPYWa+gKWtbS7M3nIe669VVTfjm1aRUC53AtwYObHXW1rr\t\tZK90haMuv1mZ4VgsBFYlNzuQBU+kUiybiajMYmeR69e0QLZdwW8gMYGU0ZF+rp6GcArcHlZg3Z5K1avaqKMUwkpGNbawzQ2VxB09\t\tDU6Gl0lUVkpQj6xA7xwtntdjsjBBfPdZhpMnc5fXL7wO5DA8+mFCND1gddDgcA8nFCVtUi0OlpRKKyrsPtphuby015PTYuB7r67w\t\t3HjdH3H8abDva/eStZKGOt33n9ZNu6tZXG6NagZ6AvVF+3zEJfCwI93BMs6nJ1tbN730rTM+R3JyxjxVQfuRztu5IaG+4UBORyWL\t\tNz0AD34k6nx4NCAYHQ4Cc1XQStMEVRlR8SEmrSjOT4fNf++lBNpfR8npNlzThZlmG3Y6H2nx8tdl8zo6uh6+p/94AtMppypLRQSn\t\tkAJJvN2mxL33+YZOynR+9PQgx4VfUbCYfDPp+PUlry7+R3HyvZuSYHFFYAAAAASUVORK5CYII=",train:"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAB4AAAAeCAIAAAC0Ujn1AAAABmJLR0QAAAAzAJlWvctWAAAACXBIWX\t\tMAAA7EAAAOxAGVKw4bAAAAB3RJTUUH5AEICiI23EqkBAAABQpJREFUSMetVm1QVFUYfs+55+4u+zEsshK0iuy6iuAHbaSwJhkZNp\t\tWjaWn2oQ2Zk1lmpjMllmNqDYZjM+Y0TdkIg8WYHwU6KjqUIzl8KGhihcgCu8Auu3uBXXfZT+89/cBAYFex8f1173nOfea973ne5z\t\t2oqrouNUWHMYb7CUqBAkWAEAqD8jxvMplRd08vpWzlhRtA74scwe0PRjwgNMegIyRERCypq3cs/qwWHlyc+RIyZ2oxAASCXniwQQ\t\tEAMAB4ff6wG6Yr4YMcVaoi+D/IEUIEAFhCwsL5G6elTEnc8A6RSgnP05vuQOP1juXbrnjpqM4cA4BIxIbFnv/0mnbpyQlLyo6VXU\t\tEIHfn1kiYpLjlmtIkTACAMGwleZZAumK8bo5SFQoGxseyhXxqezkyYYnFVXPPYb5F7UyMU/gfzX43f+P5z5L9yvZWrHoACgUDlhb\t\t9e23LRHkJ3o4Zw6LIZUevW5HCcc++354/+Zp6YIDPoVZN1YxPiY5TRoujo6NSUpIL3uNw9RgExkalHhAwLX3ySTQizeUd5YU0fgL\t\tTJSE8ZHQCOYTvTov1/3pRFpKZ0eCMeLzBoNeofiioKa/p2r4yfnjpeLGb9gWCfx2/nvOZOd7vFIxETsZg0Gb2Tgu4bfkWErKlwxz\t\tt/umD2E3OmHSg+t3Zfc+m2tIULDHc/LquVe2TJ0ZFFx/367n/JfAguFz2TMVOXv+dETb2t6cjCe/ICQEKC6utNqeF1jQADwJsGeW\t\tnh0lDo1surD6VNjdtX8GJS0sOjlPCz8/UaqRAx68na2IMl52+6AysWa2ama1mWHX1bKxTyzbmTwioEAYBCRlSxyrlZ08tOVAGAz+\t\tezO1wWa4+5vcfY2t3U6q66xjl9vEpGdGq5LmmMNIpixDMYE4IZBndYXBHF12J2tpgFrudsZY3l8311tZxoRHJSALB74O/rPFwfrk\t\tI5+BlgeRjUOBlQXnl1t8kVctNeAAAQ3a/VeUCiZjydvHyQemAEbV2rX7QgzcE5u2xOk7nncoOl+LTN5B/SafvXaV56YZYgCEU/VW\t\t840N6/uH6efOVyvcXqXLOjFvjhBaEA8H1Jg9frmZ2p06fp0vV4ySLY+lGoo8PeZHRUXzR9d9xiCTJFx0xPZiXHKOUK2aDt3DD7lU\t\tolBUSGDkrkdrsv1TuyPzw7sDRvAlm1LPFR/WTdRDXDMAN+1GnhzO2cg+tze0L9Zi+RiAiDCRNSKhVJibElR+q2HOoCgDO7MgwZE8\t\tN4SIXplre4dT3GbSabIPCPpSePVcWIxWKtRq3VqCPVus1k3f6z5baaB3U9wvqquujyXc2m9t6sOTNaWjr3Hyj/p7E1GIw4ybju3m\t\t27KgJDp8/d7Pztb9r+qLXtyMuZmqotOXzhqdxTr2SrtBOUcSoFYXiEkVgkkkhoe4fr3b3GPgGPylQHoviS7+Sy0oPb01e9Me/xTN\t\t3HO899dcbZD2XEwabVU+dm6bPnRs3OnFJxrjG/sPlORTF5eXkWq7eo3BiJ3SegHyusgt0cJcGJCezvF7kgMADQ2QeHKx2nTzTIWb\t\tfb7ZPLRbNSotoabbYAWZEzbvy4MQQAGIzu2RE7Szko5QAAYIi31HP09d1NdyxIAIBhCAAgl8vFslHNxi5KASGgdPhkGHmto/T2Fk\t\toppVSgFCggBBhjQMBgPEkXHwr50NWrDYmJ4zFmYMilDwECBEBppBsM9KcSNniebzOZ/gWOPRAUHy2iQwAAAABJRU5ErkJggg==",line:"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAB4AAAAeCAIAAAC0Ujn1AAAABmJLR0QAAAAzAJlWvctWAAAACXBIWX\t\tMAAA7EAAAOxAGVKw4bAAAAB3RJTUUH5AEICiINbUFNIAAAAfZJREFUSMdjvHz5spycHBMTEwP1wN+/fx8/fsz44cOHP39ZDh+9zf\t\tCfJO2MDFANGAxGRhtLFVbWPyzMzMwXLr4ObDxFRVfv6mKwNFNmYmAg0bnEgP8MDAwMZAZxoqXgomJd/GrIMdpCkq270SMi1Iz6Rs\t\t9sdxIW4l2x+hSVjV5UrKunI3fpyqO43svUNDrfVSwi1Oztu8/plfsIKmYiKYhrS50ZGBiau/eeeP6LmkbDg3ji7lfEqGeiehCTZj\t\tRJQYzTaMb/bBQGMU6j/zOia57f60ZSEBMbIBsbTTXUpI6dvE18EMMBCx65mgBpT3e9Fy8/FLccxZUcE4OUv//4XTD3DglGW0iyle\t\tY7MTAwVLXsRgtiiIl21srKSuKsLMyPn7wlzej5vW58vJyz5h+ef/w9VhN///l7997LQ0fvzl93l4QAgQdx+tTrAVrcUQFqxoZysr\t\tIiaCbiTzAsuIL40+fvb958ubvaX0lRnIGB4fv3X9dvPD1x+iFBE3EaDQliVhZmVl5OP2/D799/nTl3/+jJ+1hDkzSjixK1+Xg5v3\t\t//dfX6U/JMxGl03/yrl669atnwlPIKEt3oE89/naCGueRXu4PAaGYmRuoayszMwsDAwPjx40dWVs47d1/8/8/ASCUrVJQlfv/+zn\t\tj58mVZWVlmZmaqNycB+D3rTYmxQpEAAAAASUVORK5CYII=",circle:"data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAAB4AAAAeCAIAAAC0Ujn1AAAABmJLR0QAAAAzAJlWvctWAAAACXBIWX\t\tMAAA7EAAAOxAGVKw4bAAAAB3RJTUUH5AEICiEaxb+bJAAAAqNJREFUSMdjvHz5spycHBMTEwP1wN+/fx8/fsz44cOHP39ZDh+9zf\t\tCfJO2MDFANGAxGRhtLFVbWPyzMzMwXLr4ObDxFRVfv6mKwNFNmYmAg0bnEgP8MDAwMTAw0Ayz4pS0k2RKDlO2slUVFeIWFeBkYGN\t\t6++/z6zedDR+/OX3f3xPNfZBo9M1szIsTk48dvBw7fOnvp5cTdrxgYGPJdxYz1xD1dtWIjzBevOJk+9TrJRu/vszUyVJg6+1DVso\t\tfI4hN3v2LY/Yqh93JNgHRpvpOOloR19n6sJjDhMldZSSw+ex2aucigZcNT96iVstJCR6c6Emv0zGxNI0OFvKodG659xR8TJ57/Cs\t\tvcrKMlMzNbk7DRFpJssRHm3RP3ETQXbnr3xH2xEeYWkmwEjE4MUn7z9nPLhqfEJ7KWDU/fvP2cFaVOwGg7a+UDh2+RmoS3775mai\t\txPwGhREd6zl16SavSJcy+kJAUJGC0sxAtJvySB+cff8/FyEpX4qALQjf70+Xu+qxippiRaCn76/J2A0c+evzfWEyfVaAsjiWfP3x\t\tMw+vTZhw62aqQabWetfPrsQwJGT1t2U0SYty1KnnhzawKk5WVFpi27ScDoE89/LV5xMjvVDjN34Sp1S/OdFq84iVnAYkkh6VOvX7\t\tn2ZNV0X4KmW0iyrZrue+XaE6xFK/bEZ529//HTdzuXhdcESOMJh53Lwh8/fYerUMVZXltn75+ZrVlV7JoY/X7PgVsnzr2Yf/w9JJ\t\t1ZGEm4OKhJSgiSWRVAQmb+urtZUep21soRISbzeDkhCf/Z8/dHT9ybtuwm+RUYJFZP9F5mYLhMhdxI5YzOzMRIXUOZmVkYGBgYP3\t\t78yMrKeefui///GRipZIWKssTv398ZL1++LCsry8zMTPXmJADJwQv2CCSQygAAAABJRU5ErkJggg=="};function Ro(e){$.routing.transitMode=e;let t=document.querySelector(".TravelNotes-ProvidersToolbarUI-ActiveTransitModeImgButton");t&&t.classList.remove("TravelNotes-ProvidersToolbarUI-ActiveTransitModeImgButton"),document.getElementById("TravelNotes-ProvidersToolbarUI-"+e+"ImgButton").classList.add("TravelNotes-ProvidersToolbarUI-ActiveTransitModeImgButton")}function Oo(e){e.stopPropagation(),Ro(e.target.transitMode),Jt.startRouting()}function Co(e){$.routing.provider=e;let t=document.querySelector(".TravelNotes-ProvidersToolbarUI-ActiveProviderImgButton");t&&t.classList.remove("TravelNotes-ProvidersToolbarUI-ActiveProviderImgButton"),document.getElementById("TravelNotes-ProvidersToolbarUI-"+e+"ImgButton").classList.add("TravelNotes-ProvidersToolbarUI-ActiveProviderImgButton");let a=$.providers.get(e.toLowerCase());if(Po.forEach(e=>{a.transitModes[e]?Eo[e].classList.remove("TravelNotes-ProvidersToolbarUI-InactiveImgButton"):Eo[e].classList.add("TravelNotes-ProvidersToolbarUI-InactiveImgButton")}),!a.transitModes[$.routing.transitMode]){let e=null;Po.forEach(t=>{a.transitModes[t]&&(e=e||t)}),Ro(e)}}function So(e){e.stopPropagation(),Co(e.target.provider),Jt.startRouting()}function Uo(e){if(0===e.providerKey)return;let t=a.create("img",{src:e.icon,id:"TravelNotes-ProvidersToolbarUI-"+e.name+"ImgButton",className:"TravelNotes-ProvidersToolbarUI-ImgButton",title:e.name,provider:e.name},Ao);if(t.addEventListener("click",So,!1),!jo){t.classList.add("TravelNotes-ProvidersToolbarUI-ActiveProviderImgButton"),$.routing.provider=t.provider,jo=!0;let a=null;Po.forEach(t=>{e.transitModes[t]&&(a=a||t)}),Eo[a].classList.add("TravelNotes-ProvidersToolbarUI-ActiveTransitModeImgButton"),$.routing.transitMode=a,Po.forEach(t=>{e.transitModes[t]||Eo[t].classList.add("TravelNotes-ProvidersToolbarUI-InactiveImgButton")})}}const ko=Object.freeze(new class{createUI(e){Mo=e,Ao=a.create("div",{className:"TravelNotes-UI-FlexRowDiv TravelNotes-ProvidersToolbarUI-ImgButtonsDiv"},e),Po.forEach(e=>{Eo[e]=a.create("img",{src:Do[e],id:"TravelNotes-ProvidersToolbarUI-"+e+"ImgButton",className:"TravelNotes-ProvidersToolbarUI-ImgButton",title:b.getText("ProvidersToolbarUI - "+e),transitMode:e},Ao),Eo[e].addEventListener("click",Oo,!1)}),$.providers&&(jo=!1,$.providers.forEach(Uo))}set provider(e){Co(e)}set transitMode(e){Ro(e)}providersAdded(){Mo.removeChild(Ao),this.createUI(Mo)}});let Ho="geolocation"in navigator?r.inactive:r.disabled,Bo=null;function Fo(e){ve.dispatch("geolocationpositionchanged",{position:e})}function Vo(){r.active===Ho&&(Ho=r.inactive),ve.dispatch("geolocationstatuschanged",{status:Ho}),navigator.geolocation.clearWatch(Bo),Bo=null}function Wo(e){1===e.code&&(Ho=r.refusedByUser),Vo()}const zo=Object.seal(new class{get status(){return Ho}switch(){switch(Ho){case r.inactive:Ho=r.active,ve.dispatch("geolocationstatuschanged",{status:Ho}),navigator.geolocation.getCurrentPosition(Fo,Wo,t.geoLocation.options),Bo=navigator.geolocation.watchPosition(Fo,Wo,t.geoLocation.options);break;case r.active:Vo()}return Ho}});let Ko=null,Xo=null,Zo=null,Go=null,Jo=!1;function Yo(){Xo&&(clearTimeout(Xo),Xo=null),Go.classList.remove("TravelNotes-UI-MainDiv-Minimize"),Go.classList.add("TravelNotes-UI-MainDiv-Maximize")}function qo(){Go.classList.remove("TravelNotes-UI-MainDiv-Maximize"),Go.classList.add("TravelNotes-UI-MainDiv-Minimize")}function Qo(){Xo=setTimeout(qo,t.travelEditor.timeout)}function _o(e){e.stopPropagation(),Ne.setKeysFromDialog()}function $o(e){e.stopPropagation(),zo.switch()}function en(e){Jo?(e.target.innerHTML="&#x1f4cc;",Go.addEventListener("mouseenter",Yo,!1),Go.addEventListener("mouseleave",Qo,!1)):(e.target.innerHTML="&#x274c;",Go.removeEventListener("mouseenter",Yo,!1),Go.removeEventListener("mouseleave",Qo,!1)),Jo=!Jo}const tn=Object.freeze(new class{createUI(e){Go=e,Zo=a.create("div",{className:"TravelNotes-UI-FlexRowDiv"},e),a.create("div",{className:"TravelNotes-UI-Button",title:"Home",innerHTML:'<a class="TravelNotes-UI-LinkButton" href="'+window.location.origin+'" target="_blank">&#x1f3e0;</a>'},Zo),a.create("div",{className:"TravelNotes-UI-Button",title:"Help",innerHTML:'<a class="TravelNotes-UI-LinkButton" href="https://github.com/wwwouaiebe/leaflet.TravelNotes/tree/gh-pages/TravelNotesGuides" target="_blank">?</a>'},Zo),a.create("div",{className:"TravelNotes-UI-Button",title:"Contact",innerHTML:'<a class="TravelNotes-UI-LinkButton" href="'+(t.travelNotesToolbarUI.contactMail||window.location.origin)+'" target="_blank">@</a>'},Zo),t.APIKeys.showDialogButton&&a.create("div",{className:"TravelNotes-UI-Button",title:b.getText("TravelNotesToolbarUI - API keys"),innerHTML:"&#x1f511;"},Zo).addEventListener("click",_o,!1),r.disabled<zo.status&&(Ko=a.create("div",{className:"TravelNotes-UI-Button",title:b.getText("TravelNotesToolbarUI - Geo location"),innerHTML:"&#x1f310;"},Zo),Ko.addEventListener("click",$o,!1)),function(){let e=a.create("div",{innerHTML:"&#x274c;",className:"TravelNotes-UI-Button TravelNotes-UI-FlexRow-RightButton"},Zo);e.addEventListener("click",en,!1),t.travelEditor.startMinimized?(e.innerHTML="&#x1f4cc;",Go.addEventListener("mouseenter",Yo,!1),Go.addEventListener("mouseleave",Qo,!1),Go.classList.add("TravelNotes-UI-MainDiv-Minimize")):(Go.classList.add("TravelNotes-UI-MainDiv-Maximize"),Jo=!0)}()}geoLocationStatusChanged(e){switch(e){case r.inactive:Ko.classList.remove("TravelNotes-TravelNotesToolbarUI-GeoLocationButton-Striked");break;case r.active:Ko.classList.add("TravelNotes-TravelNotesToolbarUI-GeoLocationButton-Striked");break;default:Ko&&(Ko.parentNode.removeChild(Ko),Ko=null)}}});function an(){let e=t.itineraryPane.showNotes,o=t.itineraryPane.showManeuvers,n=null,r=null,l=null,d=null,c=null,u=null;function g(e){e.stopPropagation(),e.preventDefault();let t=e.target;for(;!t.latLng;)t=t.parentNode;e.latlng={lat:s.defaultValue,lng:s.defaultValue},e.fromUI=!0,e.originalEvent={clientX:e.clientX,clientY:e.clientY,latLng:t.latLng},t.maneuverObjId?(e.maneuverObjId=t.maneuverObjId,function(e,t){let a=e.maneuverObjId,o=Ee(),n=Ge(e,[{context:o,name:b.getText("ManeuverContextMenu - Zoom to this maneuver"),action:o.zoomToManeuver,param:a}],t);return Object.seal(n)}(e,n.parentNode).show()):t.noteObjId&&(e.noteObjId=t.noteObjId,_t(e,n.parentNode).show())}function v(e){e.stopPropagation(),ve.dispatch("additinerarypointmarker",{objId:e.target.objId,latLng:e.target.latLng})}function p(e){e.stopPropagation(),ve.dispatch("removeobject",{objId:e.target.objId})}function h(t){e=t.target.checked,document.querySelectorAll(".TravelNotes-UI-Route-Notes-Row").forEach(e=>{e.classList.toggle("TravelNotes-UI-Route-Notes-Row-Hidden")})}function m(e){o=e.target.checked,document.querySelectorAll(".TravelNotes-UI-Route-Maneuvers-Row").forEach(e=>{e.classList.toggle("TravelNotes-UI-Route-Maneuvers-Row-Hidden")})}return Object.freeze(new class{remove(){!function(){document.querySelectorAll(".TravelNotes-UI-Route-Notes-Row, .TravelNotes-UI-Route-Maneuvers-Row").forEach(e=>{e.removeEventListener("contextmenu",g,!1),e.removeEventListener("mouseenter",v,!1),e.removeEventListener("mouseleave",p,!1)});let e=document.querySelector(".TravelNotes-UI-Route-ManeuversAndNotes");e&&n.removeChild(e)}(),l&&(u&&(u.removeEventListener("click",m,!1),l.removeChild(u),u=null),c&&(c.removeEventListener("click",h,!1),l.removeChild(c),c=null),r.removeChild(l),l=null),d&&(r.removeChild(d),d=null)}add(){-1!==$.editedRouteObjId&&(l=a.create("div",null,r),a.create("text",{value:b.getText("ItineraryPaneUI - Show notes")},l),c=a.create("input",{type:"checkbox",id:"TravelNotes-ItineraryPane-ShowNotesInput",checked:e},l),c.addEventListener("click",h,!1),a.create("text",{value:b.getText("ItineraryPaneUI - Show maneuvers")},l),u=a.create("input",{type:"checkbox",id:"TravelNotes-ItineraryPane-ShowManeuversInput",checked:o},l),u.addEventListener("click",m,!1),d=sa.getRouteHeaderHTML("TravelNotes-UI-",$.travel.editedRoute),r.appendChild(d),n.appendChild(sa.getEditedRouteManeuversAndNotesHTML("TravelNotes-UI-")),document.querySelectorAll(".TravelNotes-UI-Route-Notes-Row, .TravelNotes-UI-Route-Maneuvers-Row").forEach(e=>{e.addEventListener("contextmenu",g,!1),e.addEventListener("mouseenter",v,!1),e.addEventListener("mouseleave",p,!1)}),e||document.querySelectorAll(".TravelNotes-UI-Route-Notes-Row").forEach(e=>{e.classList.toggle("TravelNotes-UI-Route-Notes-Row-Hidden")}),o||document.querySelectorAll(".TravelNotes-UI-Route-Maneuvers-Row").forEach(e=>{e.classList.toggle("TravelNotes-UI-Route-Maneuvers-Row-Hidden")}))}getId(){return i.itineraryPane}getButtonText(){return b.getText("PanesManagerUI - Itinerary")}setPaneDivs(e,t){n=e,r=t}})}let on=-1,nn=-1,rn=!1;let ln=null,sn=null,dn=null,cn=new Map,un=[];class gn{constructor(e,t){this.name=e,this.items=[],this.filterTagsArray=[],this.isSelected=!1,this.isExpanded=!1,this.isRoot=!1,t&&(this.isExpanded=!0,this.isRoot=!0)}}function vn(){-1===nn?nn=p():ve.dispatch("removeobject",{objId:nn});let e=$.map.getCenter();sn=$.map.getBounds();let a=Pe.getSquareBoundingBox([e.lat,e.lng],5e3);sn.getSouthWest().lat=Math.max(sn.getSouthWest().lat,a.getSouthWest().lat),sn.getSouthWest().lng=Math.max(sn.getSouthWest().lng,a.getSouthWest().lng),sn.getNorthEast().lat=Math.min(sn.getNorthEast().lat,a.getNorthEast().lat),sn.getNorthEast().lng=Math.min(sn.getNorthEast().lng,a.getNorthEast().lng),ve.dispatch("addrectangle",{objId:nn,bounds:sn,properties:t.nextSearchLimit})}function pn(e){e.isSelected&&(un=un.concat(e),e.filterTagsArray.forEach(e=>{let t=Object.getOwnPropertyNames(e)[0];cn.set(t,t)})),e.items.forEach(pn)}function hn(e,t){un.forEach(a=>{a.filterTagsArray.forEach(o=>{(function(e,t){let a=!0;for(const[o,n]of Object.entries(t))a=a&&e.tags[o]&&e.tags[o]===n;return a})(e,o)&&(e.description=a.name,t.set(e.id,e))})})}function mn(e){let t=new Map,a=new Map,o=new Map,n=new Map;function r(e){e.geometry=[[]],e.lat=s.defaultValue,e.lon=s.defaultValue;let t=0;e.nodes.forEach(o=>{let n=a.get(o);e.geometry[0].push([n.lat,n.lon]),e.lat+=n.lat,e.lon+=n.lon,t++}),0!==t&&(e.lat/=t,e.lon/=t)}e.forEach(e=>{switch(e.type){case"node":a.set(e.id,e);break;case"way":o.set(e.id,e);break;case"relation":n.set(e.id,e)}e.tags&&hn(e,t)}),t.forEach(e=>{switch(e.type){case"way":r(e);break;case"relation":!function(e){e.geometry=[[]],e.lat=s.defaultValue,e.lon=s.defaultValue;let t=0;e.members.forEach(a=>{if("way"===a.type){let n=o.get(a.ref);r(n),e.geometry.push(n.geometry[0]),e.lat+=n.lat,e.lon+=n.lon,t++}}),0!==t&&(e.lat/=t,e.lon/=t)}(e)}}),$.searchData=Array.from(t.values()),rn=!1,ve.dispatch("showsearch")}function fn(e){let t=[];e.forEach(e=>{"fulfilled"===e.status?t=t.concat(e.value.elements):console.log(e.reason)}),mn(t)}const bn=Object.seal(new class{get dictionary(){return dn}search(){rn||(rn=!0,cn.clear(),un=[],pn(dn),Promise.allSettled(function(){let e=[];return ln=sn,cn.forEach(a=>{let n="("+sn.getSouthWest().lat.toFixed(s.fixed)+","+sn.getSouthWest().lng.toFixed(s.fixed)+","+sn.getNorthEast().lat.toFixed(s.fixed)+","+sn.getNorthEast().lng.toFixed(s.fixed)+")",r=t.overpassApiUrl+"?data=[out:json];node["+a+"]"+n+"->.a;way["+a+"]"+n+"->.b;relation["+a+"]"+n+"->.c;(.c >;.c;.b >;.b;.a;);out;";e.push(o.getJsonPromise(r))}),e}()).then(fn))}show(){$.map.on("zoom",vn),$.map.on("move",vn),vn(),ln&&(-1===on?on=p():ve.dispatch("removeobject",{objId:on}),ve.dispatch("addrectangle",{objId:on,bounds:[[ln.getSouthWest().lat,ln.getSouthWest().lng],[ln.getNorthEast().lat,ln.getNorthEast().lng]],properties:t.previousSearchLimit}))}hide(){let e=ve;$.map.off("zoom",vn),$.map.off("move",vn),-1!==nn&&(e.dispatch("removeobject",{objId:nn}),nn=-1),-1!==on&&(e.dispatch("removeobject",{objId:on}),on=-1)}parseDictionary(e){dn=new gn("All",!0);let t=[dn.items],a=null;e.split(/\r\n|\r|\n/).forEach(e=>{""!==e&&function(e){let o=e.split(";");for(;""===o[o.length-1];)o.pop();let n=0,r=null;o.forEach(e=>{if(""!==e)if(-1===e.indexOf("=")){let o=new gn(e);t[n].push(o),t[n+1]=o.items,a=o.filterTagsArray}else{let t=e.split("=");r=r||{},r[t[0]]=t[1]}n++}),r&&a.push(r)}(e)})}});function yn(){let e=null,t=null,o=null,n=null,r=null,l=0;function d(t){t.stopPropagation(),t.preventDefault();let a=t.target;for(;!a.osmElement;)a=a.parentNode;t.latlng={lat:s.defaultValue,lng:s.defaultValue},t.fromUI=!0,t.originalEvent={clientX:t.clientX,clientY:t.clientY,latLng:[a.osmElement.lat,a.osmElement.lon],osmElement:a.osmElement,geometry:a.osmElement.geometry},function(e,t){let a=Ee(),o=Ge(e,[{context:mt,name:b.getText("OsmSearchContextMenu - Create a travel note with this result"),action:mt.newSearchNote,param:e.originalEvent.searchResult},{context:a,name:b.getText("OsmSearchContextMenu - Zoom to this result"),action:a.zoomToPoi,param:{latLng:e.originalEvent.latLng,geometry:e.originalEvent.geometry}}],t);return Object.seal(o)}(t,e).show()}function c(e){e.stopPropagation(),ve.dispatch("addsearchpointmarker",{objId:e.target.objId,latLng:[e.target.osmElement.lat,e.target.osmElement.lon],geometry:e.target.osmElement.geometry})}function u(e){e.stopPropagation(),ve.dispatch("removeobject",{objId:e.target.objId})}function v(){document.querySelectorAll(".TravelNotes-OsmSearchPaneUI-SearchResult").forEach(t=>{t.removeEventListener("contextmenu",d,!1),t.removeEventListener("mouseenter",c,!1),t.removeEventListener("mouseleave",u,!1),e.removeChild(t)})}function h(e){l++;let t=a.create("div",{className:"TravelNotes-SearchPaneUI-SearchItem TravelNotes-SearchPaneUI-SearchItemMargin"+l,dictItem:e},r);if(!e.isRoot){a.create("input",{type:"checkbox",checked:e.isSelected},t).addEventListener("change",(function(e){!function e(t,a){t.isSelected=a,t.items.forEach(t=>{e(t,a)})}(e.target.parentNode.dictItem,e.target.checked),r.innerHTML="",h(bn.dictionary)}),!1)}if(0===e.filterTagsArray.length){a.create("div",{className:"TravelNotes-UI-Button TravelNotes-OsmSearchPaneUI-TreeArrow",innerHTML:e.isExpanded?"▼":"▶"},t).addEventListener("click",(function(e){e.target.parentNode.dictItem.isExpanded=!e.target.parentNode.dictItem.isExpanded,r.innerHTML="",h(bn.dictionary)}),!1)}a.create("text",{value:e.name},t),e.isExpanded&&e.items.forEach(h),l--}function m(){v(),bn.dictionary.isExpanded=!1,r.innerHTML="",h(bn.dictionary),n=a.create("div",{className:"TravelNotes-WaitAnimation"},t),a.create("div",{className:"TravelNotes-WaitAnimationBullet"},n),bn.search()}function f(e){e.items.forEach(f),e.isSelected=!1}function y(){f(bn.dictionary),r.innerHTML="",h(bn.dictionary)}function T(e){e.items.forEach(T),e.isExpanded=!0}function N(){T(bn.dictionary),r.innerHTML="",h(bn.dictionary)}function L(e){e.items.forEach(L),e.isRoot||(e.isExpanded=!1)}function w(){L(bn.dictionary),r.innerHTML="",h(bn.dictionary)}function I(e){e.deltaY&&(e.target.scrollTop+=e.deltaY*g[e.deltaMode]),e.stopPropagation()}function x(e,t){t&&a.create("p",{innerHTML:t},e)}function A(t){let o=a.create("div",{className:"TravelNotes-OsmSearchPaneUI-SearchResult",osmElement:t,objId:p()},e);x(o,t.description),x(o,t.tags.name),x(o,function(e){return e.tags["addr:street"]?e.tags["addr:street"]+(e.tags["addr:housenumber"]?" "+e.tags["addr:housenumber"]:""):null}(t)),x(o,function(e){return e.tags["addr:city"]?(e.tags["addr:postcode"]?e.tags["addr:postcode"]+" ":"")+e.tags["addr:city"]:null}(t)),x(o,t.tags.phone),t.tags.email&&a.create("a",{href:"mailto:"+t.tags.email,innerHTML:t.tags.email},a.create("p",null,o)),t.tags.website&&a.create("a",{href:t.tags.website,target:"_blank",innerHTML:t.tags.website},a.create("p",null,o)),o.title="";for(const[e,a]of Object.entries(t.tags))o.title+=e+"="+a+"\n";o.addEventListener("contextmenu",d,!1),o.addEventListener("mouseenter",c,!1),o.addEventListener("mouseleave",u,!1)}return Object.freeze(new class{remove(){bn.hide(),v(),r&&(t.removeChild(r),r=null),o&&t.removeChild(o),n&&(t.removeChild(n),n=null)}add(){bn.show(),o=a.create("div",null,t),a.create("div",{className:"TravelNotes-UI-Button",title:b.getText("OsmSearchPaneUI - Search OpenStreetMap"),innerHTML:"&#x1f50e"},o).addEventListener("click",m,!1),a.create("div",{className:"TravelNotes-UI-Button",title:b.getText("OsmSearchPaneUI - Expand tree"),innerHTML:"▼"},o).addEventListener("click",N,!1),a.create("div",{className:"TravelNotes-UI-Button",title:b.getText("OsmSearchPaneUI - Collapse tree"),innerHTML:"▶"},o).addEventListener("click",w,!1),a.create("div",{id:"TravelNotes-OsmSearchPaneUI-ClearAllButton",className:"TravelNotes-UI-Button",title:b.getText("OsmSearchPaneUI - Clear tree"),innerHTML:"❌"},o).addEventListener("click",y,!1),r=a.create("div",{id:"TravelNotes-OsmSearchPaneUI-SearchTree"},t),r.addEventListener("wheel",I,!1),bn.dictionary.name="",h(bn.dictionary),$.searchData.forEach(A)}getId(){return i.searchPane}getButtonText(){return b.getText("PanesManagerUI - Search")}setPaneDivs(a,o){e=a,t=o}})}let Tn=null;const Nn=Object.freeze(new class{createUI(e){Tn||(Tn=a.create("div",{id:"TravelNotes-UI-MainDiv"},e),a.create("div",{id:"TravelNotes-UI-MainDiv-Title",innerHTML:"Travel&nbsp;&amp;&nbsp;Notes"},Tn),tn.createUI(Tn),fo.createUI(Tn),xo.addPane(an()),xo.addPane(function(){let e=0,t=null,a=null;function o(t){t.stopPropagation();try{t.dataTransfer.setData("Text",t.target.dataObjId),t.dataTransfer.dropEffect="move"}catch(e){console.log(e)}e=t.target.noteObjId}function n(e){e.preventDefault()}function r(t){t.preventDefault();let a=t.target;for(;!a.noteObjId;)a=a.parentElement;let o=a.getBoundingClientRect();mt.travelNoteDropped(e,a.noteObjId,t.clientY-o.top<o.bottom-t.clientY)}function l(e){e.stopPropagation(),e.preventDefault();let a=e.target;for(;!a.noteObjId;)a=a.parentNode;e.latlng={lat:s.defaultValue,lng:s.defaultValue},e.fromUI=!0,e.originalEvent={clientX:e.clientX,clientY:e.clientY,latLng:a.latLng},a.noteObjId&&(e.noteObjId=a.noteObjId,_t(e,t.parentNode).show())}return Object.freeze(new class{remove(){a&&(a.childNodes.forEach(e=>{e.removeEventListener("contextmenu",l,!1),e.removeEventListener("dragstart",o,!1)}),t.removeChild(a)),a=null}add(){a=sa.getTravelNotesHTML("TravelNotes-UI-"),a.addEventListener("drop",r,!1),a.addEventListener("dragover",n,!1),t.appendChild(a),a.childNodes.forEach(e=>{e.draggable=!0,e.addEventListener("contextmenu",l,!1),e.addEventListener("dragstart",o,!1),e.classList.add("TravelNotes-UI-MoveCursor")})}getId(){return i.travelNotesPane}getButtonText(){return b.getText("PanesManagerUI - Travel notes")}setPaneDivs(e){t=e}})}()),xo.addPane(yn()),xo.createUI(Tn),ko.createUI(Tn),Tn.addEventListener("travelnameupdated",()=>fo.setTravelName(),!1),Tn.addEventListener("setrouteslist",()=>fo.setRoutesList(),!1),Tn.addEventListener("showitinerary",()=>xo.showPane(i.itineraryPane),!1),Tn.addEventListener("updateitinerary",()=>xo.updatePane(i.itineraryPane),!1),Tn.addEventListener("showtravelnotes",()=>xo.showPane(i.travelNotesPane),!1),Tn.addEventListener("updatetravelnotes",()=>xo.updatePane(i.travelNotesPane),!1),Tn.addEventListener("showsearch",()=>xo.showPane(i.searchPane),!1),Tn.addEventListener("updatesearch",()=>xo.updatePane(i.searchPane),!1),Tn.addEventListener("providersadded",()=>ko.providersAdded(),!1),Tn.addEventListener("setprovider",e=>{e.data&&e.data.provider&&(ko.provider=e.data.provider)},!1),Tn.addEventListener("settransitmode",e=>{e.data&&e.data.provider&&(ko.transitMode=e.data.transitMode)},!1),document.addEventListener("geolocationstatuschanged",e=>{tn.geoLocationStatusChanged(e.data.status)},!1),Tn.addEventListener("click",e=>{e.target.id&&"TravelNotes-UI-MainDiv"===e.target.id&&(e.stopPropagation(),e.preventDefault())},!1),Tn.addEventListener("dblclick",e=>{e.stopPropagation(),e.preventDefault()},!1),Tn.addEventListener("contextmenu",e=>{e.stopPropagation(),e.preventDefault()},!1),Tn.addEventListener("wheel",e=>{e.stopPropagation(),e.preventDefault()},!1))}});function Ln(){let e=ee();e.title=b.getText("AboutDialog - About Travel & Notes"),a.create("div",{id:"TravelNotes-AboutDialog-AboutDiv",innerHTML:'<p>This  program is free software; you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation; either version 3 of the License, or any later version.</p><p>Copyright - 2017 2020 - wwwouaiebe</p><p>Contact : <a href="https://www.ouaie.be/blog/pages/Contact" target="_blank">https://www.ouaie.be/</a></p><p>GitHub : <a href="https://github.com/wwwouaiebe/leaflet.TravelNotes" target="_blank">https://github.com/wwwouaiebe/leaflet.TravelNotes</a></p><p>Version : 1.12.0.<p>This program uses: <a href="https://leafletjs.com/" target="_blank">leaflet</a>, <a href="https://github.com/mapbox/polyline" target="_blank">mapbox/polyline</a>, <a href="https://github.com/Project-OSRM/osrm-text-instructions" target="_blank">Project-OSRM/osrm-text-instructions</a> and  <a href="https://github.com/drolbr/Overpass-API" target="_blank">the Overpass API</a></p>'},e.content),e.show().then().catch(e=>console.log(e||"An error occurs in the dialog"))}let wn=null;const In=Object.freeze(new class{getOpenPromise(){return new Promise((function(e,t){if(wn)return void e();let a=window.indexedDB.open("TravelNotesDb",1);a.onerror=function(){wn=null,t(new Error("Not possible to open the db"))},a.onsuccess=function(t){wn=t.target.result,e()},a.onupgradeneeded=function(e){wn=e.target.result,wn.createObjectStore("Travels",{keyPath:"UUID"})}}))}getReadPromise(e){return new Promise((function(t,a){if(!wn)return void a(new Error("Database not opened"));let o=wn.transaction(["Travels"],"readonly");o.onerror=function(){a(new Error("Transaction error"))},o.objectStore("Travels").get(e).onsuccess=function(e){t(e.target.result?e.target.result.data:null)}}))}getWritePromise(e,t){return new Promise((function(a,o){if(!wn)return void o(new Error("Database not opened"));let n=null;try{n=wn.transaction(["Travels"],"readwrite")}catch(e){return void o(e)}n.onerror=function(){o(new Error("Transaction error"))},n.objectStore("Travels").put({UUID:e,data:t}).onsuccess=function(){a()}}))}closeDb(e){if(!wn)return;if(!e)return wn.close(),void(wn=null);let t=wn.transaction(["Travels"],"readwrite");t.onerror=function(){};let a=t.objectStore("Travels").delete(e);a.onerror=function(){wn.close(),wn=null},a.onsuccess=function(){wn.close(),wn=null}}});let xn=null,An=null,jn=null;function Pn(){xn.innerHTML="<span>"+An+"&nbsp;-&nbsp;Zoom&nbsp;:&nbsp;"+jn+"</span>"}function En(e){An=y.formatLat(e.latlng.lat)+"&nbsp;-&nbsp;"+y.formatLng(e.latlng.lng),Pn()}function Mn(){jn=$.map.getZoom(),Pn()}const Dn=Object.freeze(new class{createUI(){jn=$.map.getZoom();let e=$.map.getCenter();An=y.formatLat(e.lat)+"&nbsp;-&nbsp;"+y.formatLng(e.lng),xn=a.create("div",{id:"TravelNotes-MouseUI"},document.querySelector("body")),$.map.on("mousemove",En),$.map.on("zoomend",Mn)}});let Rn=!1;function On(){document.addEventListener("routeupdated",e=>{e.data&&ka.updateRoute(e.data.removedRouteObjId,e.data.addedRouteObjId)},!1),document.addEventListener("routepropertiesupdated",e=>{e.data&&ka.updateRouteProperties(e.data.routeObjId)},!1),document.addEventListener("noteupdated",e=>{e.data&&ka.updateNote(e.data.removedNoteObjId,e.data.addedNoteObjId)},!1),document.addEventListener("removeobject",e=>{e.data&&ka.removeObject(e.data.objId)},!1),document.addEventListener("removeallobjects",()=>ka.removeAllObjects(),!1),document.addEventListener("zoomto",e=>{e.data&&ha.zoomTo(e.data.latLng,e.data.geometry)},!1),document.addEventListener("additinerarypointmarker",e=>{e.data&&ka.addItineraryPointMarker(e.data.objId,e.data.latLng)},!1),document.addEventListener("addsearchpointmarker",e=>{e.data&&ka.addSearchPointMarker(e.data.objId,e.data.latLng,e.data.geometry)},!1),document.addEventListener("addrectangle",e=>{e.data&&ka.addRectangle(e.data.objId,e.data.bounds,e.data.properties)},!1),document.addEventListener("addwaypoint",e=>{e.data&&ka.addWayPoint(e.data.wayPoint,e.data.letter)},!1),document.addEventListener("layerchange",e=>{e.data&&ka.setLayer(e.data.layer)}),document.addEventListener("geolocationpositionchanged",e=>{e.data&&ha.onGeolocationPositionChanged(e.data.position)},!1),document.addEventListener("geolocationstatuschanged",e=>{e.data&&ha.onGeolocationStatusChanged(e.data.status)},!1),document.addEventListener("roadbookupdate",()=>{y.storageAvailable("localStorage")&&In.getOpenPromise().then(()=>{In.getWritePromise($.UUID,sa.getTravelHTML("TravelNotes-Roadbook-").outerHTML)}).then(()=>localStorage.setItem($.UUID,Date.now())).catch(e=>console.log(e||"An error occurs when writing the content"))},!1),document.addEventListener("profileclosed",e=>{e.data&&Nt.onProfileClosed(e.data.objId)},!1)}function Cn(e){$.travel.readOnly||function(e){let t=[e.latlng.lat,e.latlng.lng],a=Ee(),o=Ge(e,[{context:qt,name:b.getText("MapContextMenu - Select this point as start point"),action:-1!==$.editedRouteObjId&&s.defaultValue===$.travel.editedRoute.wayPoints.first.lat?qt.setStartPoint:null,param:t},{context:qt,name:b.getText("MapContextMenu - Select this point as way point"),action:-1===$.editedRouteObjId?null:qt.addWayPoint,param:t},{context:qt,name:b.getText("MapContextMenu - Select this point as end point"),action:-1!==$.editedRouteObjId&&s.defaultValue===$.travel.editedRoute.wayPoints.last.lat?qt.setEndPoint:null,param:t},{context:Jt,name:b.getText("MapContextMenu - Add a route"),action:Jt.addRoute},{context:Jt,name:b.getText("MapContextMenu - Hide all routes"),action:Jt.hideRoutes},{context:Jt,name:b.getText("MapContextMenu - Show all routes"),action:Jt.showRoutes},{context:mt,name:b.getText("MapContextMenu - New travel note"),action:mt.newTravelNote,param:t},{context:mt,name:b.getText("MapContextMenu - Hide all notes"),action:mt.hideNotes},{context:mt,name:b.getText("MapContextMenu - Show all notes"),action:mt.showNotes},{context:a,name:b.getText("MapContextMenu - Zoom to travel"),action:a.zoomToTravel},{context:null,name:b.getText("MapContextMenu - About Travel & Notes"),action:Ln}]);return Object.seal(o)}
/**
	@------------------------------------------------------------------------------------------------------------------------------
	...
	@------------------------------------------------------------------------------------------------------------------------------
	*/(e).show()}const Sn=Object.seal(new class{addReadOnlyMap(e,t){Rn||(Rn=!0,On(),e&&($.map=e),Lt.createUI(),Ft.setLayer("OSM - Color"),o.getJsonPromise(t).then(e=>{Ka().openDistantFile(e)}).catch(e=>{console.log(e||"Not possible to load the .trv file"),$.map.setView([s.defaultValue,s.defaultValue],2)}))}addControl(e,a){Rn||(Rn=!0,On(),window.addEventListener("unload",()=>{localStorage.removeItem($.UUID)}),window.addEventListener("beforeunload",e=>(In.closeDb($.UUID),e.returnValue="x","x")),e&&($.map=e,$.map.on("contextmenu",Cn)),$.travel=J(),$.travel.routes.add(K()),Nn.createUI(document.getElementById(a)),Lt.createUI(),Ne.setKeysFromServerFile(),t.layersToolbarUI.haveLayersToolbarUI&&Ft.createUI(),t.mouseUI.haveMouseUI&&Dn.createUI(),t.travelEditor.startupRouteEdition&&Jt.editRoute($.travel.routes.first.objId),ve.dispatch("setrouteslist"),ve.dispatch("roadbookupdate"),$.map.setView([t.map.center.lat,t.map.center.lng],t.map.zoom),ue.showHelp(b.getText("Help - Continue with interface")))}addProvider(e){Ne.addProvider(e)}showInfo(e){ue.showInfo(e)}get baseDialog(){return ee()}get userData(){return $.travel.userData}set userData(e){$.travel.userData=e}get map(){return $.map}get maneuver(){return R()}get itineraryPoint(){return P()}get version(){return"1.12.0"}});(function(){let e=null,n=null,r="",i=!1;function l(a){var o,n,l,s,d,c,u;("fulfilled"===a[0].status&&(i=!0),r=function(a){if("fulfilled"===a.status){if(a.value.language=e,a.value.haveCrypto=i,"wwwouaiebe.github.io"===window.location.hostname){a.value.layersToolbarUI.theDevil.addButton=!1,a.value.errorUI.showHelp=!0;const e=120;a.value.printRouteMap.maxTiles=e;const t=10;a.value.note.maxManeuversNotes=t,a.value.APIKeys.dialogHaveUnsecureButtons=!0}return t.overload(a.value),""}return"Not possible to load the TravelNotesConfig.json file. "}(a[1]),r)?ue.showError(r):($.providers.forEach(e=>{e.userLanguage=t.language}),o=a[2],n=a[5],r="fulfilled"===o.status?(b.setTranslations(o.value),""):"fulfilled"===n.status?(b.setTranslations(n.value),"Not possible to load the TravelNotes"+e.toUpperCase()+".json file. English will be used. "):"Not possible to load the translations. ",r+=(l=a[4],s=a[6],"fulfilled"===l.status?(st.selectOptions=l.value.preDefinedIconsList,st.buttons=l.value.editionButtons,""):"fulfilled"===s.status?(st.selectOptions=s.value.preDefinedIconsList,st.buttons=s.value.editionButtons,"Not possible to load the TravelNotesNoteDialog"+e.toUpperCase()+".json file. English will be used. "):"Not possible to load the translations for the note dialog. "),r+="fulfilled"===(d=a[3]).status?(Ft.addLayers(d.value),""):"Not possible to load the TravelNotesLayers.json file. Only the OpenStreetMap background will be available. ",r+=(c=a[7],u=a[8],"fulfilled"===c.status?(bn.parseDictionary(c.value),""):"fulfilled"===u.status?(bn.parseDictionary(u.value),"Not possible to load the TravelNotesSearchDictionary"+e.toUpperCase()+".csv file. English will be used. "):"Not possible to load the search dictionary. OSM search will not be available."),""!==r&&(ue.showWarning(r),r=""))}return Object.freeze(new class{start(){window.L.travelNotes=Sn,function(){let t="?";decodeURI(window.location.search).substr(1).split("&").forEach(a=>{-1===a.indexOf("ProviderKey")?("fil="===a.substr(0,4).toLowerCase()?n=decodeURIComponent(escape(atob(a.substr(4)))):"lng="===a.substr(0,4).toLowerCase()&&(e=a.substr(4).toLowerCase()),t+="?"===t?"":"&",t+=a):Ne.setKeyFromUrl(a)}),history.replaceState({index:"bar"},"page",t)}(),e=e||t.language,ue.createUI(),Promise.allSettled(function(){let t=window.location.origin+window.location.pathname+"TravelNotes";return[window.crypto&&window.crypto.subtle&&window.crypto.subtle.importKey&&window.isSecureContext?window.crypto.subtle.importKey("raw",(new window.TextEncoder).encode("hoho"),{name:"PBKDF2"},!1,["deriveKey"]):Promise.reject(new Error("Invalid crypto functions or unsecure context")),o.getJsonPromise(t+"Config.json"),o.getJsonPromise(t+e.toUpperCase()+".json"),o.getJsonPromise(t+"Layers.json"),o.getJsonPromise(t+"NoteDialog"+e.toUpperCase()+".json"),o.getJsonPromise(t+"EN.json"),o.getJsonPromise(t+"NoteDialogEN.json"),o.getTextPromise(t+"SearchDictionary"+e.toUpperCase()+".csv"),o.getTextPromise(t+"SearchDictionaryEN.csv")]}()).then(e=>{l(e),function(){if(t.autoLoad&&""===r){a.create("div",{id:"Map"},document.querySelector("body")),a.create("div",{id:"TravelNotes"},document.querySelector("body"));let e=window.L.map("Map",{attributionControl:!1,zoomControl:!1}).setView([s.defaultValue,s.defaultValue],0);n?Sn.addReadOnlyMap(e,n):Sn.addControl(e,"TravelNotes")}}()})}})})().start()}();