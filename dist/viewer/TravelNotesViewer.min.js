 ...
 * Build 02746 - 2021-09-07T16:09:48+0200 
...
/**
	...
	@------------------------------------------------------------------------------------------------------------------------------
	*/const V=new class{constructor(){Object.freeze(this)}dispatch(t,e){let o=new Event(t);e&&(o.data=e),document.dispatchEvent(o)}};const U=new class{#python2Round(t){return Math.floor(Math.abs(t)+.5)*(0<=t?1:-1)}#encodeDelta(t,e,o){let i=this.#python2Round(t*o),n=this.#python2Round(e*o),s=i-n;s<<=1,0>i-n&&(s=~s);let a="";for(;32<=s;)a+=String.fromCharCode(63+(32|31&s)),s>>=5;return a+=String.fromCharCode(s+63),a}#index=0;#decodeDelta(t){let e=null,o=0,i=0;do{e=t.charCodeAt(this.#index++)-63,i|=(31&e)<<o,o+=5}while(32<=e);return 1&i?~(i>>1):i>>1}constructor(){Object.freeze(this)}encode(t,e){if(!t.length)return"";let o=e.length,i=Array.from(e,(t=>Math.pow(10,t))),n="";for(let e=0;e<o;e++)n+=this.#encodeDelta(t[0][e],0,i[e]);for(let e=1;e<t.length;e++){let s=t[e],a=t[e-1];for(let t=0;t<o;t++)n+=this.#encodeDelta(s[t],a[t],i[t])}return n}decode(t,e){let o=e.length;if(!t||0===t.length)return[];this.#index=0;let i=[],n=Array.from(e,(t=>Math.pow(10,t))),s=new Array(o).fill(0);for(;this.#index<t.length;){let e=new Array(o).fill(0);for(let i=0;i<o;i++)s[i]+=this.#decodeDelta(t),e[i]=s[i]/n[i];i.push(e)}return i}};class W{#compressRoute(t){let e={};0!==t.itinerary.itineraryPoints.length&&(e=t.itinerary.itineraryPoints[0].objType);let o={values:"",objType:e},i=[];t.itinerary.itineraryPoints.forEach((t=>{i.push([t.lat,t.lng,t.distance,t.elev,t.objId])})),o.values=U.encode(i,[s.fixed,s.fixed,2,2,0]),t.itinerary.itineraryPoints=o}#decompressRoute(t){let e=[];if(t.itinerary.itineraryPoints.values)U.decode(t.itinerary.itineraryPoints.values,[s.fixed,s.fixed,2,2,0]).forEach((i=>{let a={lat:s.defaultValue,lng:s.defaultValue,distance:o.defaultValue,elev:n.defaultValue,objId:c};[a.lat,a.lng,a.distance,a.elev,a.objId]=i,a.objType=t.itinerary.itineraryPoints.objType,e.push(a)}));else{t.itinerary.itineraryPoints.latLngs=U.decode(t.itinerary.itineraryPoints.latLngs,[s.fixed,s.fixed]);let o=0;t.itinerary.itineraryPoints.latLngs.forEach((i=>{let s={};s.lat=i[0],s.lng=i[1],s.distance=t.itinerary.itineraryPoints.distances[o],t.itinerary.itineraryPoints.elevs?s.elev=t.itinerary.itineraryPoints.elevs[o]:s.elev=n.defaultValue,s.objId=t.itinerary.itineraryPoints.objIds[o],s.objType=t.itinerary.itineraryPoints.objType,e.push(s),o++}))}t.itinerary.itineraryPoints=e}#decompressTravel(t){t.routes.forEach(this.#decompressRoute),t.editedRoute&&this.#decompressRoute(t.editedRoute)}constructor(){Object.freeze(this)}decompress(t){this.#decompressTravel(t),z.travel.jsonObject=t,z.editedRouteObjId=c,z.travel.routes.forEach((t=>{a.notEdited!==t.editionStatus&&(z.editedRouteObjId=t.objId)}))}decompressMerge(t){this.#decompressTravel(t);let e=new F;e.jsonObject=t;let o=e.routes.iterator;for(;!o.done;)z.travel.routes.add(o.value);let i=e.notes.iterator;for(;!i.done;)z.travel.notes.add(i.value)}compress(t){let e=t.jsonObject;return e.routes.forEach(this.#compressRoute),this.#compressRoute(e.editedRoute),e}}const G=new class{constructor(){Object.freeze(this)}getLatLngElevAtDist(t,e){if(t.distance<=e||0>=e)return null;let o=0,i=t.itinerary.itineraryPoints.iterator;for(;o<e&&!i.done;)o+=i.value.distance;let n=i.value;i.done;let s=(n.distance-o+e)/n.distance;return Object.freeze({latLng:[n.lat+(i.value.lat-n.lat)*s,n.lng+(i.value.lng-n.lng)*s],elev:n.elev+(i.value.elev-n.elev)*s,ascent:100*(i.value.elev-n.elev)/n.distance,routeDistance:e})}getClosestLatLngDistance(t,e){if(0===t.itinerary.itineraryPoints.length)return null;let i=t.itinerary.itineraryPoints.iterator;i.done;let n=Number.MAX_VALUE,s=window.L.Projection.SphericalMercator.project(window.L.latLng(e[0],e[1])),a=window.L.Projection.SphericalMercator.project(window.L.latLng(i.value.lat,i.value.lng)),r=null,l=o.defaultValue,d=i.value.distance;for(;!i.done;){let t=window.L.Projection.SphericalMercator.project(window.L.latLng(i.value.lat,i.value.lng)),e=window.L.LineUtil.pointToSegmentDistance(s,a,t);e<n&&(n=e,r=window.L.Projection.SphericalMercator.unproject(window.L.LineUtil.closestPointOnSegment(s,a,t)),l=d-r.distanceTo(window.L.latLng(i.value.lat,i.value.lng))),d+=i.value.distance,a=t}return Object.freeze({latLng:[r.lat,r.lng],distance:l})}getLatLngBounds(t){let e=window.L.latLng([s.maxLat,s.maxLng]),o=window.L.latLng([s.minLat,s.minLng]);return t.forEach((t=>{e.lat=Math.min(e.lat,t[0]),e.lng=Math.min(e.lng,t[1]),o.lat=Math.max(o.lat,t[0]),o.lng=Math.max(o.lng,t[1])})),window.L.latLngBounds(e,o)}getSquareBoundingBox(t,e){let o=e/v*d.fromRadians,i=t[0]*d.toRadians,n=Math.acos((Math.cos(e/v)-Math.sin(i)**2)/Math.cos(i)**2)*d.fromRadians;return window.L.latLngBounds(window.L.latLng([t[0]-o,t[1]-n]),window.L.latLng([t[0]+o,t[1]+n]))}project(t,e){let o=z.map.project(window.L.latLng(t),e);return[o.x,o.y]}screenCoordToLatLng(t,e){let o=z.map.containerPointToLatLng(window.L.point(t,e));return[o.lat,o.lng]}addPoints(t,e){return[t[0]+e[0],t[1]+e[1]]}subtrackPoints(t,e){return[t[0]-e[0],t[1]-e[1]]}};const X=new class{#normalizeLng(t){return(t+d.d540)%d.d360-d.d180}constructor(){Object.freeze(this)}arcFromSummitArcArc(t,e,o){return Math.acos(Math.cos(e)*Math.cos(o)+Math.sin(e)*Math.sin(o)*Math.cos(t))}summitFromArcArcArc(t,e,o){return Math.acos((Math.cos(o)-Math.cos(t)*Math.cos(e))/(Math.sin(t)*Math.sin(e)))}pointsDistance(t,e){if(t[0]===e[0]&&t[1]===e[1])return 0;let o=t[0]*d.toRadians,i=e[0]*d.toRadians,n=(this.#normalizeLng(e[1])-this.#normalizeLng(t[1]))*d.toRadians;return Math.acos(Math.sin(o)*Math.sin(i)+Math.cos(o)*Math.cos(i)*Math.cos(n))*v}};const Z=new class{#setNearestRouteData(t,e,o){if(t.objId!==z.editedRouteObjId){let i=G.getClosestLatLngDistance(t,e);if(i){let n=X.pointsDistance(e,i.latLng);n<o.distance&&(o.route=t,o.distance=n,o.latLngOnRoute=i.latLng,o.distanceOnRoute=i.distance)}}}constructor(){Object.freeze(this)}getNearestRouteData(t){let e={distance:Number.MAX_VALUE,route:null,distanceOnRoute:0,latLngOnRoute:[s.defaultValue,s.defaultValue]};return z.travel.routes.forEach((o=>this.#setNearestRouteData(o,t,e))),c!==z.editedRouteObjId&&this.#setNearestRouteData(z.travel.editedRoute,t,e),Object.freeze(e)}getRoute(t){let e=null;return e=z.travel.routes.getAt(t),e||t===z.travel.editedRoute.objId&&(e=z.travel.editedRoute),e}getNoteAndRoute(t){let e=null,o=null;if(e=z.travel.notes.getAt(t),!e){let i=z.travel.routes.iterator;for(;!i.done&&!e;)e=i.value.notes.getAt(t),e&&(o=i.value);e||(e=z.travel.editedRoute.notes.getAt(t),e&&(o=z.travel.editedRoute))}return Object.freeze({note:e,route:o})}getWayPoint(t){let e=z.travel.editedRoute.wayPoints.getAt(t);if(!e){let o=z.travel.routes.iterator;for(;!o.done&&!e;)e=o.value.wayPoints.getAt(t)}return e}};class Y{#geometry=[];#pushNoteGeometry(t){this.#geometry.push(t.latLng),this.#geometry.push(t.iconLatLng)}#pushRouteGeometry(t){t.itinerary.itineraryPoints.forEach((t=>this.#geometry.push(t.latLng))),t.notes.forEach((t=>this.#pushNoteGeometry(t)))}constructor(){Object.seal(this)}zoomToLatLng(t){V.dispatch("zoomto",{latLng:t})}zoomToManeuver(t){let e=z.travel.editedRoute.itinerary.maneuvers.getAt(t).itineraryPointObjId,o=z.travel.editedRoute.itinerary.itineraryPoints.getAt(e).latLng;V.dispatch("zoomto",{latLng:o})}zoomToNote(t){this.#geometry=[],this.#pushNoteGeometry(Z.getNoteAndRoute(t).note),V.dispatch("zoomto",{geometry:[this.#geometry]})}zoomToRoute(t){this.#geometry=[],this.#pushRouteGeometry(Z.getRoute(t)),V.dispatch("zoomto",{geometry:[this.#geometry]})}zoomToTravel(){this.#geometry=[],z.travel.routes.forEach((t=>this.#pushRouteGeometry(t))),c!==z.travel.editedRouteObjId&&this.#pushRouteGeometry(z.travel.editedRoute),z.travel.notes.forEach((t=>this.#pushNoteGeometry(t))),V.dispatch("zoomto",{geometry:[this.#geometry]})}zoomToPoi(t){V.dispatch("zoomto",t)}}class _{constructor(){Object.freeze(this)}openDistantFile(t){(new W).decompress(t),z.travel.readOnly=!0,document.title="Travel & Notes"+(""===z.travel.name?"":" - "+z.travel.name);let e=z.travel.routes.iterator;for(;!e.done;)a.notEdited===e.value.editionStatus&&V.dispatch("routeupdated",{removedRouteObjId:c,addedRouteObjId:e.value.objId});c!==z.editedRouteObjId&&V.dispatch("routeupdated",{removedRouteObjId:c,addedRouteObjId:z.travel.editedRoute.objId});let o=z.travel.notes.iterator;for(;!o.done;)V.dispatch("noteupdated",{removedNoteObjId:c,addedNoteObjId:o.value.objId});(new Y).zoomToTravel()}}
/**
	@------------------------------------------------------------------------------------------------------------------------------
...
/**
	...
	@------------------------------------------------------------------------------------------------------------------------------
	*/class ye{#salt=null;#importKey(t){return window.crypto.subtle.importKey("raw",t,{name:"PBKDF2"},!1,["deriveKey"])}#deriveKey(t,e){return window.crypto.subtle.deriveKey({name:"PBKDF2",salt:(new window.TextEncoder).encode(e),iterations:1e6,hash:"SHA-256"},t,{name:"AES-GCM",length:256},!1,["encrypt","decrypt"])}#decrypt(t,e){return window.crypto.subtle.decrypt({name:"AES-GCM",iv:new Uint8Array(e.slice(0,16))},t,new Uint8Array(e.slice(16)))}#encrypt(t,e,o){return window.crypto.subtle.encrypt({name:"AES-GCM",iv:e},t,o)}constructor(t){this.#salt=t||"Tire la chevillette la bobinette cherra. Le Petit Chaperon rouge tira la chevillette.",Object.freeze(this)}encryptData(t,e,o,i){let n=window.crypto.getRandomValues(new Uint8Array(16));i.then(this.#importKey).then((t=>this.#deriveKey(t,this.#salt))).then((e=>this.#encrypt(e,n,t))).then((t=>{e(new Blob([n,new Uint8Array(t)],{type:"application/octet-stream"}))})).catch(o)}decryptData(t,e,o,i){i.then(this.#importKey).then((t=>this.#deriveKey(t,this.#salt))).then((e=>this.#decrypt(e,t))).then(e).catch(o)}}class be{constructor(){Object.freeze(this)}handleEvent(t){t.stopPropagation();let e=new Event("apikeydeleted");e.data={objId:Number.parseInt(t.target.dataset.tanObjId)},t.target.parentNode.parentNode.dispatchEvent(e)}}class fe{#rootHTMLElement=null;#providerNameInput=null;#providerKeyInput=null;#objId=c;constructor(e){this.#objId=D.nextObjId,this.#rootHTMLElement=J.create("div",{className:"TravelNotes-APIKeysDialog-ApiKeyRow"}),this.#providerNameInput=J.create("input",{className:"TravelNotes-APIKeysDialog-ApiKeyName TravelNotes-APIKeysDialog-Input",value:e.providerName,placeholder:N.getText("APIKeysDialog - provider name")},this.#rootHTMLElement),this.#providerKeyInput=J.create("input",{className:"TravelNotes-APIKeysDialog-ApiKeyValue TravelNotes-APIKeysDialog-Input",value:e.providerKey,placeholder:N.getText("APIKeysDialog - API key"),type:t.APIKeysDialog.showAPIKeys?"text":"password"},this.#rootHTMLElement),J.create("div",{className:"TravelNotes-BaseDialog-Button TravelNotes-APIKeysDialog-AtRightButton TravelNotes-APIKeysDialog-DeleteRowButton",title:N.getText("APIKeysDialog - delete API key"),textContent:"❌",dataset:{ObjId:this.#objId}},this.#rootHTMLElement).addEventListener("click",new be,!1),Object.freeze(this)}get objId(){return this.#objId}get HTMLElements(){return[this.#rootHTMLElement]}get providerName(){return this.#providerNameInput.value}get providerKey(){return this.#providerKeyInput.value}get APIKey(){return Object.seal({providerName:this.#providerNameInput.value,providerKey:this.#providerKeyInput.value})}}class De{#APIKeysDialog=null;constructor(t){this.#APIKeysDialog=t,Object.freeze(this)}destructor(){this.#APIKeysDialog=null}onErrorDecrypt(t){this.#APIKeysDialog.hideWait(),this.#APIKeysDialog.keyboardELEnabled=!0,t&&"Canceled by user"!==t&&this.#APIKeysDialog.showError(N.getText("APIKeysDialog - An error occurs when reading the file"))}onOkDecrypt(t){try{this.#APIKeysDialog.addAPIKeys(JSON.parse((new TextDecoder).decode(t)))}catch(t){return void this.onErrorDecrypt(t)}this.#APIKeysDialog.hideWait(),this.#APIKeysDialog.hideError(),this.#APIKeysDialog.keyboardELEnabled=!0}onOkEncrypt(t){this.#APIKeysDialog.hideError(),this.#APIKeysDialog.hideWait(),E.saveFile("APIKeys",t),this.#APIKeysDialog.keyboardELEnabled=!0}onErrorEncrypt(){this.#APIKeysDialog.showError(N.getText("APIKeysDialog - An error occurs when saving the keys")),this.#APIKeysDialog.hideWait(),this.#APIKeysDialog.keyboardELEnabled=!0}}class we{#APIKeysControls=null;constructor(t){this.#APIKeysControls=t,Object.freeze(this)}destructor(){this.#APIKeysControls=null}getAPIKeysJsonString(){let t=[];return this.#APIKeysControls.forEach((e=>{t.push(e.APIKey)})),JSON.stringify(t)}}class Ie{#APIKeysDialog=null;#APIKeysControls=null;constructor(t,e){this.#APIKeysDialog=t,this.#APIKeysControls=e,Object.freeze(this)}destructor(){this.#APIKeysDialog=null,this.#APIKeysControls=null}handleEvent(t){t.stopPropagation(),this.#APIKeysControls.delete(t.data.objId),this.#APIKeysDialog.refreshAPIKeys()}}class Le{#APIKeysDialog=null;constructor(t){this.#APIKeysDialog=t,Object.freeze(this)}destructor(){this.#APIKeysDialog=null}handleEvent(t){t.stopPropagation();let e=new FileReader;e.onload=()=>{try{this.#APIKeysDialog.addAPIKeys(JSON.parse(e.result))}catch(t){this.#APIKeysDialog.showError(t.message),t instanceof Error&&console.error(t)}},e.readAsText(t.target.files[0])}}class Te{#APIKeysDialog=null;#openUnsecureFileInputEventListener=null;constructor(t){this.#APIKeysDialog=t,this.#openUnsecureFileInputEventListener=new Le(this.#APIKeysDialog),Object.freeze(this)}destructor(){this.#APIKeysDialog=null,this.#openUnsecureFileInputEventListener.destructor()}handleEvent(t){t.stopPropagation(),this.#APIKeysDialog.hideError(),E.openFile(this.#openUnsecureFileInputEventListener,".json")}}class Ne{#APIKeysDialog=null;#dataEncryptorHandlers=null;constructor(t){this.#APIKeysDialog=t,this.#dataEncryptorHandlers=new De(this.#APIKeysDialog),Object.freeze(this)}destructor(){this.#APIKeysDialog=null,this.#dataEncryptorHandlers.destructor()}handleEvent(t){t.stopPropagation(),this.#APIKeysDialog.hideError(),this.#APIKeysDialog.showWait(),this.#APIKeysDialog.keyboardELEnabled=!1,fetch(window.location.href.substr(0,window.location.href.lastIndexOf("/")+1)+"APIKeys").then((t=>{g===t.status&&t.ok?t.arrayBuffer().then((t=>{(new ye).decryptData(t,(t=>{this.#dataEncryptorHandlers.onOkDecrypt(t)}),(t=>{this.#dataEncryptorHandlers.onErrorDecrypt(t)}),new ve(!1).show())})):this.#dataEncryptorHandlers.onErrorDecrypt(new Error("Invalid http status"))})).catch((t=>{this.#dataEncryptorHandlers.onErrorDecrypt(t),t instanceof Error&&console.error(t)}))}}class Ee{#APIKeysDialog=null;#dataEncryptorHandlers=null;constructor(t){this.#APIKeysDialog=t,this.#dataEncryptorHandlers=new De(this.#APIKeysDialog),Object.freeze(this)}destructor(){this.#APIKeysDialog=null,this.#dataEncryptorHandlers.destructor()}handleEvent(t){t.stopPropagation(),this.#APIKeysDialog.showWait(),this.#APIKeysDialog.keyboardELEnabled=!1;let e=new FileReader;e.onload=()=>{(new ye).decryptData(e.result,(t=>{this.#dataEncryptorHandlers.onOkDecrypt(t)}),(t=>{this.#dataEncryptorHandlers.onErrorDecrypt(t)}),new ve(!1).show())},e.readAsArrayBuffer(t.target.files[0])}}class Pe{#APIKeysDialog=null;#openSecureFileInputEventListener=null;constructor(t){this.#APIKeysDialog=t,this.#openSecureFileInputEventListener=new Ee(this.#APIKeysDialog),Object.freeze(this)}destructor(){this.#APIKeysDialog=null,this.#openSecureFileInputEventListener.destructor()}handleEvent(t){t.stopPropagation(),this.#APIKeysDialog.hideError(),E.openFile(this.#openSecureFileInputEventListener)}}class Ce{#APIKeysDialog=null;#APIKeysControls=null;#saveAPIKeysHelper=null;#dataEncryptorHandlers=null;constructor(t,e){this.#APIKeysDialog=t,this.#APIKeysControls=e,this.#saveAPIKeysHelper=new we(this.#APIKeysControls),this.#dataEncryptorHandlers=new De(this.#APIKeysDialog),Object.freeze(this)}destructor(){this.#APIKeysDialog=null,this.#APIKeysControls=null,this.#saveAPIKeysHelper.destructor(),this.#dataEncryptorHandlers.destructor()}handleEvent(t){t.stopPropagation(),this.#APIKeysDialog.validateAPIKeys()&&(this.#APIKeysDialog.showWait(),this.#APIKeysDialog.keyboardELEnabled=!1,(new ye).encryptData((new window.TextEncoder).encode(this.#saveAPIKeysHelper.getAPIKeysJsonString()),(t=>this.#dataEncryptorHandlers.onOkEncrypt(t)),(()=>this.#dataEncryptorHandlers.onErrorEncrypt()),new ve(!0).show()))}}class je{#APIKeysDialog=null;#APIKeysControls=null;#saveAPIKeysHelper=null;constructor(t,e){this.#APIKeysDialog=t,this.#APIKeysControls=e,this.#saveAPIKeysHelper=new we(this.#APIKeysControls),Object.freeze(this)}destructor(){this.#APIKeysDialog=null,this.#APIKeysControls=null,this.#saveAPIKeysHelper.destructor()}handleEvent(t){t.stopPropagation(),this.#APIKeysDialog.validateAPIKeys()&&E.saveFile("APIKeys.json",this.#saveAPIKeysHelper.getAPIKeysJsonString(),"application/json")}}class xe{#APIKeysDialog=null;#APIKeysControls=null;constructor(t,e){this.#APIKeysDialog=t,this.#APIKeysControls=e,Object.freeze(this)}destructor(){this.#APIKeysDialog=null,this.#APIKeysControls=null}handleEvent(t){t.stopPropagation();let e=Object.seal({providerName:"",providerKey:""}),o=new fe(e);this.#APIKeysControls.set(o.objId,o),this.#APIKeysDialog.refreshAPIKeys()}}class Ae{#APIKeysDialog=null;#APIKeysControls=null;#haveAPIKeysFile=!1;#rootHTMLElement=null;#reloadKeysFromServerButton=null;#saveKeysToSecureFileButton=null;#restoreKeysFromSecureFileButton=null;#newAPIKeyButton=null;#saveKeysToUnsecureFileButton=null;#restoreKeysFromUnsecureFileButton=null;#reloadKeysFromServerButtonEventListener=null;#saveKeysToSecureFileButtonEventListener=null;#restoreKeysFromSecureFileButtonEventListener=null;#newAPIKeyButtonEventListener=null;#saveKeysToUnsecureFileButtonEventListener=null;#restoreKeysFromUnsecureFileButtonEventListener=null;#createReloadKeysFromServerButton(){this.#reloadKeysFromServerButton=J.create("div",{className:"TravelNotes-BaseDialog-Button",title:N.getText("APIKeysDialog - Reload from server"),textContent:"🔄"},this.#rootHTMLElement),this.#reloadKeysFromServerButtonEventListener=new Ne(this.#APIKeysDialog),this.#reloadKeysFromServerButton.addEventListener("click",this.#reloadKeysFromServerButtonEventListener,!1)}#createSaveKeysToSecureFileButton(){this.#saveKeysToSecureFileButton=J.create("div",{className:"TravelNotes-BaseDialog-Button",title:N.getText("APIKeysDialog - Save to file"),textContent:"💾"},this.#rootHTMLElement),this.#saveKeysToSecureFileButtonEventListener=new Ce(this.#APIKeysDialog,this.#APIKeysControls),this.#saveKeysToSecureFileButton.addEventListener("click",this.#saveKeysToSecureFileButtonEventListener,!1)}#createRestoreKeysFromSecureFileButton(){this.#restoreKeysFromSecureFileButton=J.create("div",{className:"TravelNotes-BaseDialog-Button",title:N.getText("APIKeysDialog - Open file"),textContent:"📂"},this.#rootHTMLElement),this.#restoreKeysFromSecureFileButtonEventListener=new Pe(this.#APIKeysDialog),this.#restoreKeysFromSecureFileButton.addEventListener("click",this.#restoreKeysFromSecureFileButtonEventListener,!1)}#createNewAPIKeyButton(){this.#newAPIKeyButton=J.create("div",{className:"TravelNotes-BaseDialog-Button",title:N.getText("APIKeysDialog - new API key"),textContent:"+"},this.#rootHTMLElement),this.#newAPIKeyButtonEventListener=new xe(this.#APIKeysDialog,this.#APIKeysControls),this.#newAPIKeyButton.addEventListener("click",this.#newAPIKeyButtonEventListener,!1)}#createSaveKeysToUnsecureFileButton(){this.#saveKeysToUnsecureFileButton=J.create("div",{className:"TravelNotes-BaseDialog-Button TravelNotes-APIKeysDialog-AtRightButton",title:N.getText("APIKeysDialog - Save to json file"),textContent:"💾"},this.#rootHTMLElement),this.#saveKeysToUnsecureFileButtonEventListener=new je(this.#APIKeysDialog,this.#APIKeysControls),this.#saveKeysToUnsecureFileButton.addEventListener("click",this.#saveKeysToUnsecureFileButtonEventListener,!1)}#createRestoreKeysFromUnsecureFileButton(){this.#restoreKeysFromUnsecureFileButton=J.create("div",{className:"TravelNotes-BaseDialog-Button",title:N.getText("APIKeysDialog - Open json file"),textContent:"📂"},this.#rootHTMLElement),this.#restoreKeysFromUnsecureFileButtonEventListener=new Te(this.#APIKeysDialog),this.#restoreKeysFromUnsecureFileButton.addEventListener("click",this.#restoreKeysFromUnsecureFileButtonEventListener,!1)}#addToolbarButtons(){window.crypto&&window.crypto.subtle&&window.crypto.subtle.importKey&&window.isSecureContext&&(this.#haveAPIKeysFile&&this.#createReloadKeysFromServerButton(),this.#createSaveKeysToSecureFileButton(),this.#createRestoreKeysFromSecureFileButton()),this.#createNewAPIKeyButton(),t.APIKeysDialog.haveUnsecureButtons&&(this.#createSaveKeysToUnsecureFileButton(),this.#createRestoreKeysFromUnsecureFileButton())}constructor(t,e,o){this.#APIKeysDialog=t,this.#APIKeysControls=e,this.#haveAPIKeysFile=o,this.#rootHTMLElement=J.create("div",{id:"TravelNotes-APIKeysDialog-ToolbarDiv"}),this.#addToolbarButtons(),Object.freeze(this)}destructor(){this.#reloadKeysFromServerButton&&(this.#reloadKeysFromServerButton.removeEventListener("click",this.#reloadKeysFromServerButtonEventListener,!1),this.#reloadKeysFromServerButtonEventListener.destructor()),this.#saveKeysToSecureFileButton&&(this.#saveKeysToSecureFileButton.removeEventListener("click",this.#saveKeysToSecureFileButtonEventListener,!1),this.#saveKeysToSecureFileButtonEventListener.destructor()),this.#restoreKeysFromSecureFileButton&&(this.#restoreKeysFromSecureFileButton.removeEventListener("click",this.#restoreKeysFromSecureFileButtonEventListener,!1),this.#restoreKeysFromSecureFileButtonEventListener.destructor()),this.#newAPIKeyButton&&(this.#newAPIKeyButton.removeEventListener("click",this.#newAPIKeyButtonEventListener,!1),this.#newAPIKeyButtonEventListener.destructor()),this.#saveKeysToUnsecureFileButton&&(this.#saveKeysToUnsecureFileButton.removeEventListener("click",this.#saveKeysToUnsecureFileButtonEventListener,!1),this.#saveKeysToUnsecureFileButtonEventListener.destructor()),this.#restoreKeysFromUnsecureFileButton&&(this.#restoreKeysFromUnsecureFileButton.removeEventListener("click",this.#restoreKeysFromUnsecureFileButtonEventListener,!1),this.#restoreKeysFromUnsecureFileButtonEventListener.destructor())}get rootHTMLElement(){return this.#rootHTMLElement}}class Oe extends Rt{#APIKeysControls=new Map;#toolbar=null;#APIKeysControlsContainer=null;#onAPIKeyDeletedEventListener=null;#createAPIKeysControlsContainer(){this.#APIKeysControlsContainer=J.create("div"),this.#onAPIKeyDeletedEventListener=new Ie(this,this.#APIKeysControls),this.#APIKeysControlsContainer.addEventListener("apikeydeleted",this.#onAPIKeyDeletedEventListener,!1)}constructor(t,e){super(),this.#toolbar=new Ae(this,this.#APIKeysControls,e),this.#createAPIKeysControlsContainer(),this.addAPIKeys(t)}#destructor(){this.#toolbar.destructor(),this.#APIKeysControlsContainer.removeEventListener("apikeydeleted",this.#onAPIKeyDeletedEventListener,!1),this.#onAPIKeyDeletedEventListener.destructor()}validateAPIKeys(){this.hideError();let t=!1,e=[];this.#APIKeysControls.forEach((o=>{t=t||""===o.providerName||""===o.providerKey,e.push(o.providerName)}));let o=!1;return e.forEach((t=>{o=o||e.indexOf(t)!==e.lastIndexOf(t)})),t?(this.showError(N.getText("APIKeysDialog - empty API key name or value")),!1):!o||(this.showError(N.getText("APIKeysDialog - duplicate API key name found")),!1)}addAPIKeys(t){this.#APIKeysControls.clear(),t.forEach((t=>{let e=new fe(t);this.#APIKeysControls.set(e.objId,e)})),this.refreshAPIKeys()}refreshAPIKeys(){for(;this.#APIKeysControlsContainer.firstChild;)this.#APIKeysControlsContainer.removeChild(this.#APIKeysControlsContainer.firstChild);this.#APIKeysControls.forEach((t=>{this.#APIKeysControlsContainer.appendChild(t.HTMLElements[0])}))}canClose(){return this.validateAPIKeys()}onCancel(){this.#destructor(),super.onCancel()}onOk(){let t=[];this.#APIKeysControls.forEach((e=>t.push(e.APIKey))),super.onOk(t)&&this.#destructor()}get title(){return N.getText("APIKeysDialog - API keys")}get contentHTMLElements(){return[this.#toolbar.rootHTMLElement,this.#APIKeysControlsContainer]}}const Me=new class{#haveAPIKeysFile=!1;#APIKeysMap=new Map;#onOkDecryptServerFile(t){let e=JSON.parse((new TextDecoder).decode(t));this.#resetAPIKeys(e)}#onErrorDecryptServerFile(t){t instanceof Error&&console.error(t),t&&"Canceled by user"!==t&&ue.showError(N.getText("APIKeysManager - An error occurs when reading the APIKeys file"))}#onServerFileFound(t){window.isSecureContext&&window.crypto&&window.crypto.subtle&&window.crypto.subtle.importKey&&(new ye).decryptData(t,(t=>this.#onOkDecryptServerFile(t)),(t=>this.#onErrorDecryptServerFile(t)),new ve(!1).show())}#getAPIKey(t){return this.#APIKeysMap.get(t.toLowerCase())}#setAPIKey(t,e){this.#APIKeysMap.set(t.toLowerCase(),e)}#setAPIKeysFromSessionStorage(){let t=0;for(let e=0;e<sessionStorage.length;e++){let o=sessionStorage.key(e);"ProviderKey"===o.substr(o.length-"ProviderKey".length)&&(this.#setAPIKey(o.substr(0,o.length-"ProviderKey".length),atob(sessionStorage.getItem(o))),t++)}return z.providers.forEach((t=>{t.providerKey=this.#getAPIKey(t.name)||""})),t}#resetAPIKeys(e){sessionStorage.clear(),this.#APIKeysMap.clear();let o=E.storageAvailable("sessionStorage")&&t.APIKeys.saveToSessionStorage;e.forEach((t=>{o&&sessionStorage.setItem(t.providerName.toLowerCase()+"ProviderKey",btoa(t.providerKey)),this.#setAPIKey(t.providerName,t.providerKey)})),z.providers.forEach((t=>{t.providerKey=this.#getAPIKey(t.name)||""})),V.dispatch("providersadded")}constructor(){Object.freeze(this)}hasKey(t){return this.#APIKeysMap.has(t.toLowerCase())}getUrl(t){if(t.providerKeyNeeded){let e=this.#APIKeysMap.get(t.providerName.toLowerCase());return e?t.url.replace("{providerKey}",e):null}return t.url}setKeysFromServerFile(){let t=!1;0!==this.#setAPIKeysFromSessionStorage()&&(V.dispatch("providersadded"),t=!0),fetch(window.location.href.substr(0,window.location.href.lastIndexOf("/")+1)+"APIKeys").then((e=>{g===e.status&&e.ok&&(this.#haveAPIKeysFile=!0,t||e.arrayBuffer().then((t=>this.#onServerFileFound(t))))})).catch((t=>{t instanceof Error&&console.error(t)}))}setKeysFromDialog(){let t=[];this.#APIKeysMap.forEach(((e,o)=>{t.push(Object.seal({providerName:o,providerKey:e}))})),t.sort(((t,e)=>t.providerName.localeCompare(e.providerName))),new Oe(t,this.#haveAPIKeysFile).show().then((t=>this.#resetAPIKeys(t))).catch((t=>{t instanceof Error&&console.error(t)}))}addProvider(t){let e=new t,o=e.name.toLowerCase(),i=this.#getAPIKey(o);e.providerKeyNeeded&&!i&&E.storageAvailable("sessionStorage")&&(i=sessionStorage.getItem(o),i&&(i=atob(i))),e.providerKeyNeeded&&i&&(e.providerKey=i),z.providers.set(e.name.toLowerCase(),e)}};class Se{#myGpxString="";#timeStamp="";#route=null;#addHeader(){this.#myGpxString='<?xml version="1.0"?>\n',this.#myGpxString+='<gpx xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xsi:schemaLocation="http://www.topografix.com/GPX/1/1 http://www.topografix.com/GPX/1/1/gpx.xsd" version="1.1" creator="leaflet.TravelNotes">'}#addWayPoints(){let t=this.#route.wayPoints.iterator;for(;!t.done;)this.#myGpxString+='\n\t<wpt lat="'+t.value.lat+'" lon="'+t.value.lng+'" '+this.#timeStamp+"/>"}#addRoute(){this.#myGpxString+="\n\t<rte>";let t=this.#route.itinerary.maneuvers.iterator;for(;!t.done;){let e=this.#route.itinerary.itineraryPoints.getAt(t.value.itineraryPointObjId),o=t.value.instruction.replaceAll(/\u0027/g,"&apos;").replaceAll(/"/g,"&quot;").replaceAll(/</g,"&lt;").replaceAll(/>/g,"&gt;");this.#myGpxString+='\n\t\t<rtept lat="'+e.lat+'" lon="'+e.lng+'" '+this.#timeStamp+'desc="'+o+'" />'}this.#myGpxString+="\n\t</rte>"}#addTrack(){this.#myGpxString+="\n\t<trk>",this.#myGpxString+="\n\t\t<trkseg>";let t=this.#route.itinerary.itineraryPoints.iterator;for(;!t.done;)this.#myGpxString+='\n\t\t\t<trkpt lat="'+t.value.lat+'" lon="'+t.value.lng+'" '+this.#timeStamp+" />";this.#myGpxString+="\n\t\t</trkseg>",this.#myGpxString+="\n\t</trk>"}#addFooter(){this.#myGpxString+="\n</gpx>"}#saveGpxToFile(){let t=(""===z.travel.name?"":z.travel.name+" - ")+this.#route.computedName;""===t&&(t="TravelNote"),t+=".gpx",E.saveFile(t,this.#myGpxString,"application/xml")}constructor(){Object.freeze(this)}routeToGpx(t){this.#route=Z.getRoute(t),this.#route&&(this.#timeStamp='time="'+(new Date).toISOString()+'" ',this.#addHeader(),this.#addWayPoints(),this.#addRoute(),this.#addTrack(),this.#addFooter(),this.#saveGpxToFile())}}class Re{#red=e.maxColorValue;#green=e.maxColorValue;#blue=e.maxColorValue;constructor(t,o,i){this.#red="number"==typeof t&&e.maxColorValue>=t&&e.minColorValue<=t?t:e.maxColorValue,this.#green="number"==typeof o&&e.maxColorValue>=o&&e.minColorValue<=o?o:e.maxColorValue,this.#blue="number"==typeof i&&e.maxColorValue>=i&&e.minColorValue<=i?i:e.maxColorValue,Object.freeze(this)}get red(){return this.#red}set red(t){"number"==typeof t&&e.maxColorValue>=t&&e.minColorValue<=t&&(this.#red=t)}get green(){return this.#green}set green(t){"number"==typeof t&&e.maxColorValue>=t&&e.minColorValue<=t&&(this.#green=t)}get blue(){return this.#blue}set blue(t){"number"==typeof t&&e.maxColorValue>=t&&e.minColorValue<=t&&(this.#blue=t)}get cssColor(){return"#"+this.#red.toString(p).padStart(2,"0")+this.#green.toString(p).padStart(2,"0")+this.#blue.toString(p).padStart(2,"0")}set cssColor(t){"#"===t[0]?(this.#red=Number.parseInt(t.substr(1,2),p),this.#green=Number.parseInt(t.substr(3,2),p),this.#blue=Number.parseInt(t.substr(5,2),p)):"rgb"===t.substr(0,3)&&([this.#red,this.#green,this.#blue]=Array.from(t.match(/[0-9]{1,3}/g),(t=>Number.parseInt(t))))}clone(){return new Re(this.#red,this.#green,this.#blue)}copyTo(t){t.red=this.#red,t.green=this.#green,t.blue=this.#blue}}class ke{#redSlider=null;#colorButtons=null;constructor(t,e){this.#redSlider=t,this.#colorButtons=e,Object.freeze(this)}destructor(){this.#redSlider=null,this.#colorButtons=null}handleEvent(t){t.stopPropagation();let o=new Re;o.red=Math.ceil(t.target.valueAsNumber*(e.maxColorValue/e.sliderMaxValue));for(let t=0;t<e.rowsNumber;++t){o.blue=t*e.deltaColor;for(let i=0;i<e.rowsNumber;++i)o.green=i*e.deltaColor,this.#colorButtons[e.rowsNumber*t+i].style["background-color"]=o.cssColor}}}class He{#colorControl=null;#inputs=null;constructor(t,e){this.#colorControl=t,this.#inputs=e,Object.freeze(this)}destructor(){this.#colorControl=null,this.#inputs=null}handleEvent(t){t.stopPropagation();let e=new Re(Number.parseInt(this.#inputs.red.value),Number.parseInt(this.#inputs.green.value),Number.parseInt(this.#inputs.blue.value));this.#colorControl.color=e}}class Be{#colorControl=null;constructor(t){this.#colorControl=t,Object.freeze(this)}destructor(){this.#colorControl=null}handleEvent(t){t.stopPropagation();let e=new Re;e.cssColor=t.target.style["background-color"],this.#colorControl.color=e}}class Ke{#colorDiv=null;#colorButtons=[];#inputs={red:null,green:null,blue:null};#redSliderInput=null;#rgbDiv=null;#colorSampleDiv=null;#newColor=new Re;#eventListeners={onColorButtonClick:null,onColorInput:null,onRedSliderInput:null};#createColorButtonsDiv(){let t=J.create("div",null,this.#colorDiv),o=new Re(e.initialRed,e.minColorValue,e.minColorValue);this.#eventListeners.onColorButtonClick=new Be(this);for(let i=0;i<e.rowsNumber;++i){let i=J.create("div",null,t);o.green=e.minColorValue;for(let t=0;t<e.cellsNumber;++t){let t=J.create("div",{className:"TravelNotes-ColorControl-CellColorDiv"},i);t.style["background-color"]=o.cssColor,t.addEventListener("click",this.#eventListeners.onColorButtonClick,!1),o.green+=e.deltaColor,this.#colorButtons.push(t)}o.blue+=e.deltaColor}}#createRedSliderDiv(){let t=J.create("div",null,this.#colorDiv);this.#redSliderInput=J.create("input",{type:"range",value:Math.ceil(e.initialRed*(e.sliderMaxValue/e.maxColorValue)),min:0,max:e.sliderMaxValue,step:e.sliderStep},t),this.#eventListeners.onRedSliderInput=new ke(this.#redSliderInput,this.#colorButtons),this.#redSliderInput.addEventListener("input",this.#eventListeners.onRedSliderInput,!1),this.#redSliderInput.focus()}#createColorInput(t,o){J.create("text",{value:t},this.#rgbDiv);let i=J.create("input",{type:"number",className:"TravelNotes-ColorControl-NumberInput",value:o,min:e.minColorValue,max:e.maxColorValue},this.#rgbDiv);return i.addEventListener("input",this.#eventListeners.onColorInput,!1),i}#createColorInputsDiv(){this.#rgbDiv=J.create("div",null,this.#colorDiv),this.#eventListeners.onColorInput=new He(this,this.#inputs),this.#inputs.red=this.#createColorInput(N.getText("ColorControl - Red"),this.#newColor.red),this.#inputs.green=this.#createColorInput(N.getText("ColorControl - Green"),this.#newColor.green),this.#inputs.blue=this.#createColorInput(N.getText("ColorControl - Blue"),this.#newColor.blue)}#createColorSampleDiv(){this.#colorSampleDiv=J.create("div",{id:"TravelNotes-ColorControl-ColorSampleDiv"},this.#colorDiv),this.#colorSampleDiv.style["background-color"]=this.#newColor.cssColor}constructor(t){Object.freeze(this),this.#newColor.cssColor=t,this.#colorDiv=J.create("div",{id:"TravelNotes-ColorControl-ColorDiv"}),this.#createColorButtonsDiv(),this.#createRedSliderDiv(),this.#createColorInputsDiv(),this.#createColorSampleDiv()}destructor(){this.#colorButtons.forEach((t=>{t.removeEventListener("click",this.#eventListeners.onColorButtonClick,!1)})),this.#eventListeners.onColorButtonClick.destructor();for(const t in this.#inputs)this.#inputs[t].removeEventListener("input",this.#eventListeners.onColorInput,!1);this.#eventListeners.onColorInput.destructor(),this.#redSliderInput.removeEventListener("input",this.#eventListeners.onRedSliderInput,!1),this.#eventListeners.onRedSliderInput.destructor()}get HTMLElements(){return[this.#colorDiv]}get cssColor(){return this.#newColor.cssColor}set color(t){this.#inputs.red.value=t.red,this.#inputs.green.value=t.green,this.#inputs.blue.value=t.blue,this.#colorSampleDiv.style["background-color"]=t.cssColor,t.copyTo(this.#newColor)}}class Fe extends Rt{#route=null;#colorControl=null;#nameInput=null;#widthInput=null;#dashSelect=null;#chainInput=null;#createNameDiv(){let t=J.create("div",{textContent:N.getText("RoutePropertiesDialog - Name")}),e=J.create("div",{className:"TravelNotes-RoutePropertiesDialog-DataDiv",id:"TravelNotes-RoutePropertiesDialog-NameInputDiv"});return this.#nameInput=J.create("input",{type:"text",id:"TravelNotes-RoutePropertiesDialog-NameInput",value:this.#route.computedName},e),[t,e]}#createWidthDiv(){let t=J.create("div",{className:"TravelNotes-RoutePropertiesDialog-DataDiv"});return J.create("text",{value:N.getText("RoutePropertiesDialog - Width")},J.create("span",null,t)),this.#widthInput=J.create("input",{type:"number",id:"TravelNotes-RoutePropertiesDialog-WidthInput",value:this.#route.width,min:1,max:40},t),t}#createDashDiv(){let e=J.create("div",{className:"TravelNotes-RoutePropertiesDialog-DataDiv"});J.create("text",{value:N.getText("RoutePropertiesDialog - Linetype")},J.create("span",null,e)),this.#dashSelect=J.create("select",null,e);let o=t.route.dashChoices;for(let t=0;t<o.length;t++)this.#dashSelect.add(J.create("option",{text:o[t].text}));return this.#dashSelect.selectedIndex=this.#route.dashArray<o.length?this.#route.dashArray:0,e}#createChainDiv(){let t=J.create("div",{className:"TravelNotes-RoutePropertiesDialog-DataDiv",id:"TravelNotes-RoutePropertiesDialog-ChainDiv"});return J.create("text",{value:N.getText("RoutePropertiesDialog - Chained route")},J.create("span",null,t)),this.#chainInput=J.create("input",{type:"checkbox",checked:this.#route.chain},t),t}#createColorHeaderDiv(){return J.create("div",{textContent:N.getText("RoutePropertiesDialog - Color"),id:"TravelNotes-RoutePropertiesDialog-ColorHeaderDiv"})}constructor(t){super(),this.#route=t,this.#colorControl=new Ke(t.color)}onCancel(){this.#colorControl.destructor(),super.onCancel()}onOk(){this.#route.color=this.#colorControl.cssColor,this.#route.computedName!==this.#nameInput.value&&(this.#route.name=this.#nameInput.value),this.#route.width=parseInt(this.#widthInput.value),this.#route.chain=this.#chainInput.checked,this.#route.dashArray=this.#dashSelect.selectedIndex,this.#route.validateData(),this.#colorControl.destructor(),super.onOk()}get title(){return N.getText("RoutePropertiesDialog - Route properties")}get contentHTMLElements(){return[].concat(this.#createNameDiv(),this.#createWidthDiv(),this.#createDashDiv(),this.#createChainDiv(),this.#createColorHeaderDiv(),this.#colorControl.HTMLElements)}}class ze extends Rt{#paperWidthInput=null;#paperHeightInput=null;#borderWidthInput=null;#pageBreakInput=null;#printNotesInput=null;#zoomFactorInput=null;#createPaperWidthDiv(){let e=J.create("div",{className:"TravelNotes-PrintRouteMapDialog-DataDiv"});return J.create("text",{value:N.getText("PrintRouteMapDialog - Paper width")},e),this.#paperWidthInput=J.create("input",{type:"number",className:"TravelNotes-PrintRouteMapDialog-NumberInput"},e),this.#paperWidthInput.value=t.printRouteMap.paperWidth,J.create("text",{value:N.getText("PrintRouteMapDialog - Paper width units")},e),e}#createPaperHeightDiv(){let e=J.create("div",{className:"TravelNotes-PrintRouteMapDialog-DataDiv"});return J.create("text",{value:N.getText("PrintRouteMapDialog - Paper height")},e),this.#paperHeightInput=J.create("input",{type:"number",className:"TravelNotes-PrintRouteMapDialog-NumberInput",value:t.printRouteMap.paperHeight},e),J.create("text",{value:N.getText("PrintRouteMapDialog - Paper height units")},e),e}#createBorderWidthDiv(){let e=J.create("div",{className:"TravelNotes-PrintRouteMapDialog-DataDiv"});return J.create("text",{value:N.getText("PrintRouteMapDialog - Border width")},e),this.#borderWidthInput=J.create("input",{type:"number",className:"TravelNotes-PrintRouteMapDialog-NumberInput",value:t.printRouteMap.borderWidth},e),J.create("text",{value:N.getText("PrintRouteMapDialog - Border width units")},e),e}#createZoomFactorDiv(){let e=J.create("div",{className:"TravelNotes-PrintRouteMapDialog-DataDiv"});return J.create("text",{value:N.getText("PrintRouteMapDialog - Zoom factor")},e),this.#zoomFactorInput=J.create("input",{type:"number",className:"TravelNotes-PrintRouteMapDialog-NumberInput",value:Math.min(t.printRouteMap.zoomFactor,15),min:z.map.getMinZoom(),max:Math.min(z.map.getMaxZoom(),15)},e),e}#createPageBreakDiv(){let e=J.create("div",{className:"TravelNotes-PrintRouteMapDialog-DataDiv"});return this.#pageBreakInput=J.create("input",{type:"checkbox",checked:t.printRouteMap.pageBreak},e),J.create("text",{value:N.getText("PrintRouteMapDialog - Page break")},e),e}#createPrintNotesDiv(){let e=J.create("div",{className:"TravelNotes-PrintRouteMapDialog-DataDiv"});return this.#printNotesInput=J.create("input",{type:"checkbox",checked:t.printRouteMap.printNotes},e),J.create("text",{value:N.getText("PrintRouteMapDialog - Print notes")},e),e}constructor(t={}){super(t)}onOk(){super.onOk(Object.freeze({paperWidth:parseInt(this.#paperWidthInput.value),paperHeight:parseInt(this.#paperHeightInput.value),borderWidth:parseInt(this.#borderWidthInput.value),zoomFactor:parseInt(this.#zoomFactorInput.value),pageBreak:this.#pageBreakInput.checked,printNotes:this.#printNotesInput.checked}))}get contentHTMLElements(){return[this.#createPaperWidthDiv(),this.#createPaperHeightDiv(),this.#createBorderWidthDiv(),this.#createZoomFactorDiv(),this.#createPageBreakDiv(),this.#createPrintNotesDiv()]}get title(){return N.getText("PrintRouteMapDialog - Print")}}
/**
	@------------------------------------------------------------------------------------------------------------------------------
	...
	@------------------------------------------------------------------------------------------------------------------------------
	*/
class Ve{#dragData=null;constructor(t){Object.freeze(this),this.#dragData=t}handleEvent(t){this.#dragData.dragStartX=t.screenX,this.#dragData.dragStartY=t.screenY,t.dataTransfer.dropEffect="move",t.dataTransfer.effectAllowed="move"}}class Ue{#dragData=null;#containerDiv=null;constructor(t){Object.seal(this),this.#dragData=t}handleEvent(t){let e=t.target.parentNode;this.#dragData.windowX+=t.screenX-this.#dragData.dragStartX,this.#dragData.windowY+=t.screenY-this.#dragData.dragStartY,this.#dragData.windowX=Math.min(Math.max(this.#dragData.windowX,20),z.map.getContainer().clientWidth-e.clientWidth-20),this.#dragData.windowY=Math.max(this.#dragData.windowY,20);let o=z.map.getContainer().clientHeight-Math.max(this.#dragData.windowY,0)-20;e.style.top=String(this.#dragData.windowY)+"px",e.style.left=String(this.#dragData.windowX)+"px",e.style["max-height"]=String(o)+"px"}}class We extends It{constructor(t,e=null){super(t,e)}doAction(t){switch(t){case 0:pe.newRouteNote({routeObjId:this.eventData.targetObjId,lat:this.eventData.lat,lng:this.eventData.lng});break;case 1:(new Y).zoomToLatLng([this.eventData.lat,this.eventData.lng])}}get menuItems(){return[{itemText:N.getText("ProfileContextMenu - Add a note to the route at this point"),isActive:!0},{itemText:N.getText("ProfileContextMenu - Zoom to this point"),isActive:!0}]}}
/**
	@------------------------------------------------------------------------------------------------------------------------------
	...
	@------------------------------------------------------------------------------------------------------------------------------
	*/class Ge{constructor(){Object.freeze(this)}getlatLngElevOnRouteAtMousePosition(t){let e=Z.getRoute(Number.parseInt(t.currentTarget.dataset.tanObjId)),o=t.currentTarget.getBoundingClientRect(),i=(t.clientX-o.x-r.margin/(2*r.margin+r.width)*o.width)/(r.width/(2*r.margin+r.width)*o.width)*e.distance;return 0<i&&i<e.distance?G.getLatLngElevAtDist(e,i):null}}class Xe extends Ge{constructor(){super()}handleEvent(t){t.preventDefault(),t.stopPropagation();let e=this.getlatLngElevOnRouteAtMousePosition(t);e&&(t.latlng={lat:e.latLng[0],lng:e.latLng[1]},new We(t).show())}}class Ze{constructor(){Object.freeze(this)}handleEvent(t){t.preventDefault(),t.stopPropagation(),V.dispatch("removeobject",{objId:Number.parseInt(t.currentTarget.dataset.tanMarkerObjId)})}}class Ye extends Ge{constructor(){super()}#marker=null;#distanceText=null;#elevText=null;#ascentText=null;#textAnchor=null;#markerX=null;#profileSvg=null;#createSvgText(t,e){let o=document.createElementNS(m,"text");return o.appendChild(document.createTextNode(t)),o.setAttributeNS(null,"class","TravelNotes-Route-SvgProfile-elevText"),o.setAttributeNS(null,"x",this.#markerX),o.setAttributeNS(null,"y",e),o.setAttributeNS(null,"text-anchor",this.#textAnchor),this.#profileSvg.appendChild(o),o}handleEvent(t){t.preventDefault(),t.stopPropagation(),this.#profileSvg=t.currentTarget;let e=this.getlatLngElevOnRouteAtMousePosition(t);if(e){let o=Number.parseInt(this.#profileSvg.dataset.tanMarkerObjId);V.dispatch("removeobject",{objId:o}),V.dispatch("additinerarypointmarker",{objId:o,latLng:e.latLng}),this.#marker&&(this.#profileSvg.removeChild(this.#marker),this.#profileSvg.removeChild(this.#distanceText),this.#profileSvg.removeChild(this.#elevText),this.#profileSvg.removeChild(this.#ascentText));let i=this.#profileSvg.getBoundingClientRect();this.#markerX=(2*r.margin+r.width)*(t.clientX-i.x)/i.width;let n=r.margin+r.height;this.#marker=document.createElementNS(m,"polyline"),this.#marker.setAttributeNS(null,"points",String(this.#markerX)+","+r.margin+" "+this.#markerX+","+n),this.#marker.setAttributeNS(null,"class","TravelNotes-Route-SvgProfile-markerPolyline"),this.#profileSvg.appendChild(this.#marker);let s=Z.getRoute(Number.parseInt(this.#profileSvg.dataset.tanObjId));this.#textAnchor=e.routeDistance>s.distance/2?"end":"start",this.#markerX+=e.routeDistance>s.distance/2?-r.xDeltaText:r.xDeltaText,this.#distanceText=this.#createSvgText(E.formatDistance(e.routeDistance),r.margin+r.yDeltaText),this.#elevText=this.#createSvgText("Alt. "+e.elev.toFixed(0)+" m.",r.margin+2*r.yDeltaText),this.#ascentText=this.#createSvgText("Pente "+e.ascent.toFixed(0)+" % ",r.margin+3*r.yDeltaText)}}}class _e extends class{#dragData=Object.seal({dragStartX:0,dragStartY:0,windowX:0,windowY:0});#containerDiv=null;#topBar=null;#headerDiv=null;#contentDiv=null;#eventListeners={onTopBarDragStart:null,onTopBarDragEnd:null};#createContainerDiv(){this.#containerDiv=J.create("div",{className:"TravelNotes-FloatWindow-Container"},document.body)}#createTopBar(){this.#topBar=J.create("div",{className:"TravelNotes-FloatWindow-TopBar",draggable:!0},this.#containerDiv),this.#topBar.addEventListener("dragstart",this.#eventListeners.onTopBarDragStart,!1),this.#topBar.addEventListener("dragend",this.#eventListeners.onTopBarDragEnd,!1),J.create("div",{textContent:"❌",className:"TravelNotes-FloatWindow-CancelButton",title:N.getText("FloatWindow - Close")},this.#topBar).addEventListener("click",(()=>this.close()),!1)}#createHeaderDiv(){this.#headerDiv=J.create("div",{className:"TravelNotes-FloatWindow-HeaderDiv"},this.#containerDiv)}#createContentDiv(){this.#contentDiv=J.create("div",{className:"TravelNotes-FloatWindow-ContentDiv"},this.#containerDiv)}constructor(){this.#eventListeners.onTopBarDragStart=new Ve(this.#dragData),this.#eventListeners.onTopBarDragEnd=new Ue(this.#dragData),this.#createContainerDiv(),this.#createTopBar(),this.#createHeaderDiv(),this.#createContentDiv(),Object.seal(this)}close(){this.#topBar.removeEventListener("dragstart",this.#eventListeners.onTopBarDragStart,!1),this.#topBar.removeEventListener("dragend",this.#eventListeners.onTopBarDragEnd,!1),this.#eventListeners.onTopBarDragStart=null,this.#eventListeners.onTopBarDragEnd=null,document.body.removeChild(this.#containerDiv)}update(){}get header(){return this.#headerDiv}get content(){return this.#contentDiv}}{#svg=null;#ascentDiv=null;#route=null;#eventListeners={onSvgContextMenu:null,onSvgMouseMove:null,onSvgMouseLeave:null};#markerObjId=D.nextObjId;#clean(){this.#svg&&(this.#svg.removeEventListener("contextmenu",this.#eventListeners.onSvgContextMenu,!1),this.#svg.removeEventListener("mousemove",this.#eventListeners.onSvgMouseMove,!1),this.#svg.removeEventListener("mouseleave",this.#eventListeners.onSvgMouseLeave,!1),V.dispatch("removeobject",{objId:this.#markerObjId}),this.content.removeChild(this.#ascentDiv),this.content.removeChild(this.#svg)),this.#svg=null,this.#ascentDiv=null}constructor(){super(),this.#eventListeners.onSvgContextMenu=new Xe,this.#eventListeners.onSvgMouseMove=new Ye,this.#eventListeners.onSvgMouseLeave=new Ze}close(){this.#clean(),V.dispatch("profileclosed",{objId:this.#route.objId}),super.close()}update(t){this.#clean(),this.#route=t,this.#svg=(new ct).createSvg(this.#route),this.#svg.dataset.tanObjId=t.objId,this.#svg.dataset.tanMarkerObjId=this.#markerObjId,this.header.textContent=N.getText("ProfileWindow - Profile {name}",{name:this.#route.computedName}),this.content.appendChild(this.#svg),this.#svg.addEventListener("contextmenu",this.#eventListeners.onSvgContextMenu,!1),this.#svg.addEventListener("mousemove",this.#eventListeners.onSvgMouseMove,!1),this.#svg.addEventListener("mouseleave",this.#eventListeners.onSvgMouseLeave,!1),this.#ascentDiv=J.create("div",{className:"TravelNotes-ProfileWindow-Ascent",textContent:N.getText("ProfileWindow - Ascent: {ascent} m. - Descent: {descent} m. - Distance: {distance}",{ascent:this.#route.itinerary.ascent.toFixed(0),descent:this.#route.itinerary.descent.toFixed(0),distance:E.formatDistance(this.#route.distance)})}),this.content.appendChild(this.#ascentDiv)}}const Je=new class{#profileWindows=new Map;constructor(){Object.freeze(this)}createProfile(e){let o=this.#profileWindows.get(e.objId);if(e.itinerary.hasProfile){t.route.elev.smooth&&(new ct).smooth(e),e.itinerary.ascent=0,e.itinerary.descent=0;let i=e.itinerary.itineraryPoints.first.elev;e.itinerary.itineraryPoints.forEach((t=>{let o=t.elev-i;0>o?e.itinerary.descent-=o:e.itinerary.ascent+=o,i=t.elev})),o&&o.update(e)}else o&&o.close()}updateProfile(t,e){let o=this.#profileWindows.get(t);o&&(this.#profileWindows.delete(t),e&&e.itinerary.hasProfile?(o.update(e),this.#profileWindows.set(e.objId,o)):o.close())}deleteProfile(t){let e=this.#profileWindows.get(t);e&&e.close()}deleteAllProfiles(){this.#profileWindows.forEach((t=>t.close()))}showProfile(t){let e=this.#profileWindows.get(t);e||(e=new _e);let o=Z.getRoute(t);e.update(o),this.#profileWindows.set(t,e)}onProfileClosed(t){this.#profileWindows.delete(t)}},qe=1e-6;class $e{#views=[];#route=null;#printSize=null;#isItineraryHorOrVer(t,e,o){return e.lng===o.lng?{lat:e.lat>o.lat?t.bottomLeft.lat:t.upperRight.lat,lng:e.lng}:e.lat===o.lat?{lat:e.lat,lng:e.lng<o.lng?t.upperRight.lng:t.bottomLeft.lng}:null}#isFirstPointOnView(t,e){return e.lat-t.bottomLeft.lat<qe||t.upperRight.lat-e.lat<qe||e.lng-t.bottomLeft.lng<qe||t.upperRight.lng-e.lng<qe?{lat:e.lat,lng:e.lng}:null}#haveViewOnlyOnePoint(t,e,o){if(t.bottomLeft.lat===t.upperRight.lat&&t.bottomLeft.lng===t.upperRight.lng){let t=Math.min(Math.abs(this.#printSize[0]/(o.lat-e.lat)),Math.abs(this.#printSize[1]/(o.lng-e.lng)));return{lat:e.lat+t*(o.lat-e.lat),lng:e.lng+t*(o.lng-e.lng)}}return null}#computeIntermediatePoint(t,e,o){let i=this.#haveViewOnlyOnePoint(t,e,o);if(i)return i;if(i=this.#isFirstPointOnView(t,e),i)return i;if(i=this.#isItineraryHorOrVer(t,e,o),i)return i;let n=(e.lat-o.lat)/(e.lng-o.lng),s=e.lat-n*e.lng;if(i={lat:n*t.upperRight.lng+s,lng:t.upperRight.lng},i.lat<=t.upperRight.lat&&i.lat>=t.bottomLeft.lat&&i.lng<o.lng)return i;if(i={lat:t.upperRight.lat,lng:(t.upperRight.lat-s)/n},i.lng>=t.bottomLeft.lng&&i.lng<=t.upperRight.lng&&i.lat<o.lat)return i;if(i={lat:n*t.bottomLeft.lng+s,lng:t.bottomLeft.lng},i.lat<=t.upperRight.lat&&i.lat>=t.bottomLeft.lat&&i.lng>o.lng)return i;if(i={lat:t.bottomLeft.lat,lng:(t.bottomLeft.lat-s)/n},i.lng>=t.bottomLeft.lng&&i.lng<=t.upperRight.lng&&i.lat>o.lat)return i;throw new Error("intermediate point not found")}#computeViews(){this.#views=[];let t=this.#route.itinerary.itineraryPoints.iterator,e=t.done,o={bottomLeft:{lat:t.value.lat,lng:t.value.lng},upperRight:{lat:t.value.lat,lng:t.value.lng}},i={lat:t.value.lat,lng:t.value.lng},n=t.value;e=t.done;let s=t.value;for(;!e;){let a={bottomLeft:{lat:Math.min(o.bottomLeft.lat,s.lat),lng:Math.min(o.bottomLeft.lng,s.lng)},upperRight:{lat:Math.max(o.upperRight.lat,s.lat),lng:Math.max(o.upperRight.lng,s.lng)}},r=[a.upperRight.lat-a.bottomLeft.lat,a.upperRight.lng-a.bottomLeft.lng];this.#printSize[0]>r[0]&&this.#printSize[1]>r[1]?(o=a,n=t.value,e=t.done,s=t.value,e&&(o.entryPoint=i,o.exitPoint=n,this.#views.push(o))):(n=this.#computeIntermediatePoint(o,n,s),o.bottomLeft={lat:Math.min(o.bottomLeft.lat,n.lat),lng:Math.min(o.bottomLeft.lng,n.lng)},o.upperRight={lat:Math.max(o.upperRight.lat,n.lat),lng:Math.max(o.upperRight.lng,n.lng)},o.entryPoint=i,o.exitPoint=n,this.#views.push(o),o={bottomLeft:{lat:n.lat,lng:n.lng},upperRight:{lat:n.lat,lng:n.lng}},i={lat:n.lat,lng:n.lng})}}constructor(t,e){Object.freeze(this),this.#route=t,this.#printSize=e,this.#computeViews()}get views(){return this.#views}}class Qe{#name=null;#service=null;#url=null;#wmsOptions=null;#bounds=null;#minZoom=null;#maxZoom=null;#toolbar=null;#providerName=null;#providerKeyNeeded=!1;#attribution=null;#getCapabilitiesUrl=null;constructor(t){if(!t.name||"string"!=typeof t.name)throw new Error("invalid name for layer");if(this.#name=b.sanitizeToJsString(t.name),!t.service||"wms"!==t.service&&"wmts"!==t.service)throw new Error("invalid service for layer "+this.#name);if(this.#service=t.service,!t.url||"string"!=typeof t.url)throw new Error("invalid url for layer "+this.#name);if(this.#url=t.url,"wms"===this.#service){if(!(t.wmsOptions&&t.wmsOptions.layers&&"string"==typeof t.wmsOptions.layers&&t.wmsOptions.format&&"string"==typeof t.wmsOptions.format&&t.wmsOptions.transparent&&"boolean"==typeof t.wmsOptions.transparent))throw new Error("invalid wmsOptions for layer "+this.#name);this.#wmsOptions=t.wmsOptions,this.#wmsOptions.layers=b.sanitizeToJsString(this.#wmsOptions.layers),this.#wmsOptions.format=b.sanitizeToJsString(this.#wmsOptions.format)}try{t.bounds&&"number"==typeof t.bounds[0][0]&&"number"==typeof t.bounds[0][1]&&"number"==typeof t.bounds[1][0]&&"number"==typeof t.bounds[1][1]&&(this.#bounds=t.bounds)}catch(t){throw new Error("invalid bounds for layer "+this.#name)}if(t.minZoom&&"number"==typeof t.minZoom&&(this.#minZoom=t.minZoom),t.maxZoom&&"number"==typeof t.maxZoom&&(this.#maxZoom=t.maxZoom),!(t.toolbar&&t.toolbar.text&&"string"==typeof t.toolbar.text&&t.toolbar.color&&"string"==typeof t.toolbar.color&&t.toolbar.backgroundColor&&"string"==typeof t.toolbar.backgroundColor))throw new Error("invalid toolbar for layer "+this.#name);if(this.#toolbar=t.toolbar,this.#toolbar.text=b.sanitizeToJsString(this.#toolbar.text),this.#toolbar.color=b.sanitizeToColor(this.#toolbar.color)||"#000000",this.#toolbar.backgroundColor=b.sanitizeToColor(this.#toolbar.backgroundColor)||"#ffffff",!t.providerName||"string"!=typeof t.providerName)throw new Error("invalid providerName for layer "+this.#name);if(this.#providerName=b.sanitizeToJsString(t.providerName),"boolean"!=typeof t.providerKeyNeeded)throw new Error("invalid providerKeyNeeded for layer "+this.#name);if(this.#providerKeyNeeded=t.providerKeyNeeded,""===t.attribution)this.#attribution="";else{if(!t.attribution||"string"!=typeof t.attribution)throw new Error("invalid attribution for map layer "+this.#name);this.#attribution=b.sanitizeToHtmlString(t.attribution).htmlString}if(t.getCapabilitiesUrl&&"string"==typeof t.getCapabilitiesUrl&&(this.#getCapabilitiesUrl=b.sanitizeToUrl(t.getCapabilitiesUrl).url,""===this.#getCapabilitiesUrl))throw new Error("invalid getCapabilitiesUrl for map layer "+this.#name);Object.freeze(this)}get name(){return this.#name}get service(){return this.#service}get url(){return this.#url}get wmsOptions(){return this.#wmsOptions}get bounds(){return this.#bounds}get minZoom(){return this.#minZoom}get maxZoom(){return this.#maxZoom}get toolbar(){return this.#toolbar}get providerName(){return this.#providerName}get providerKeyNeeded(){return this.#providerKeyNeeded}get attribution(){return this.#attribution}get getCapabilitiesUrl(){return this.#getCapabilitiesUrl}}const to=new class{#mapLayers=new Map;#defaultMapLayer=null;#mapLayersAdded=!1;constructor(){this.#defaultMapLayer=new Qe({service:"wmts",url:"https://{s}.tile.osm.org/{z}/{x}/{y}.png",name:"OSM - Color",toolbar:{text:"OSM",color:"#ff0000",backgroundColor:"#ffffff"},providerName:"OSM",providerKeyNeeded:!1,attribution:""}),this.#mapLayers.set(this.#defaultMapLayer.name,this.#defaultMapLayer),Object.freeze(this)}getMapLayer(t){let e=this.#mapLayers.get(t)||this.#defaultMapLayer;return e.providerKeyNeeded&&(Me.hasKey(e.providerName.toLowerCase())||(e=this.#defaultMapLayer)),e}forEach(t){this.#mapLayers.forEach(t)}addMapLayers(t){this.#mapLayersAdded||(t.forEach((t=>{let e=new Qe(t);this.#mapLayers.get(e.name)||this.#mapLayers.set(e.name,e)})),this.#mapLayersAdded=!0)}get defaultMapLayer(){return this.#defaultMapLayer}};class eo{handleEvent(){window.print()}}class oo{#printPageBuilder=null;constructor(t){this.#printPageBuilder=t}handleEvent(){this.#printPageBuilder.onAfterPrint(),this.#printPageBuilder=null}}class io{#printData=null;#route=null;#views=[];#printToolbar=null;#printButton=null;#cancelButton=null;#viewsCounter=0;#viewsDiv=[];#routePolyline=null;#eventsListeners={onPrint:null,onAfterPrint:null};onAfterPrint(){this.#viewsDiv.forEach((t=>document.body.removeChild(t))),this.#viewsDiv.length=0,this.#printButton.removeEventListener("click",this.#eventsListeners.onPrint,!1),this.#cancelButton.removeEventListener("click",this.#eventsListeners.onAfterPrint,!1),document.body.removeChild(this.#printToolbar);let t=document.body.children;for(let e=0;e<t.length;e++)t.item(e).classList.remove("TravelNotes-Hidden");z.map.invalidateSize(!1),document.title="Travel & Notes"+(""===z.travel.name?"":" - "+z.travel.name),window.removeEventListener("afterprint",this.#eventsListeners.onAfterPrint,!0),this.#eventsListeners.onAfterPrint=null,this.#eventsListeners.onPrint=null}#getMapLayer(){let t=to.getMapLayer(z.travel.layerName),e=Me.getUrl(t),o=null;return o="wmts"===t.service.toLowerCase()?window.L.tileLayer(e):window.L.tileLayer.wms(e,t.wmsOptions),o.options.attribution=b.sanitizeToHtmlString(' © <a href="https://www.openstreetmap.org/copyright" target="_blank" title="OpenStreetMap contributors">OpenStreetMap contributors</a> '+t.attribution+'| © <a href="https://github.com/wwwouaiebe" target="_blank" title="https://github.com/wwwouaiebe">Travel & Notes</a> ').htmlString,o}#getNotesMarkers(){let t=[];return this.#route.notes.forEach((e=>{let o=window.L.divIcon({iconSize:[e.iconWidth,e.iconHeight],iconAnchor:[e.iconWidth/2,e.iconHeight/2],popupAnchor:[0,-e.iconHeight/2],html:e.iconContent,className:"TravelNotes-Map-AllNotes "}),i=window.L.marker(e.iconLatLng,{zIndexOffset:100,icon:o,draggable:!0});t.push(i)})),t}#createViewOnPage(e){this.#viewsCounter++;let o="TravelNotes-RouteViewDiv"+this.#viewsCounter,i=document.createElement("div");i.className="TravelNotes-routeViewDiv",i.id=o,document.body.appendChild(i),this.#viewsDiv.push(i),this.#printData.pageBreak&&i.classList.add("TravelNotes-PrintPageBreak"),i.style.width=String(this.#printData.paperWidth)+"mm",i.style.height=String(this.#printData.paperHeight)+"mm";let n=this.#printData.printNotes?this.#getNotesMarkers():[];n.push(this.#getMapLayer()),n.push(window.L.circleMarker([e.entryPoint.lat,e.entryPoint.lng],t.printRouteMap.entryPointMarker)),n.push(window.L.circleMarker([e.exitPoint.lat,e.exitPoint.lng],t.printRouteMap.exitPointMarker)),n.push(this.#routePolyline),window.L.map(o,{attributionControl:!0,zoomControl:!1,center:[(e.bottomLeft.lat+e.upperRight.lat)/2,(e.bottomLeft.lng+e.upperRight.lng)/2],zoom:this.#printData.zoomFactor,minZoom:this.#printData.zoomFactor,maxZoom:this.#printData.zoomFactor,layers:n})}#createToolbar(){this.#printToolbar=J.create("div",{id:"TravelNotes-PrintToolbar"},document.body),this.#printButton=J.create("div",{className:"TravelNotes-UI-Button",title:N.getText("PrintPageBuilder - Print"),textContent:"🖨️"},this.#printToolbar),this.#printButton.addEventListener("click",this.#eventsListeners.onPrint,!1),this.#cancelButton=J.create("div",{className:"TravelNotes-UI-Button",title:N.getText("PrintPageBuilder - Cancel print"),textContent:"❌"},this.#printToolbar),this.#cancelButton.addEventListener("click",this.#eventsListeners.onAfterPrint,!1)}constructor(t,e,o){this.#route=t,this.#views=e,this.#printData=o,this.#eventsListeners.onPrint=new eo,this.#eventsListeners.onAfterPrint=new oo(this),Object.freeze(this)}preparePage(){let t=document.body.children;for(let e=0;e<t.length;e++)t.item(e).classList.add("TravelNotes-Hidden");document.title=""===z.travel.name?"maps":z.travel.name+" - "+this.#route.computedName+" - maps",this.#createToolbar(),window.addEventListener("afterprint",this.#eventsListeners.onAfterPrint,!0);let e=[],o=this.#route.itinerary.itineraryPoints.iterator;for(;!o.done;)e.push(o.value.latLng);this.#routePolyline=window.L.polyline(e,{color:this.#route.color,weight:this.#route.width}),this.#viewsCounter=0,this.#views.forEach((t=>this.#createViewOnPage(t)))}}class no{#tilesPerPage=0;#computeViewSize(t){let e=J.create("div",{},document.body);e.style.position="absolute",e.style.top="0",e.style.left="0",e.style.width=String(t.paperWidth-2*t.borderWidth)+"mm",e.style.height=String(t.paperHeight-2*t.borderWidth)+"mm",this.#tilesPerPage=Math.ceil(e.clientWidth/256)*Math.ceil(e.clientHeight/256);let o=G.screenCoordToLatLng(0,0),i=G.screenCoordToLatLng(e.clientWidth,e.clientHeight);document.body.removeChild(e);let n=z.map.getZoomScale(z.map.getZoom(),t.zoomFactor);return[Math.abs(o[0]-i[0])*n,Math.abs(o[1]-i[1])*n]}constructor(){Object.freeze(this)}print(e,o){let i=Z.getRoute(o);if(!i)return;let n=new $e(i,this.#computeViewSize(e));t.printRouteMap.maxTiles<n.views.length*this.#tilesPerPage?ue.showError(N.getText("RoutePrinter - The maximum of allowed pages is reached.")):new io(i,n.views,e).preparePage()}}const so=new class{constructor(){Object.freeze(this)}addRoute(){let t=new B;z.travel.routes.add(t),a.editedChanged===z.travel.editedRoute.editionStatus?(this.chainRoutes(),V.dispatch("setrouteslist"),V.dispatch("roadbookupdate")):this.editRoute(t.objId)}editRoute(t){let e=Z.getRoute(t),o=e.itinerary.provider,i=z.providers.get(o.toLowerCase());if(o&&""!==o&&(!i||i.providerKeyNeeded&&!Me.hasKey(o)))return void ue.showError(N.getText("RouteEditor - Not possible to edit a route created with this provider",{provider:o}));c!==z.editedRouteObjId&&this.cancelEdition(),o&&""!==o&&V.dispatch("setprovider",{provider:o});let n=e.itinerary.transitMode;n&&""!==n&&V.dispatch("settransitmode",{transitMode:n}),z.travel.editedRoute=new B,e.editionStatus=a.editedNoChange,z.travel.editedRoute.jsonObject=e.jsonObject,z.editedRouteObjId=e.objId,z.travel.editedRoute.hidden=!1,e.hidden=!1,Je.updateProfile(z.editedRouteObjId,z.travel.editedRoute),this.chainRoutes(),V.dispatch("routeupdated",{removedRouteObjId:e.objId,addedRouteObjId:z.travel.editedRoute.objId}),V.dispatch("roadbookupdate"),V.dispatch("showitinerary"),V.dispatch("setrouteslist")}removeRoute(t){let e=t;e!==z.editedRouteObjId&&e!==z.travel.editedRoute.objId||(e=z.editedRouteObjId,this.cancelEdition()),V.dispatch("routeupdated",{removedRouteObjId:e,addedRouteObjId:c}),z.travel.routes.remove(e),Je.deleteProfile(e),this.chainRoutes(),V.dispatch("roadbookupdate"),V.dispatch("setrouteslist")}saveGpx(t){(new Se).routeToGpx(t)}chainRoutes(){let t=z.travel.routes.iterator,e=o.defaultValue;for(;!t.done;){t.value.chain?(t.value.chainedDistance=e,e+=t.value.distance):t.value.chainedDistance=o.defaultValue;let i=t.value.notes.iterator;for(;!i.done;)i.value.chainedDistance=t.value.chainedDistance}}saveEdition(){let t=new B;t.jsonObject=z.travel.editedRoute.jsonObject,z.travel.routes.replace(z.editedRouteObjId,t),z.editedRouteObjId=t.objId,this.cancelEdition()}cancelEdition(){let t=Z.getRoute(z.editedRouteObjId);t.editionStatus=a.notEdited,Je.updateProfile(z.travel.editedRoute.objId,t),V.dispatch("routeupdated",{removedRouteObjId:z.travel.editedRoute.objId,addedRouteObjId:z.editedRouteObjId}),z.editedRouteObjId=c,z.travel.editedRoute=new B,this.chainRoutes(),V.dispatch("roadbookupdate"),V.dispatch("setrouteslist"),V.dispatch("showitinerary")}routeProperties(t){let e=Z.getRoute(t);new Fe(e).show().then((()=>{this.chainRoutes(),e.haveValidWayPoints()&&V.dispatch("routepropertiesupdated",{routeObjId:e.objId}),V.dispatch("roadbookupdate"),V.dispatch("setrouteslist"),V.dispatch("updateitinerary")})).catch((t=>{t instanceof Error&&console.error(t)}))}printRouteMap(t){(new ze).show().then((e=>(new no).print(e,t))).catch((t=>{t instanceof Error&&console.error(t)}))}showRoute(t){Z.getRoute(t).hidden=!1,V.dispatch("routeupdated",{removedRouteObjId:c,addedRouteObjId:t}),V.dispatch("setrouteslist")}hideRoute(t){Z.getRoute(t).hidden=!0,V.dispatch("routeupdated",{removedRouteObjId:t,addedRouteObjId:c}),V.dispatch("setrouteslist")}showRoutes(){let t=z.travel.routes.iterator;for(;!t.done;)t.value.hidden&&(t.value.hidden=!1,V.dispatch("routeupdated",{removedRouteObjId:c,addedRouteObjId:t.value.objId}));V.dispatch("setrouteslist")}hideRoutes(){let t=z.travel.routes.iterator;for(;!t.done;)t.value.hidden||t.value.objId===z.editedRouteObjId||(t.value.hidden=!0,V.dispatch("routeupdated",{removedRouteObjId:t.value.objId,addedRouteObjId:c}));V.dispatch("setrouteslist")}};class ao extends Rt{#wayPoint=null;#addressInput=null;#resetAddressButton=null;#nameInput=null;async handleEvent(e){if(e.stopPropagation(),!t.wayPoint.reverseGeocoding)return;this.showWait();let o=new Jt,i=await o.getAddressAsync(this.#wayPoint.latLng);if(this.hideWait(),i.statusOk){t.wayPoint.geocodingIncludeName&&(this.#nameInput.value=i.name);let e=i.street;""!==i.city&&(e+=" "+i.city),this.#addressInput.value=e}}#createAddressControl(){let t=J.create("div");this.#resetAddressButton=J.create("div",{className:"TravelNotes-BaseDialog-Button",title:N.getText("WayPointPropertiesDialog - Reset address"),textContent:"🔄"},t),this.#resetAddressButton.addEventListener("click",this,!1),J.create("text",{value:N.getText("WayPointPropertiesDialog - Address")},t);let e=J.create("div");return this.#addressInput=J.create("input",{type:"text",value:this.#wayPoint.address,className:"TravelNotes-WayPointPropertiesDialog-Input"},e),[t,e]}#createNameControl(){let t=J.create("div",{textContent:N.getText("WayPointPropertiesDialog - Name")}),e=J.create("div");return this.#nameInput=J.create("input",{type:"text",value:this.#wayPoint.name,className:"TravelNotes-WayPointPropertiesDialog-Input"},e),[t,e]}constructor(t){super(),this.#wayPoint=t}onCancel(){this.#resetAddressButton.removeEventListener("click",this,!1),super.onCancel()}onOk(){this.#wayPoint.address=this.#addressInput.value,this.#wayPoint.name=this.#nameInput.value,this.#resetAddressButton.removeEventListener("click",this,!1),super.onOk()}get contentHTMLElements(){return[].concat(this.#createNameControl(),this.#createAddressControl())}get title(){return N.getText("WayPointPropertiesDialog - Waypoint properties")}}const ro=new class{#routingRequestStarted=!1;#zoomToRouteAfterRouting=!1;#computeRouteDistances(t){let e=t.itinerary.itineraryPoints.iterator,i=t.itinerary.maneuvers.iterator;for(e.done,i.done,i.value.distance=o.defaultValue,i.done,t.distance=o.defaultValue,t.duration=o.defaultValue;!e.done;)e.previous.distance=X.pointsDistance(e.previous.latLng,e.value.latLng),t.distance+=e.previous.distance,i.previous.distance+=e.previous.distance,i.value.itineraryPointObjId===e.value.objId&&(t.duration+=i.previous.duration,i.value.distance=o.defaultValue,i.next&&i.value.itineraryPointObjId===i.next.itineraryPointObjId&&(i.done,i.value.distance=o.defaultValue),i.done)}#onRoutingError(t){this.#routingRequestStarted=!1,ue.showError(t),t instanceof Error&&console.error(t)}#onRoutingOk(){this.#routingRequestStarted=!1,z.travel.editedRoute.itinerary.validateData();let t=z.travel.editedRoute.itinerary.maneuvers.iterator;for(;!t.done;)t.value.validateData();let e=z.travel.editedRoute.itinerary.itineraryPoints.iterator;for(;!e.done;)e.value.validateData();if(this.#computeRouteDistances(z.travel.editedRoute),"circle"!==z.travel.editedRoute.itinerary.transitMode){let t=z.travel.editedRoute.wayPoints.iterator;for(;!t.done;)t.first?t.value.latLng=z.travel.editedRoute.itinerary.itineraryPoints.first.latLng:t.last?t.value.latLng=z.travel.editedRoute.itinerary.itineraryPoints.last.latLng:t.value.latLng=G.getClosestLatLngDistance(z.travel.editedRoute,t.value.latLng).latLng}let o=z.travel.editedRoute.notes.iterator;for(;!o.done;){let t=G.getClosestLatLngDistance(z.travel.editedRoute,o.value.latLng);o.value.latLng=t.latLng,o.value.distance=t.distance}so.chainRoutes(),z.travel.editedRoute.notes.sort(((t,e)=>t.distance-e.distance)),this.#zoomToRouteAfterRouting&&(new Y).zoomToRoute(z.travel.editedRoute.objId),Je.createProfile(z.travel.editedRoute),V.dispatch("routeupdated",{removedRouteObjId:z.travel.editedRoute.objId,addedRouteObjId:z.travel.editedRoute.objId}),V.dispatch("roadbookupdate"),V.dispatch("showitinerary"),V.dispatch("setrouteslist")}constructor(){Object.freeze(this)}startRouting(){if(!this.#routingRequestStarted&&z.travel.editedRoute.haveValidWayPoints()){this.#zoomToRouteAfterRouting=0===z.travel.editedRoute.itinerary.itineraryPoints.length,this.#routingRequestStarted=!0;let t=z.providers.get(z.routing.provider.toLowerCase());z.travel.editedRoute.itinerary.provider=t.name,z.travel.editedRoute.itinerary.transitMode=z.routing.transitMode,t.getPromiseRoute(z.travel.editedRoute).then((()=>this.#onRoutingOk())).catch((()=>this.#onRoutingError()))}}};new class{#renameWayPoint(t,e){let o=z.travel.editedRoute.wayPoints.getAt(e);o?(z.travel.editedRoute.editionStatus=a.editedChanged,o.name=t.name,o.address=t.address,V.dispatch("setrouteslist"),V.dispatch("showitinerary"),V.dispatch("roadbookupdate")):console.error("waypoint not found")}async#renameWayPointWithGeocoder(e,o){if(!t.wayPoint.reverseGeocoding)return V.dispatch("setrouteslist"),V.dispatch("showitinerary"),void V.dispatch("roadbookupdate");let i=await(new Jt).getAddressAsync(e);if(i.statusOk){let e=i.street;""!==i.city&&(e+=" "+i.city);let n="";t.wayPoint.geocodingIncludeName&&(n=i.name),this.#renameWayPoint(Object.seal({name:n,address:e}),o)}}constructor(){Object.freeze(this)}addWayPoint(t){z.travel.editedRoute.editionStatus=a.editedChanged;let e=new C;e.latLng=t,z.travel.editedRoute.wayPoints.add(e),this.#renameWayPointWithGeocoder(t,e.objId),V.dispatch("addwaypoint",{wayPoint:z.travel.editedRoute.wayPoints.last,letter:z.travel.editedRoute.wayPoints.length-2}),z.travel.editedRoute.wayPoints.swap(e.objId,!0),ro.startRouting()}addWayPointOnRoute(t,e){let o=G.getClosestLatLngDistance(z.travel.editedRoute,t).distance;z.travel.editedRoute.editionStatus=a.editedChanged;let i=new C;i.latLng=e;let n="",s=z.travel.editedRoute.wayPoints.iterator;for(;!s.done;){if(o<G.getClosestLatLngDistance(z.travel.editedRoute,s.value.latLng).distance){n=String(s.index),z.travel.editedRoute.wayPoints.add(i),z.travel.editedRoute.wayPoints.moveTo(i.objId,s.value.objId,!0),this.#renameWayPointWithGeocoder(e,i.objId),V.dispatch("addwaypoint",{wayPoint:i,letter:n}),ro.startRouting();break}}}reverseWayPoints(){z.travel.editedRoute.editionStatus=a.editedChanged;let t=z.travel.editedRoute.wayPoints.iterator;for(;!t.done;)V.dispatch("removeobject",{objId:t.value.objId});for(z.travel.editedRoute.wayPoints.reverse(),t=z.travel.editedRoute.wayPoints.iterator;!t.done;)V.dispatch("addwaypoint",{wayPoint:t.value,letter:t.first?"A":t.last?"B":t.index});V.dispatch("setrouteslist"),V.dispatch("showitinerary"),V.dispatch("roadbookupdate"),ro.startRouting()}removeWayPoint(t){z.travel.editedRoute.editionStatus=a.editedChanged,V.dispatch("removeobject",{objId:t}),z.travel.editedRoute.wayPoints.remove(t),ro.startRouting()}setStartPoint(t){z.travel.editedRoute.editionStatus=a.editedChanged,s.defaultValue!==z.travel.editedRoute.wayPoints.first.lat&&V.dispatch("removeobject",{objId:z.travel.editedRoute.wayPoints.first.objId}),z.travel.editedRoute.wayPoints.first.latLng=t,this.#renameWayPointWithGeocoder(t,z.travel.editedRoute.wayPoints.first.objId),V.dispatch("addwaypoint",{wayPoint:z.travel.editedRoute.wayPoints.first,letter:"A"}),ro.startRouting()}setEndPoint(t){z.travel.editedRoute.editionStatus=a.editedChanged,s.defaultValue!==z.travel.editedRoute.wayPoints.last.lat&&V.dispatch("removeobject",{objId:z.travel.editedRoute.wayPoints.last.objId}),z.travel.editedRoute.wayPoints.last.latLng=t,this.#renameWayPointWithGeocoder(t,z.travel.editedRoute.wayPoints.last.objId),V.dispatch("addwaypoint",{wayPoint:z.travel.editedRoute.wayPoints.last,letter:"B"}),ro.startRouting()}wayPointDragEnd(t){z.travel.editedRoute.editionStatus=a.editedChanged,this.#renameWayPointWithGeocoder(z.travel.editedRoute.wayPoints.getAt(t).latLng,t),ro.startRouting()}wayPointProperties(t){let e=z.travel.editedRoute.wayPoints.getAt(t);new ao(e).show().then((()=>{V.dispatch("setrouteslist"),V.dispatch("showitinerary"),V.dispatch("roadbookupdate")})).catch((t=>{t instanceof Error&&console.error(t)}))}};class lo{static handleEvent(t){let e=Z.getRoute(t.target.objId),o=G.getClosestLatLngDistance(e,[t.latlng.lat,t.latlng.lng]).distance;o+=e.chainedDistance,o=E.formatDistance(o);let i=z.mapObjects.get(t.target.objId);i.closeTooltip();let n=e.computedName;z.travel.readOnly||(n+=0===n.length?"":" - ",n+=o),i.setTooltipContent(n),i.openTooltip(t.latlng)}}class ho{#currentLayer=null;#geolocationCircle=null;#getDashArray(e){e.dashArray>=t.route.dashChoices.length&&(e.dashArray=0);let o=t.route.dashChoices[e.dashArray].iDashArray;if(o){let t="",i=0;for(i=0;i<o.length-1;i++)t+=o[i]*e.width+",";return t+=o[i]*e.width,t}return null}#addNote(e){let o=Z.getNoteAndRoute(e).note,i=window.L.marker(o.latLng,{icon:window.L.divIcon({iconSize:[t.note.grip.size,t.note.grip.size],iconAnchor:[t.note.grip.size/2,t.note.grip.size/2],html:"<div></div>",className:"TravelNotes-Map-Note-Bullet"}),opacity:t.note.grip.opacity,draggable:!z.travel.readOnly});i.objId=o.objId;let n=window.L.divIcon({iconSize:[o.iconWidth,o.iconHeight],iconAnchor:[o.iconWidth/2,o.iconHeight/2],popupAnchor:[0,-o.iconHeight/2],html:o.iconContent,className:"TravelNotes-Map-AllNotes "}),s=window.L.marker(o.iconLatLng,{zIndexOffset:100,icon:n,draggable:!z.travel.readOnly});s.objId=o.objId,s.bindPopup((t=>b.clone(ut.getNoteTextHTML("TravelNotes-Map-",Z.getNoteAndRoute(t.objId))))),0!==o.tooltipContent.length&&(s.bindTooltip((t=>Z.getNoteAndRoute(t.objId).note.tooltipContent)),s.getTooltip().options.offset[0]=o.iconWidth/2);let a=window.L.polyline([o.latLng,o.iconLatLng],t.note.polyline);a.objId=o.objId;let r=window.L.layerGroup([s,a,i]);return r.markerId=window.L.Util.stamp(s),r.polylineId=window.L.Util.stamp(a),r.bulletId=window.L.Util.stamp(i),this.addToMap(o.objId,r),t.note.haveBackground&&document.querySelectorAll(".TravelNotes-MapNote,.TravelNotes-SvgIcon").forEach((t=>t.classList.add("TravelNotes-Map-Note-Background"))),Object.freeze({marker:s,polyline:a,bullet:i})}constructor(){Object.freeze(this)}addToMap(t,e){e.objId=t,e.addTo(z.map),z.mapObjects.set(t,e)}addRoute(t){let e=Z.getRoute(t),o=[],i=e.itinerary.itineraryPoints.iterator;for(;!i.done;)o.push(i.value.latLng);let n=window.L.polyline(o,{color:e.color,weight:e.width,dashArray:this.#getDashArray(e)});this.addToMap(e.objId,n),a.notEdited===e.editionStatus&&(n.bindTooltip(e.computedName,{sticky:!0,direction:"right"}),window.L.DomEvent.on(n,"mouseover",lo.handleEvent),window.L.DomEvent.on(n,"mousemove",lo.handleEvent)),n.bindPopup((t=>b.clone(pt.getRouteHeaderHTML("TravelNotes-Map-",Z.getRoute(t.objId))))),window.L.DomEvent.on(n,"click",(t=>t.target.openPopup(t.latlng)));let s=e.notes.iterator;for(;!s.done;)this.#addNote(s.value.objId);return e}addNote(t){return this.#addNote(t)}getDashArray(t){return this.#getDashArray(t)}zoomTo(e,o){if(o){let t=[];o.forEach((e=>t=t.concat(e))),z.map.fitBounds(G.getLatLngBounds(t))}else z.map.setView(e,t.itineraryPoint.zoomFactor)}setLayer(t,e){let o=null;o="wmts"===t.service.toLowerCase()?window.L.tileLayer(e):window.L.tileLayer.wms(e,t.wmsOptions),this.#currentLayer&&z.map.removeLayer(this.#currentLayer),z.map.addLayer(o),this.#currentLayer=o,z.travel.readOnly||(z.map.getZoom()<(t.minZoom||0)&&z.map.setZoom(t.minZoom||0),z.map.setMinZoom(t.minZoom||0),z.map.getZoom()>(t.maxZoom||18)&&z.map.setZoom(t.maxZoom||18),z.map.setMaxZoom(t.maxZoom||18),t.bounds?(z.map.getBounds().intersects(t.bounds)&&!z.map.getBounds().contains(t.bounds)||(z.map.setMaxBounds(null),z.map.fitBounds(t.bounds),z.map.setZoom(t.minZoom||0)),z.map.setMaxBounds(t.bounds)):z.map.setMaxBounds(null)),z.map.fire("baselayerchange",o)}onGeolocationStatusChanged(t){i.active!==t&&this.#geolocationCircle&&(z.map.removeLayer(this.#geolocationCircle),this.#geolocationCircle=null)}onGeolocationPositionChanged(e){let o=t.geoLocation.zoomToPosition;this.#geolocationCircle&&(z.map.removeLayer(this.#geolocationCircle),o=!1),this.#geolocationCircle=window.L.circleMarker(window.L.latLng(e.coords.latitude,e.coords.longitude),t.geoLocation.marker).bindTooltip(E.formatLatLng([e.coords.latitude,e.coords.longitude])).addTo(z.map),o&&z.map.setView(window.L.latLng(e.coords.latitude,e.coords.longitude),t.geoLocation.zoomFactor)}}class co{constructor(){Object.freeze(this)}handleEvent(t){if(t.stopPropagation(),"Z"===t.key||"z"===t.key)(new Y).zoomToTravel();else if("G"===t.key||"g"===t.key)$.switch();else{let e=t.key.charCodeAt(0);47<e&&58>e&&ot.setMapLayer(t.key)}}}class uo{#travelUrl=null;#language=null;#addLayerToolbar=!1;#originAndPath=window.location.href.substr(0,window.location.href.lastIndexOf("/")+1)+"TravelNotes";static#mapEditorViewer=new ho;#addEventsListeners(){document.addEventListener("keydown",new co,!0),document.addEventListener("routeupdated",(t=>{t.data&&uo.#mapEditorViewer.addRoute(t.data.addedRouteObjId)}),!1),document.addEventListener("noteupdated",(t=>{t.data&&uo.#mapEditorViewer.addNote(t.data.addedNoteObjId)}),!1),document.addEventListener("zoomto",(t=>{t.data&&uo.#mapEditorViewer.zoomTo(t.data.latLng,t.data.geometry)}),!1),document.addEventListener("layerchange",(t=>{t.data&&uo.#mapEditorViewer.setLayer(t.data.layer,t.data.layer.url)})),document.addEventListener("geolocationpositionchanged",(t=>{t.data&&uo.#mapEditorViewer.onGeolocationPositionChanged(t.data.position)}),!1),document.addEventListener("geolocationstatuschanged",(t=>{t.data&&uo.#mapEditorViewer.onGeolocationStatusChanged(t.data.status)}),!1)}#readURL(){let t=new URL(window.location),e=t.searchParams.get("fil");if(e&&0!==e.length)try{if(e=atob(e),e.match(/[^\w-%:./]/))throw new Error("invalid char in the url encoded in the fil parameter");let o=new URL(e);if(!(t.protocol&&o.protocol&&t.protocol===o.protocol&&t.hostname&&o.hostname&&t.hostname===o.hostname))throw new Error("The distant file is not on the same site than the app");this.#travelUrl=encodeURI(o.href)}catch(t){t instanceof Error&&console.error(t)}let o=t.searchParams.get("lng");o&&o.match(/^[A-Z,a-z]{2}$/)&&(this.#language=o.toLowerCase()),""===t.searchParams.get("lay")&&(this.#addLayerToolbar=!0)}async#loadConfig(){let t=await fetch(this.#originAndPath+"Config.json");if(g===t.status&&t.ok){let e=await t.json();return e.travelNotes.language=this.#language||e.travelNotes.language,"wwwouaiebe.github.io"===window.location.hostname&&(e.note.haveBackground=!0),(new f).overload(e),!0}return!1}async#loadTranslations(){let t=await fetch(this.#originAndPath+this.#language.toUpperCase()+".json");return!(g!==t.status||!t.ok)&&(N.setTranslations(await t.json()),!0)}async#loadMapLayers(){let t=await fetch(this.#originAndPath+"Layers.json");return!(g!==t.status||!t.ok)&&(ot.addMapLayers(await t.json()),!0)}#loadTravelNotesViewer(){let t=document.createElement("div");t.id="TravelNotes-Map",document.body.appendChild(t),z.map=window.L.map("TravelNotes-Map",{attributionControl:!1,zoomControl:!1}),z.map.setView([s.defaultValue,s.defaultValue],2),it.addReadOnlyMap(this.#travelUrl,this.#addLayerToolbar)}constructor(){Object.freeze(this)}async loadApp(){this.#readURL(),await this.#loadConfig()?(this.#language=this.#language||t.travelNotes.language,await this.#loadTranslations()?await this.#loadMapLayers()?(this.#addEventsListeners(),this.#loadTravelNotesViewer()):document.body.textContent="Not possible to load the TravelNotesLayers.json file. ":document.body.textContent="Not possible to load the TravelNotesConfig"+this.#language.toUpperCase()+".json file. "):document.body.textContent="Not possible to load the TravelNotesConfig.json file. "}}(new uo).loadApp()}();