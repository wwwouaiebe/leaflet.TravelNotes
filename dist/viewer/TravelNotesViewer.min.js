 ...
 * Build 00579 - 2021-01-04T21:06:48+0100 
...
/**
	...
	@------------------------------------------------------------------------------------------------------------------------------
	*/const e=Object.freeze({fixed:2,invalid:-1,defaultValue:0}),t=Object.freeze({refusedByUser:-1,disabled:0,inactive:1,active:2}),o=(Object.freeze({invalidPane:"43a6a53e-008a-4910-80a6-7a87d301ea15",itineraryPane:"8fbf0da7-4e6f-4bc7-8e20-1388461ccde7",travelNotesPane:"dffe782b-07df-4b81-a318-f287c0cf5ec6",searchPane:"228f00d7-43a8-4c13-897d-70400cb6dd58"}),Object.freeze({fixed:2,defaultValue:0})),a=Object.freeze({defaultValue:0,fixed:6}),n=Object.freeze({notEdited:0,editedNoChange:1,editedChanged:2}),r=Object.freeze({margin:100,height:500,width:1e3,yDeltaText:30,xDeltaText:10,vScales:[1,2,5,10,20,50,100,200,500,1e3,2e3,5e3],hScales:[1,2,5,10,20,50,100,200,500,1e3,2e3,5e3,1e4,2e4,5e4,1e5]}),i=(Object.freeze({width:40,height:40}),"http://www.w3.org/2000/svg");let s=new Map;s.set("a",["href","target"]),s.set("br",[]),s.set("div",[]),s.set("del",[]),s.set("em",[]),s.set("figcaption",[]),s.set("figure",[]),s.set("h1",[]),s.set("h2",[]),s.set("h3",[]),s.set("h4",[]),s.set("h5",[]),s.set("h6",[]),s.set("hr",[]),s.set("img",["src","alt"]),s.set("ins",[]),s.set("li",[]),s.set("mark",[]),s.set("ol",[]),s.set("p",[]),s.set("s",[]),s.set("small",[]),s.set("strong",[]),s.set("span",[]),s.set("sub",[]),s.set("sup",[]),s.set("ul",[]),s.set("svg",["xmlns","viewBox","class"]),s.set("text",["x","y","text-anchor"]),s.set("polyline",["points","class","transform"]);const l=window.location.protocol,c=new DOMParser;function d(e){return e.replaceAll(/</g,"&lt;").replaceAll(/>/g,"&gt;").replaceAll(/"/g,"&quot;").replaceAll(/\u0027/g,"&apos;").replaceAll(/\u0a00/g,"&nbsp;")}function u(e){return e.replaceAll(/&lt;/g,"<").replaceAll(/&gt;/g,">").replaceAll(/&amp;/g,"&").replaceAll(/&quot;/g,'"').replaceAll(/&apos;/g,"'").replaceAll(/&nbsp;/g,"਀")}function h(e,t="href"){let o=c.parseFromString("<div>"+u(e)+"</div>","text/html").querySelector("body").firstChild,a="";for(let e=0;e<o.childNodes.length;e++)"#text"===o.childNodes[e].nodeName&&(a+=o.childNodes[e].nodeValue);if(a!==e)return{url:"",errorsString:"tags found in the url"};let n=["https:"];if("http:"!==l&&"href"!==t||n.push("http:"),"href"===t){n.push("mailto:");let e=a.match(/^#\w*/);if(e&&a===e[0])return{url:a,errorsString:""}}let r=null;try{r=new URL(a)}catch(e){return{url:"",errorsString:"Invalid url string"}}if(-1===n.indexOf(r.protocol))return{url:"",errorsString:"Invalid protocol "+r.protocol};try{encodeURIComponent(r.href)}catch(e){return{url:"",errorsString:"Invalid character in url"}}return-1!==r.href.search(/[()\u0027*]/g)?{url:"",errorsString:"Invalid character in url"}:{url:r.href,errorsString:""}}const g=Object.freeze(new class{sanitizeToColor(e){let t=e.match(/^#[0-9,A-F,a-f]{6}$/);return t?t[0]:null}sanitizeToUrl(e){return h(e)}sanitizeToJsString(e){return function(e){let t=c.parseFromString("<div>"+u(e)+"</div>","text/html").querySelector("body").firstChild,o="";for(let e=0;e<t.childNodes.length;e++)"#text"===t.childNodes[e].nodeName&&(o+=t.childNodes[e].nodeValue);return o=o.replaceAll(/</g,"≺").replaceAll(/>/g,"≻").replaceAll(/"/g,"″").replaceAll(/\u0027/g,"′").replaceAll(/&lt;/g,"≺").replaceAll(/&gt;/g,"≻").replaceAll(/&quot;/g,"″").replaceAll(/&apos;/g,"′"),o}(e)}sanitizeToHtmlElement(e,t){!function(e,t){!function e(t,o){let a=t.childNodes;for(let n=0;n<a.length;n++){let a=t.childNodes[n],r=a.nodeName.toLowerCase(),l=s.get(r);if(l){l=l.concat(["id","class","dir","title"]);let t="svg"===r||"text"===r||"polyline"===r,n=t?document.createElementNS(i,r):document.createElement(r);l.forEach(e=>{if(t)a.hasAttributeNS(null,e)&&(n.setAttributeNS(null,e,a.getAttribute(e)),a.removeAttributeNS(null,e));else if(a.hasAttribute(e)){if("href"===e||"src"===e){let t=h(a.getAttribute(e),e).url;""!==t&&n.setAttribute(e,t)}else n.setAttribute(e,a.getAttribute(e));a.removeAttribute(e)}}),o.appendChild(n),e(a,n)}else"#text"===r&&o.appendChild(document.createTextNode(a.nodeValue))}}(c.parseFromString("<div>"+e+"</div>","text/html").querySelector("body").firstChild,t)}(e,t)}sanitizeToHtmlString(e){return function(e){let t="",o="";return function e(a){let n=a.childNodes;for(let r=0;r<n.length;r++){let n=a.childNodes[r],i=n.nodeName.toLowerCase(),l=s.get(i);if(l){l=l.concat(["id","class","dir","title"]);let a="svg"===i||"text"===i||"polyline"===i;t+="<"+i,l.forEach(e=>{if(a)n.hasAttributeNS(null,e)&&(t+=" "+e+'="'+d(n.getAttribute(e))+'"',n.removeAttribute(e));else if(n.hasAttribute(e))if("href"===e||"src"===e){let a=h(n.getAttribute(e),e).url;""===a?o+="\nAn invalid url ("+n.getAttribute(e)+") was removed from a "+e+" attribute":t+=" "+e+'="'+a+'"',n.removeAttribute(e)}else t+=" "+e+'="'+d(n.getAttribute(e))+'"',n.removeAttribute(e)}),t+=">",e(n),t+="</"+i+">"}else"#text"===i?t+=d(n.nodeValue):o+="\nAn invalid tag "+i+" was removed";if(n.hasAttributes)for(let e=0;e<n.attributes.length;e++)o+="\nAn unsecure attribute "+n.attributes[e].name+'="'+n.attributes[e].value+'" was removed.'}}(c.parseFromString("<div>"+e.replace("&nbsp;","਀")+"</div>","text/html").querySelector("body").firstChild),{htmlString:t,errorsString:o}}(e)}});let p={autoLoad:!1,map:{center:{lat:50.50923,lng:5.49542},zoom:12},travelNotesToolbarUI:{contactMail:{url:"https://github.com/wwwouaiebe/leaflet.TravelNotes/issues"}},layersToolbarUI:{haveLayersToolbarUI:!0,toolbarTimeOut:1500,theDevil:{addButton:!1}},mouseUI:{haveMouseUI:!0},errorUI:{timeOut:1e4,helpTimeOut:3e4,showError:!0,showWarning:!0,showInfo:!0,showHelp:!0},geoLocation:{color:"#ff0000",radius:11,zoomToPosition:!0,zoomFactor:17,options:{enableHighAccuracy:!1,maximumAge:0,timeout:1/0}},APIKeys:{showDialogButton:!0,saveToSessionStorage:!0,showAPIKeysInDialog:!0,dialogHaveUnsecureButtons:!0},contextMenu:{timeout:1500},routing:{auto:!0},language:"fr",itineraryPointMarker:{color:"#ff0000",weight:2,radius:7,fill:!1},searchPointMarker:{color:"#006400",weight:4,radius:20,fill:!1},searchPointPolyline:{color:"#006400",weight:4,radius:20,fill:!1},previousSearchLimit:{color:"#006400",fill:!1,weight:1},nextSearchLimit:{color:"#ff0000",fill:!1,weight:1},wayPoint:{reverseGeocoding:!1},route:{color:"#ff0000",width:3,dashArray:0,dashChoices:[{text:"——————",iDashArray:null},{text:"— — — — —",iDashArray:[4,2]},{text:"—‧—‧—‧—‧—",iDashArray:[4,2,0,2]},{text:"················",iDashArray:[0,2]}],elev:{smooth:!0,smoothCoefficient:.25,smoothPoints:3},showDragTooltip:3},note:{osmSearchNoteDialog:!1,reverseGeocoding:!1,grip:{size:10,opacity:0,moveOpacity:1},polyline:{color:"#808080",weight:1},haveBackground:!1,svgIconWidth:200,svgAnleMaxDirection:{right:35,slightRight:80,continue:100,slightLeft:145,left:200,sharpLeft:270,sharpRight:340},svgZoom:17,svgAngleDistance:10,svgHamletDistance:200,svgVillageDistance:400,svgCityDistance:1200,svgTownDistance:1500,svgTimeOut:40,maxManeuversNotes:100},itineraryPointZoom:17,routeEditor:{displayEditionInHTMLPage:!0},travelEditor:{clearAfterSave:!0,startMinimized:!0,timeout:1e3,startupRouteEdition:!0},haveBeforeUnloadWarning:!0,overpassApi:{url:"https://lz4.overpass-api.de/api/interpreter"},nominatim:{url:"https://nominatim.openstreetmap.org/",language:"*"},printRouteMap:{isEnabled:!0,maxTiles:240,paperWidth:287,paperHeight:200,pageBreak:!1,printNotes:!0,borderWidth:30,zoomFactor:15,entryPointMarker:{color:"#00ff00",weight:4,radius:10,fill:!0,fillOpacity:1},exitPointMarker:{color:"#ff0000",weight:4,radius:10,fill:!0,fillOpacity:1}},haveCrypto:!1,itineraryPane:{showNotes:!0,showManeuvers:!1},colorDialog:{haveSlider:!0,initialRed:0}};let m=new class{get autoLoad(){return p.autoLoad}get map(){return p.map}get travelNotesToolbarUI(){return p.travelNotesToolbarUI}get layersToolbarUI(){return p.layersToolbarUI}get mouseUI(){return p.mouseUI}get errorUI(){return p.errorUI}get APIKeys(){return p.APIKeys}get contextMenu(){return p.contextMenu}get routing(){return p.routing}get language(){return p.language}get itineraryPointMarker(){return p.itineraryPointMarker}get searchPointMarker(){return p.searchPointMarker}get searchPointPolyline(){return p.searchPointPolyline}get previousSearchLimit(){return p.previousSearchLimit}get nextSearchLimit(){return p.nextSearchLimit}get wayPoint(){return p.wayPoint}get route(){return p.route}get note(){return p.note}get itineraryPointZoom(){return p.itineraryPointZoom}get routeEditor(){return p.routeEditor}get travelEditor(){return p.travelEditor}get haveBeforeUnloadWarning(){return p.haveBeforeUnloadWarning}get overpassApi(){return p.overpassApi}get nominatim(){return p.nominatim}get geoLocation(){return p.geoLocation}get printRouteMap(){return p.printRouteMap}get haveCrypto(){return p.haveCrypto}get itineraryPane(){return p.itineraryPane}get colorDialog(){return p.colorDialog}overload(e){!function e(t,o){if("object"==typeof t&&"object"==typeof o)try{for(let a in o)"object"==typeof o[a]?e(t[a],o[a]):typeof t[a]==typeof o[a]&&("string"==typeof o[a]?o[a]="color"===a?g.sanitizeToColor(t[a])||o[a]:"url"===a?g.sanitizeToUrl(t[a]).url:g.sanitizeToJsString(t[a]):o[a]=t[a]||o[a]);for(let a in t)"object"==typeof t[a]?("[object Array]"===Object.prototype.toString.call(t[a])?o[a]=o[a]||[]:o[a]=o[a]||{},e(t[a],o[a])):"string"==typeof o.property?o[a]=g.sanitizeToHtmlString(t[a],[]).htmlString:o[a]=t[a]}catch(e){console.log(e||"Not possible to overload Config")}}(e,p),p=function e(t){for(let o in t)"object"==typeof t[o]&&(t[o]=e(t[o]));return Object.freeze(t)}(p)}};
/**
	@------------------------------------------------------------------------------------------------------------------------------
