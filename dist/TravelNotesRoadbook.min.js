 ...
 * Build 00923 - 2021-01-13T08:35:40+0100 
...
/**
	...
	@------------------------------------------------------------------------------------------------------------------------------
	*/Object.freeze({fixed:2,invalid:-1,defaultValue:0}),Object.freeze({refusedByUser:-1,disabled:0,inactive:1,active:2}),Object.freeze({invalidPane:"43a6a53e-008a-4910-80a6-7a87d301ea15",itineraryPane:"8fbf0da7-4e6f-4bc7-8e20-1388461ccde7",travelNotesPane:"dffe782b-07df-4b81-a318-f287c0cf5ec6",searchPane:"228f00d7-43a8-4c13-897d-70400cb6dd58"}),Object.freeze({fixed:2,defaultValue:0}),Object.freeze({defaultValue:0,fixed:6}),Object.freeze({notEdited:0,editedNoChange:1,editedChanged:2}),Object.freeze({margin:100,height:500,width:1e3,yDeltaText:30,xDeltaText:10,vScales:[1,2,5,10,20,50,100,200,500,1e3,2e3,5e3],hScales:[1,2,5,10,20,50,100,200,500,1e3,2e3,5e3,1e4,2e4,5e4,1e5]}),Object.freeze({width:40,height:40,svgViewboxDim:200});let e=new Map;e.set("a",["href","target"]),e.set("br",[]),e.set("div",[]),e.set("del",[]),e.set("em",[]),e.set("figcaption",[]),e.set("figure",[]),e.set("h1",[]),e.set("h2",[]),e.set("h3",[]),e.set("h4",[]),e.set("h5",[]),e.set("h6",[]),e.set("hr",[]),e.set("img",["src","alt","width","height"]),e.set("ins",[]),e.set("li",[]),e.set("mark",[]),e.set("ol",[]),e.set("p",[]),e.set("s",[]),e.set("small",[]),e.set("strong",[]),e.set("span",[]),e.set("sub",[]),e.set("sup",[]),e.set("ul",[]),e.set("svg",["xmlns","viewBox","class"]),e.set("text",["x","y","text-anchor"]),e.set("polyline",["points","class","transform"]);const t=window.location.protocol,r=new DOMParser;function o(e){return e.replaceAll(/</g,"&lt;").replaceAll(/>/g,"&gt;").replaceAll(/"/g,"&quot;").replaceAll(/\u0027/g,"&apos;").replaceAll(/\u0a00/g,"&nbsp;")}function n(e,o="href"){let n=r.parseFromString("<div>"+e+"</div>","text/html");if(!n||"#document"!==n.nodeName)return{url:"",errorsString:"Parsing error"};let l=n.querySelector("body").firstChild,s="";for(let e=0;e<l.childNodes.length;e++){if("#text"!==l.childNodes[e].nodeName)return{url:"",errorsString:"Invalid characters found in the url"};s+=l.childNodes[e].nodeValue}if(s=s.replaceAll(/</g,"").replaceAll(/>/g,"").replaceAll(/"/g,"").replaceAll(/\u0027/g,"").replaceAll(/&lt;/g,"").replaceAll(/&gt;/g,"").replaceAll(/&quot;/g,"").replaceAll(/&apos;/g,"").replaceAll(/%3C/g,"").replaceAll(/%3c/g,"").replaceAll(/%3E/g,"").replaceAll(/%3e/g,"").replaceAll(/%22/g,"").replaceAll(/%27/g,""),s!==e)return{url:"",errorsString:"Invalid characters found in the url"};let a=["https:"];if("http:"!==t&&"href"!==o||a.push("http:"),"href"===o){a.push("mailto:"),a.push("sms:"),a.push("tel:");let e=s.match(/^#\w*/);if(e&&s===e[0])return{url:s,errorsString:""}}"src"===o&&a.push("data:");let i=null;try{i=new URL(s)}catch(e){return{url:"",errorsString:"Invalid url string"}}if(-1===a.indexOf(i.protocol))return{url:"",errorsString:"Invalid protocol "+i.protocol};if(-1!==["sms:","tel:"].indexOf(i.protocol)&&i.pathname.match(/^\+[0-9,*,#]*$/))return{url:s,errorsString:""};try{encodeURIComponent(i.href)}catch(e){return{url:"",errorsString:"Invalid character in url"}}return{url:s,errorsString:""}}const l=Object.freeze(new class{sanitizeToColor(e){let t=e.match(/^#[0-9,A-F,a-f]{6}$/);return t?t[0]:null}sanitizeToUrl(e,t){return n(e,t)}sanitizeToJsString(e){return function(e){let t=r.parseFromString("<div>"+e+"</div>","text/html");if(!t||"#document"!==t.nodeName)return"";let o=t.querySelector("body").firstChild,n="";for(let e=0;e<o.childNodes.length;e++){if("#text"!==o.childNodes[e].nodeName)return"";n+=o.childNodes[e].nodeValue}return n=n.replaceAll(/</g,"≺").replaceAll(/>/g,"≻").replaceAll(/"/g,"″").replaceAll(/\u0027/g,"′"),n}(e)}sanitizeToHtmlElement(t,o){!function(t,o){let l=r.parseFromString("<div>"+t+"</div>","text/html");l&&"#document"===l.nodeName?function t(r,o){let l=r.childNodes;for(let s=0;s<l.length;s++){let l=r.childNodes[s],a=l.nodeName.toLowerCase(),i=e.get(a);if(i){i=i.concat(["id","class","dir","title"]);let e="svg"===a||"text"===a||"polyline"===a,r=e?document.createElementNS("http://www.w3.org/2000/svg",a):document.createElement(a);if(i.forEach(t=>{if(e)l.hasAttributeNS(null,t)&&(r.setAttributeNS(null,t,l.getAttribute(t)),l.removeAttributeNS(null,t));else if(l.hasAttribute(t))if("href"===t||"src"===t){let e=n(l.getAttribute(t),t).url;""!==e&&r.setAttribute(t,e)}else r.setAttribute(t,l.getAttribute(t))}),l.hasAttribute("style")){l.getAttribute("style").split(";").forEach(e=>{let t=e.split(":");2!==t.length||"width"!==t[0].trim()&&"height"!==t[0].trim()||(r.style[t[0].trim()]=t[1].trim())})}o.appendChild(r),t(l,r)}else"#text"===a&&o.appendChild(document.createTextNode(l.nodeValue))}}(l.querySelector("body").firstChild,o):o.textContent=""}(t,o)}sanitizeToHtmlString(t){return function(t){let l="",s="",a=r.parseFromString("<div>"+t.replace("&nbsp;","਀")+"</div>","text/html");return a&&"#document"===a.nodeName?(function t(r){let a=r.childNodes;for(let i=0;i<a.length;i++){let a=r.childNodes[i],c=a.nodeName.toLowerCase(),u=e.get(c);if(u){u=u.concat(["id","class","dir","title"]);let e="svg"===c||"text"===c||"polyline"===c;l+="<"+c,u.forEach(t=>{if(e)a.hasAttributeNS(null,t)&&(l+=" "+t+'="'+o(a.getAttribute(t))+'"',a.removeAttribute(t));else if(a.hasAttribute(t))if("href"===t||"src"===t){let e=n(a.getAttribute(t),t).url;""===e?s+="\nAn invalid url ("+a.getAttribute(t)+") was removed from a "+t+" attribute":l+=" "+t+'="'+e+'"',a.removeAttribute(t)}else l+=" "+t+'="'+o(a.getAttribute(t))+'"',a.removeAttribute(t)}),l+=">",t(a),l+="</"+c+">"}else"#text"===c?l+=o(a.nodeValue):s+="\nAn invalid tag "+c+" was removed";if(a.hasAttributes)for(let e=0;e<a.attributes.length;e++)s+="\nAn unsecure attribute "+a.attributes[e].name+'="'+a.attributes[e].value+'" was removed.'}}(a.querySelector("body").firstChild),{htmlString:l,errorsString:s}):{htmlString:"",errorsString:"Parsing error"}}(t)}});let s=new Map;const a=Object.freeze(new class{setTranslations(e){e.forEach(e=>s.set(e.msgid,l.sanitizeToJsString(e.msgstr)))}getText(e,t){let r=s.get(e);return t&&r&&Object.getOwnPropertyNames(t).forEach(e=>r=r.replace("{"+e+"}",t[e])),r||e}});const i=Object.freeze(new
/**
	@------------------------------------------------------------------------------------------------------------------------------
