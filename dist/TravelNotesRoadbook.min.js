 ...
 * Build 00483 - 2021-02-05T18:40:14+0100 
...
/**
	...
	@------------------------------------------------------------------------------------------------------------------------------
	*/let i=null;const d=new class{constructor(){Object.freeze(this)}getOpenPromise(){return new Promise((function(e,t){if(i)return void e();let r=window.indexedDB.open("TravelNotesDb",1);r.onerror=function(){i=null,t(new Error("Not possible to open the db"))},r.onsuccess=function(t){i=t.target.result,e()},r.onupgradeneeded=function(e){i=e.target.result,i.createObjectStore("Travels",{keyPath:"UUID"})}}))}getReadPromise(e){return new Promise((function(t,r){if(!i)return void r(new Error("Database not opened"));let o=i.transaction(["Travels"],"readonly");o.onerror=function(){r(new Error("Transaction error"))},o.objectStore("Travels").get(e).onsuccess=function(e){t(e.target.result?e.target.result.data:null)}}))}getWritePromise(e,t){return new Promise((function(r,o){if(!i)return void o(new Error("Database not opened"));let n=null;try{n=i.transaction(["Travels"],"readwrite")}catch(e){return void o(e)}n.onerror=function(){o(new Error("Transaction error"))},n.objectStore("Travels").put({UUID:e,data:t}).onsuccess=function(){r()}}))}closeDb(e){if(!i)return;if(!e)return i.close(),void(i=null);let t=i.transaction(["Travels"],"readwrite");t.onerror=function(){};let r=t.objectStore("Travels").delete(e);r.onerror=function(){i.close(),i=null},r.onsuccess=function(){i.close(),i=null}}};let c=new URLSearchParams(document.location.search.substring(1)),u=c.get("lng"),m=c.get("page");function h(){let e=document.getElementById("TravelNotes-Travel-ShowNotes").checked,t=document.getElementsByClassName("TravelNotes-Roadbook-Travel-Notes-Row");for(let r=0;r<t.length;r++)e?t[r].classList.remove("TravelNotes-Roadbook-Hidden-Row"):t[r].classList.add("TravelNotes-Roadbook-Hidden-Row")}function g(){let e=document.getElementById("TravelNotes-Routes-ShowNotes").checked,t=document.getElementsByClassName("TravelNotes-Roadbook-Route-Notes-Row");for(let r=0;r<t.length;r++)e?t[r].classList.remove("TravelNotes-Roadbook-Hidden-Row"):t[r].classList.add("TravelNotes-Roadbook-Hidden-Row")}function f(){let e=document.getElementById("TravelNotes-Routes-ShowManeuvers").checked,t=document.getElementsByClassName("TravelNotes-Roadbook-Route-Maneuvers-Row");for(let r=0;r<t.length;r++)e?t[r].classList.remove("TravelNotes-Roadbook-Hidden-Row"):t[r].classList.add("TravelNotes-Roadbook-Hidden-Row")}function v(e){document.getElementById("TravelNotes").textContent="",l.sanitizeToHtmlElement(e,document.getElementById("TravelNotes"));let t=document.querySelector(".TravelNotes-Roadbook-Travel-Header-Name");t&&(document.title=""===t.textContent?"roadbook":t.textContent+" - roadbook"),h(),g(),f()}document.getElementById("TravelNotes-Travel-ShowNotes").addEventListener("change",h),document.getElementById("TravelNotes-Routes-ShowNotes").addEventListener("change",g),document.getElementById("TravelNotes-Routes-ShowManeuvers").addEventListener("change",f),m&&(u&&fetch(window.location.href.substr(0,window.location.href.lastIndexOf("/")+1)+"TravelNotes"+u.toUpperCase()+".json").then(e=>{200===e.status&&e.ok&&e.json().then(e=>{s.setTranslations(e),document.getElementById("TravelNotes-Travel-ShowNotesLabel").textContent=s.getText("Roadbook - show travel notes"),document.getElementById("TravelNotes-Routes-ShowManeuversLabel").textContent=s.getText("Roadbook - show maneuver"),document.getElementById("TravelNotes-Routes-ShowNotesLabel").textContent=s.getText("Roadbook - show routes notes")}).catch(e=>{e instanceof Error&&console.error(e)})}),function(){let e=document.createElement("button");e.textContent=s.getText("Roadbook - Save"),e.id="TravelNotes-SaveButton",document.getElementById("TravelNotes-Menu").appendChild(e),e.addEventListener("click",(function(){try{let e=document.querySelector(".TravelNotes-Roadbook-Travel-Header-Name").textContent+"-Roadbook.html",t=document.getElementById("TravelNotes-Menu").removeChild(document.getElementById("TravelNotes-SaveButton")),r=window.URL.createObjectURL(new File(["<!DOCTYPE html>",document.documentElement.outerHTML],e,{type:"text/plain"})),o=document.createElement("a");o.setAttribute("href",r),o.setAttribute("download",e),o.style.display="none",document.body.appendChild(o),o.click(),document.body.removeChild(o),window.URL.revokeObjectURL(r),document.getElementById("TravelNotes-Menu").appendChild(t)}catch(e){e instanceof Error&&console.error(e)}}))}(),m?(d.getOpenPromise().then(()=>d.getReadPromise(m)).then(e=>{v(e)}).catch(e=>{e instanceof Error&&console.error(e)}),window.addEventListener("storage",()=>{d.getReadPromise(m).then(e=>{e?v(e):document.getElementById("TravelNotes").textContent=""}).catch(e=>{e instanceof Error&&console.error(e)})}),window.addEventListener("unload",()=>{d.closeDb()})):document.getElementById("TravelNotes-Menu").removeChild(document.getElementById("TravelNotes-ButtonContainer"))),h(),g(),f()}();