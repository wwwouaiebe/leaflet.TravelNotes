...
( function ( ){
	...
	var getRouter = function ( ) {
		...
		var _StartRequest = function ( ) {
			...
			xmlHttpRequest.open ( 
				'GET',
				_RouteProvider.getUrl ( _DataManager.editedRoute.wayPoints, 'car', providerKey, _Config.language, null ),
				true
			);
			
			//xmlHttpRequest.setRequestHeader('Access-Control-Allow-Origin', 'https://valhalla.mapzen.com/');
			xmlHttpRequest.send ( null );
