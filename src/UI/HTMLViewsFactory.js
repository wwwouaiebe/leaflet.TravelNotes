...
class HTMLViewsFactory {
	...
	*/
	...
	/**
	Gives an HTMLElement with the note icon and sames values than the this.#getNoteTextHTML function
	@param {string} classPrefix A string that will be added to all the className of the created HTMLElements
	@param {NoteAndRoute} noteAndRoute A NoteAndRoute object with the note and the route to witch the note is attached
	@return {HTMLElement}
	@private
	...
	#getTravelNotesHTML ( classPrefix ) {
		...
		while ( ! travelNotesIterator.done ) {
			let noteTextAndIconHTML =
				this.#getNoteTextAndIconHTML ( classPrefix, { note : travelNotesIterator.value, route : null } );
	...
	*/
	...
	getTravelHTML ( classPrefix ) {
		...
		travelHTML.appendChild ( this.#getTravelNotesHTML ( classPrefix ) );
		...
		while ( ! travelRoutesIterator.done ) {
			...
			travelHTML.appendChild ( this.#getRouteHeaderHTML ( classPrefix, route ) );
			if ( route.itinerary.hasProfile ) {
				travelHTML.appendChild ( this.#getRouteProfileHTML ( classPrefix, route ) );
			}
			travelHTML.appendChild ( this.#getRouteManeuversAndNotesHTML ( classPrefix, route ) );
			travelHTML.appendChild ( this.#getRouteFooterHTML ( classPrefix, route ) );
		}
	...
	*/
	...
	getNoteTextAndIconHTML ( classPrefix, noteAndRoute ) {
		return this.#getNoteTextAndIconHTML ( classPrefix, noteAndRoute );
	}
	...
	*/
	...
	getNoteTextHTML ( classPrefix, noteAndRoute ) {
		return this.#getNoteTextHTML ( classPrefix, noteAndRoute );
	}
	...
	*/
	...
	getEditedRouteManeuversAndNotesHTML ( classPrefix ) {
		return this.#getRouteManeuversAndNotesHTML (
			classPrefix,
			theTravelNotesData.travel.editedRoute
		);
	}
	...
	*/
	...
	getTravelNotesHTML ( classPrefix ) {
		return this.#getTravelNotesHTML ( classPrefix );
	}
	...
	*/
	...
	getRouteHeaderHTML ( classPrefix, route ) {
		return this.#getRouteHeaderHTML ( classPrefix, route );
	}
}
...
const theHTMLViewsFactory = new HTMLViewsFactory ( );

export default theHTMLViewsFactory;
