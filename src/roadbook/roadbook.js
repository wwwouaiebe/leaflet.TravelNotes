...
( function ( ){
	...
	*/
	...
	var showTravelNotes = function ( event )
	{
	...
	*/
	...
	var showRouteNotes = function ( event )
	{
	...
	*/
	...
	var showRouteManeuvers = function ( event )
	{
			...
			if ( xmlHttpRequest.readyState === 4 ) {
				if ( xmlHttpRequest.status === 200 ) {
					...
					try {
						...
						translator. setTranslations ( response );
						document.getElementById ( "TravelNotes-Travel-ShowNotesLabel" ).innerHTML = translator.getText ( "Roadbook - show travel notes" );
						document.getElementById ( "TravelNotes-Routes-ShowManeuversLabel" ).innerHTML = translator.getText ( "Roadbook - show maneuver" );
						document.getElementById ( "TravelNotes-Routes-ShowNotesLabel" ).innerHTML = translator.getText ( "Roadbook - show routes notes" );
						var saveButton = document.getElementById ( "TravelNotes-SaveFile" );
						if ( saveButton ) {
							saveButton.value = translator.getText ( "Roadbook - Save" );
						}
					}
					catch ( e ) {
